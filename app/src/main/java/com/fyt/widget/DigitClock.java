...
public class DigitClock extends RelativeLayout {
    ...
    private void initViews() {
        ...
        LayoutParams params = new LayoutParams(this.mViewWidth, this.mViewHeight);
        params.addRule(20);
        addView(this.tv1, params);
        LayoutParams params2 = new LayoutParams(this.mViewWidth, this.mViewHeight);
        params2.addRule(17, this.tv1.getId());
        addView(this.tv2, params2);
        LayoutParams params3 = new LayoutParams(this.mDotWidth, this.mDotHeight);
        params3.addRule(17, this.tv2.getId());
        addView(this.tv3, params3);
        LayoutParams params4 = new LayoutParams(this.mViewWidth, this.mViewHeight);
        params4.addRule(17, this.tv3.getId());
        addView(this.tv4, params4);
        LayoutParams params5 = new LayoutParams(this.mViewWidth, this.mViewHeight);

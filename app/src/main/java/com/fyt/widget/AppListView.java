...
public class AppListView extends ListView {
    ...
    public AppListView(Context context2, AttributeSet arg1, int arg2) {
        ...
        this.receiver = new BroadcastReceiver() { // from class: com.fyt.widget.AppListView.1
            ...
            public void onReceive(Context arg0, Intent arg3) {
    ...
    private void init(Context context2) {
        ...
        View_AppList.setOnItemClickListener(new OnItemClickListener() { // from class: com.fyt.widget.AppListView.2
        ...
        View_AppList.setOnItemLongClickListener(new OnItemLongClickListener() { // from class: com.fyt.widget.AppListView.3
        ...
        View_AppList.setOnScrollListener(new OnScrollListener() { // from class: com.fyt.widget.AppListView.4
    ...
    static void ItemClick(int arg) throws RemoteException {

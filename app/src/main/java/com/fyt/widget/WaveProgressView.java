...
public class WaveProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.mMaxProgress = ta.getInt(0, 100);
        this.mProgress = ta.getInt(1, 50);
        this.mWaveWidth = ta.getFloat(3, 200.0f);
        this.mHalfWaveWidth = this.mWaveWidth / 4.0f;
        this.mWaveHeight = ta.getFloat(4, 20.0f);
        this.mSpeed = ta.getFloat(2, this.mWaveWidth / 70.0f);
        this.mWaveColor = ta.getColor(5, Color.parseColor(DEFAULT_WAVE_COLOR));
        this.mWaveBackgroundColor = ta.getColor(6, Color.parseColor(DEFAULT_WAVE_BG_COLOR));
        this.mStrokeColor = ta.getColor(7, Color.parseColor(DEFAULT_STROKE_COLOR));
        this.mText = ta.getString(8);
        if (this.mText == null) {
            this.mText = "";
        }
        this.mTextColor = ta.getColor(9, Color.parseColor(DEFAULT_TEXT_COLOR));
        this.mTextSize = ta.getDimensionPixelSize(10, sp2px(16));
        this.mHint = ta.getString(11);
        if (this.mHint == null) {
            this.mHint = "";
        }
        this.mHintColor = ta.getColor(12, Color.parseColor(DEFAULT_TEXT_COLOR));
        this.mHintSize = ta.getDimensionPixelSize(13, sp2px(14));
        this.mTextSpace = ta.getDimension(14, 10.0f);
        ta.recycle();
        this.mPath = new Path();

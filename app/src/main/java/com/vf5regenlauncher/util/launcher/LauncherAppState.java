...
import com.vf5regenlauncher.util.MemoryTracker;
...
public class LauncherAppState {
    ...
    private static final String SHARED_PREFERENCES_KEY = "com.vf5regenlauncher.prefs";
...
//    private WidgetPreviewLoader.CacheDb mWidgetPreviewCacheDb;
    ...
    private final ContentObserver mFavoritesObserver = new ContentObserver(new Handler()) { // from class: com.android.launcher17.LauncherAppState.1
...
//            LauncherAppState.this.mModel.startLoaderFromBackground();
    ...
    private LauncherAppState() {
        ...
        try {
            ...
            Log.e("Launcher", "Resource not found: debug_memory_enabled", e);
        }
...
//        this.mIconCache = new IconCache(sContext);
        try {
            appsWidgetsDetach = sContext.getResources().getBoolean(R.bool.config_apps_widgets_detach);
        } catch (Exception e) {
            Log.e("Launcher", "Resource not found: config_apps_widgets_detach", e);
            appsWidgetsDetach = false;
        }
//        try {
//            this.mAppFilter = AppFilter.loadByName(sContext.getString(R.string.app_filter_class));
//        } catch (Resources.NotFoundException e) {
//            Log.e("Launcher", "Resource not found: app_filter_class", e);
//        }

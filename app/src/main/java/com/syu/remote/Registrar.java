...
/**
 * Standard SYU Module Registrar.
 * Manages IRemoteModule instances and their associated callbacks.
 */
public abstract class Registrar {
    ...
    final int getInt(int def, int code, int... params) {
        try {
            if (this.mModule == null) return def;
    ...
    final int[] getInts(int code, int... params) {
        try {
            if (this.mModule == null) return null;
            ModuleObject object = this.mModule.get(code, params, null, null);
            if (object != null) {
                return object.ints;
            }
    ...
    final float[] getFlts(int code, int... params) {
        try {
            if (this.mModule == null) return null;
            ModuleObject object = this.mModule.get(code, params, null, null);
            if (object != null) {

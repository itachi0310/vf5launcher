...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/remote/RemoteTools.class
  classes.dex
 */
...
public class RemoteTools implements ServiceConnection {
    ...
    public void sendInt(int module, int code, int... params) throws RemoteException {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            try {

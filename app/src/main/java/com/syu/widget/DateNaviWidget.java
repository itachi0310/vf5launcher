...
import com.android.launcher34.MyAutoMapReceiver;
...
public class DateNaviWidget extends Widget {
    ...
    protected void updateViews(RemoteViews views) {
        ...
        if (MyAutoMapReceiver.mCameraDis == -1) {
            views.setViewVisibility(ResValue.getInstance().camera, 4);
        } else {
            views.setViewVisibility(ResValue.getInstance().camera, 0);
        }

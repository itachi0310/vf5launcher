...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/weather/WeatherManager.class
  classes.dex
 */
...
public class WeatherManager {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/weather/WeatherManager$OnWeatherChangedListener.class
  classes.dex
 */
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/weather/WeatherManager$RecentWeatherListener.class
  classes.dex
 */
    ...
    void getWeather(final String city, final boolean china) {
        if (!this.isGettingWeather && city != null && !city.isEmpty()) {
            ...
            new AsyncTask<String, Void, WeatherDescription>() { // from class: com.syu.weather.WeatherManager.7
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // android.os.AsyncTask
                protected WeatherDescription doInBackground(String... params) {
                    try {
                        if (params != null && params.length > 0) {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/weather/WeatherManager$RecentWeather.class
  classes.dex
 */
    ...
    public void requestRecentWeathers(String city, final RecentWeatherListener listener) {
        if (city != null && city.length() != 0) {
            ...
            new AsyncTask<String, DailyWeather, RecentWeather>() { // from class: com.syu.weather.WeatherManager.9
                ...
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // android.os.AsyncTask
                protected RecentWeather doInBackground(String... params) {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/weather/WeatherManager$mThread_readLocalData.class
  classes.dex
 */
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        if (inputStream_shx != null) inputStream_shx.close();
                        if (inputStream_shp != null) inputStream_shp.close();
                        out2.close();
                        out = out2;
                    } catch (IOException e) {
                        e.printStackTrace();
                    ...
                    out = out2;
                    String string = Log.getStackTraceString(e2);
                    Log.i("hzq", string);
                    try {
                        if (inputStream_shx != null) inputStream_shx.close();
                        if (inputStream_shp != null) inputStream_shp.close();

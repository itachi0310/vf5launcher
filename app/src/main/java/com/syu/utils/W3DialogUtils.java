...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/utils/W3DialogUtils.class
  classes.dex
 */
...
public class W3DialogUtils {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001034_com.android.launcher34.apk:bin/autolib.jar:com/syu/utils/W3DialogUtils$CustomDialog.class
  classes.dex
 */
    public static class CustomDialog extends Dialog {
        ...
        public CustomDialog(Context context) {
            this(context, R.style.Theme_Translucent_NoTitleBar_Fullscreen);
        }

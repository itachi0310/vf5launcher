...
public class CamryHistoryAct_Luz extends BaseActivity {
    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.camry.luz.CamryHistoryAct_Luz.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 95:
                    CamryHistoryAct_Luz.this.mUpdaterCurTripOilExpend();
                    break;
                case 96:
                    if (ints == null) {
                        for (int i = 0; i < 5; i++) {
                            ...
                            CamryHistoryAct_Luz.this.mUpdaterTripOilValue(ints2);
                        }
                    } else {
                        CamryHistoryAct_Luz.this.mUpdaterTripOilValue(ints);
                    }
                    break;
                case 145:
                    CamryHistoryAct_Luz.this.mUpdaterAverageOilExpend();
                    break;
                case 147:
                    CamryHistoryAct_Luz.this.mUpdaterDrivingTime();
                    break;
            }
        }
    };
    ...
    public void init() {
        ...
        findViewById(R.id.camry_btn_update).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry.luz.CamryHistoryAct_Luz.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(8, null, null, null);
            }
        });
        findViewById(R.id.camry_btn_delete).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry.luz.CamryHistoryAct_Luz.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {

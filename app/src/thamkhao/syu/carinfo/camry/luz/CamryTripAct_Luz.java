...
public class CamryTripAct_Luz extends BaseActivity {
    private VerticalProgressbar[] mProgressbar = new VerticalProgressbar[15];
    private TextView[] mOilTv = new TextView[4];
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.camry.luz.CamryTripAct_Luz.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 94:
                    CamryTripAct_Luz.this.mUpdaterDrivingMileage();
                    break;
                case 115:
                    if (ints != null) {
                        CamryTripAct_Luz.this.mUpdaterOilValue(ints);
                    }
                    break;
                case 145:
                    CamryTripAct_Luz.this.mUpdaterOilExpend();
                    break;
                case 148:
                    CamryTripAct_Luz.this.mUpdaterAveragVelocity();
                    break;
            }
        }
    };
    ...
    public void init() {
        ...
        findViewById(R.id.camry_btn_clear).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry.luz.CamryTripAct_Luz.2
    ...
    public void mUpdaterAveragVelocity() {
        ...
        int num = value & 16777215;
        if (unit == 0) {
            str = String.valueOf(String.format("%d", Integer.valueOf(num))) + " " + CamryData.SPEED_UNIT_MILE;
        } else {
            str = String.valueOf(String.format("%d", Integer.valueOf(num))) + " " + CamryData.SPEED_UNIT_KM;
        }

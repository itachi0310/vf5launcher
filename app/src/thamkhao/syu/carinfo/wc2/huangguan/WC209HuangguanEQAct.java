...
public class WC209HuangguanEQAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ctv_wc2_09huangguan_volbyspeed /* 2131428527 */:
                ...
                setCarInfo(7, value);
                break;
            case R.id.wc2_09huangguan_btn_vol_minus /* 2131428528 */:
                int i = DataCanbus.DATA[94];
                setCarInfo(1, 255);
                break;
            case R.id.wc2_09huangguan_btn_vol_plus /* 2131428530 */:
                int i2 = DataCanbus.DATA[94];
                setCarInfo(1, 1);
                break;
            case R.id.wc2_09huangguan_btn_bal_minus /* 2131428531 */:
                ...
                setCarInfo(2, value2);
                break;
            case R.id.wc2_09huangguan_btn_bal_plus /* 2131428533 */:
                ...
                setCarInfo(2, value3);
                break;
            case R.id.wc2_09huangguan_btn_fad_minus /* 2131428534 */:
                int value4 = DataCanbus.DATA[96];
                if (value4 > 0) {
                    value4--;
                }
                setCarInfo(3, value4);
                break;
            case R.id.wc2_09huangguan_btn_fad_plus /* 2131428536 */:
                ...
                setCarInfo(3, value5);
                break;
            case R.id.wc2_09huangguan_btn_bass_minus /* 2131428537 */:
                ...
                setCarInfo(4, value6);
                break;
            case R.id.wc2_09huangguan_btn_bass_plus /* 2131428539 */:
                ...
                setCarInfo(4, value7);
                break;
            case R.id.wc2_09huangguan_btn_mid_minus /* 2131428540 */:
                ...
                setCarInfo(5, value8);
                break;
            case R.id.wc2_09huangguan_btn_mid_plus /* 2131428542 */:
                ...
                setCarInfo(5, value9);
                break;
            case R.id.wc2_09huangguan_btn_tre_minus /* 2131428543 */:
                ...
                break;
            case R.id.wc2_09huangguan_btn_tre_plus /* 2131428545 */:

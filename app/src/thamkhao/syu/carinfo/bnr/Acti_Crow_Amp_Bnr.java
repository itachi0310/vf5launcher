        ...
        public void onStopTrackingTouch(SeekBar v) {
            switch (v.getId()) {
                case R.id.bnr_crow_amp_carvol_seekview /* 2131428125 */:
                    ...
                    break;
                case R.id.bnr_crow_amp_treview /* 2131428128 */:
                    Acti_Crow_Amp_Bnr.this.sendCMD(5, v.getProgress() + 2);
                    break;
                case R.id.bnr_crow_amp_bassview /* 2131428131 */:
                    Acti_Crow_Amp_Bnr.this.sendCMD(4, v.getProgress() + 2);
                    break;
                case R.id.bnr_crow_amp_middleview /* 2131428134 */:
                    Acti_Crow_Amp_Bnr.this.sendCMD(6, v.getProgress() + 2);
                    break;
                case R.id.bnr_crow_amp_fadview /* 2131428137 */:
                    Acti_Crow_Amp_Bnr.this.sendCMD(1, v.getProgress());
                    break;
                case R.id.bnr_crow_amp_balview /* 2131428140 */:
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_plus1 /* 2131427457 */:
                    ...
                    break;
                case R.id.bnr_crow_btn_amppsel_minus /* 2131428142 */:
                    ...
                    break;
                case R.id.bnr_crow_btn_amppsel_plus /* 2131428144 */:
                    ...
                    break;
                case R.id.bnr_crow_amp_poweronoff /* 2131428145 */:
                    ...
                    break;
                case R.id.bnr_crow_amp_arround /* 2131428146 */:
                    ...
                    break;
                case R.id.bnr_crow_amp_mute /* 2131428148 */:
                    ...
                    break;
                case R.id.bnr_crow_amp_asl /* 2131428149 */:

...
public class UnitFragment extends BaseFragment {
    ...
    private void initValue() {
        this.mList.clear();
        CarInfo carInfo = new CarInfo(3, 115, R.string.str_dongjian_wc2_ds5_car_computer_unit_set);
        carInfo.setCmd(1, 1);
        carInfo.setDiplsys(new String[]{getString(R.string.str_unit_us_imperial), getString(R.string.str_unit_metric)});
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(3, 117, R.string.jeep_format_set);
        carInfo2.setCmd(1, 3);
        carInfo2.setDiplsys(new String[]{"KM", "MI"});
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(3, 118, R.string.str_372_temp_unit);
        carInfo3.setCmd(1, 4);
        ...
        CarInfo carInfo4 = new CarInfo(1, 116, R.string.str_372_oil_unit);
        carInfo4.setCmd(1, 5);
        carInfo4.setDiplsys(new String[]{"L/100KM", "KM/L", "MPG(US)", "MPG(UK)"});
        carInfo4.setCanCycleChange(true);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(1, 119, R.string.str_373_unit_tpms);
        carInfo5.setCmd(1, 7);

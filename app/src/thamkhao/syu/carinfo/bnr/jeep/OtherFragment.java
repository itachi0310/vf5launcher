...
public class OtherFragment extends BaseFragment {
    ...
    private void initValue() {
        this.mList.clear();
        CarInfo carInfo = new CarInfo(2, 161, R.string.wc_372_anglestr);
        ...
        CarInfo carInfo2 = new CarInfo(2, 162, R.string.str_compass_deviation_value);
        ...
        CarInfo carInfo3 = new CarInfo(1, 143, R.string.jeep_headlights_off_delay);
        ...
        CarInfo carInfo4 = new CarInfo(0, 173, R.string.wc_17zhinanzhe_str4);
        carInfo4.setCmd(1, 145);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 164, R.string.jeep_autoparkbrake);
        carInfo5.setCmd(1, 192);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(1, 174, R.string.jeep_speedvolume);
        carInfo6.setCmd(1, 208);
        carInfo6.setDiplsys(new String[]{"OFF", "1", "2", "3"});
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 175, R.string.jeep_surroundsound);

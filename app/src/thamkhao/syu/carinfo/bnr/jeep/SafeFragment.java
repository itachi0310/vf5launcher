...
public class SafeFragment extends BaseFragment {
    ...
    private void initValue() {
        this.mList.clear();
        CarInfo carInfo = new CarInfo(3, 144, R.string.jeep_parksense);
        ...
        CarInfo carInfo2 = new CarInfo(1, 150, R.string.wc_372_frontsensevolstr);
        ...
        CarInfo carInfo3 = new CarInfo(1, 151, R.string.wc_372_backsensevolstr);
        ...
        CarInfo carInfo4 = new CarInfo(0, 145, R.string.wc_372_parksensebreakstr);
        carInfo4.setCmd(1, 163);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 146, R.string.wc_372_video_movestr);
        carInfo5.setCmd(1, 164);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 147, R.string.wc_372_video_staticstr);
        carInfo6.setCmd(1, 165);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 148, R.string.xp_yl_lane_assist_str);
        carInfo7.setCmd(1, 166);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(3, 152, R.string.jeep_forwardcollisionwarn);
        ...
        CarInfo carInfo9 = new CarInfo(0, 153, R.string.jeep_forwardcollisionbrake);
        carInfo9.setCmd(1, 168);
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(1, 159, R.string.wc_372_lanewar);
        ...
        CarInfo carInfo11 = new CarInfo(1, 155, R.string.str_lanesense_strength);
        ...
        CarInfo carInfo12 = new CarInfo(1, 149, R.string.jeep_blindwarn);
        ...
        CarInfo carInfo13 = new CarInfo(0, 156, R.string.jeep_rainsensewipers);

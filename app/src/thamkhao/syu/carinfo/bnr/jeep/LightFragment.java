...
public class LightFragment extends BaseFragment {
    ...
    private void initValue() {
        this.mList.clear();
        CarInfo carInfo = new CarInfo(1, 120, R.string.rzc_biglight_sleep_value);
        carInfo.setCmd(1, 32);
        carInfo.setDiplsys(new String[]{"0 sec", "30 sec", "60 sec", "90 sec"});
        carInfo.setCanCycleChange(true);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(1, 122, R.string.wc_372_nearlight);
        carInfo2.setCmd(1, 33);
        carInfo2.setDiplsys(new String[]{"0 sec", "30 sec", "60 sec", "90 sec"});
        carInfo2.setCanCycleChange(true);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 121, R.string.jeep_locklights);
        carInfo3.setCmd(1, 35);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 123, R.string.wc_372_daylightstr);
        carInfo4.setCmd(1, 36);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 124, R.string.str_cornering_lights);
        carInfo5.setCmd(1, 37);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 125, R.string.wc_372_rainautolightstr);
        carInfo6.setCmd(1, 38);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 127, R.string.jeep_autodimminghighbeams);
        carInfo7.setCmd(1, 39);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(0, 126, R.string.jeep_373_rearview_mirror);
        carInfo8.setCmd(1, 40);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(1, 128, R.string.str_372_headlight_sensitivity);
        carInfo9.setCmd(1, 41);
        carInfo9.setDiplsys(new String[]{"1", "2", "3"});
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(0, 129, R.string.str_373_unlock_turn_light);
        carInfo10.setCmd(1, 42);
        this.mList.add(carInfo10);
        CarInfo carInfo11 = new CarInfo(1, 171, R.string.wc_372_amblight);

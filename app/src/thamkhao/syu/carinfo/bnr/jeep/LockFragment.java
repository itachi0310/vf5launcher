...
public class LockFragment extends BaseFragment {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 130, R.string.str_298_auto_door_unlock);
        carInfo.setCmd(1, 48);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 131, R.string.wc_372_offautolocktstr);
        carInfo2.setCmd(1, 49);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 132, R.string.wc_372_lockturnlightstr);
        carInfo3.setCmd(1, 50);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(3, 136, R.string.jeep_presskeyunlock);
        ...
        CarInfo carInfo5 = new CarInfo(0, 137, R.string.jeep_keylessentry);
        carInfo5.setCmd(1, 54);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 135, R.string.jeep_powertailgatealarm);
        carInfo6.setCmd(1, 55);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(1, 133, R.string.wc_372_lock_voice);
        ...
        CarInfo carInfo8 = new CarInfo(0, 138, R.string.c_321_civic_beep_start_str);
        carInfo8.setCmd(1, 59);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(3, 139, R.string.str_remote_door_unlock);

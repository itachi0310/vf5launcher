    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.daojun.b70.DaojunB70LowCarSettingInfoAct.1
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                ...
                case 116:
                case 117:
                    int B0 = DataCanbus.DATA[112];
                    int B1 = DataCanbus.DATA[113];
                    int B2 = DataCanbus.DATA[114];
                    int B3 = DataCanbus.DATA[115];
                    int B4 = DataCanbus.DATA[116];
                    int B5 = DataCanbus.DATA[117];

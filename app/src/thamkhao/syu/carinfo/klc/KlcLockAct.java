...
public class KlcLockAct extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.klc_btn_Prevent_automatic_door_latch_check /* 2131431922 */:
                int valPre = DataCanbus.DATA[27] & 255;
                KlcFunc.C_CAR_LOCK(1, valPre == 0 ? 1 : 0);
                break;
            case R.id.klc_btn_Automatic_latch_check /* 2131431924 */:
                int valLatch = DataCanbus.DATA[28] & 255;
                KlcFunc.C_CAR_LOCK(2, valLatch == 0 ? 1 : 0);
                break;
            case R.id.klc_lock_automatic_transmission_btn_pre /* 2131431926 */:
                ...
                break;
            case R.id.klc_lock_automatic_transmission_btn_next /* 2131431928 */:
                ...
                break;
            case R.id.klc_btn_Delay_latch_check /* 2131431930 */:
                int valLatchDelay = DataCanbus.DATA[30] & 255;
                KlcFunc.C_CAR_LOCK(4, valLatchDelay == 0 ? 1 : 0);
                break;
            case R.id.klc_lock_manual_transmission_btn_pre /* 2131431932 */:
                ...
                break;
            case R.id.klc_lock_manual_transmission_btn_next /* 2131431934 */:
                ...
                break;
            case R.id.klc_btn_prevent_anti_lock /* 2131431936 */:

...
public class KlcLightAct extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.klc_btn_Look_for_lightsParking_check /* 2131431914 */:
                int valLightPark = DataCanbus.DATA[43] & 255;
                KlcFunc.C_CAR_LIGHT(1, valLightPark == 0 ? 1 : 0);
                break;
            case R.id.klc_btn_Lasuo_headlight_delay_pre /* 2131431916 */:
                ...
                break;
            case R.id.klc_btn_Lasuo_headlight_delay_next /* 2131431918 */:
                ...
                break;
            case R.id.klc_btn_location_lights_check /* 2131431920 */:

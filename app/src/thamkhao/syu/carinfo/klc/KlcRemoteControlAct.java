...
public class KlcRemoteControlAct extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.klc_remote_Remote_control_latch_pre /* 2131431980 */:
                ...
                break;
            case R.id.klc_remote_Remote_control_latch_next /* 2131431982 */:
            ...
            case R.id.klc_Smart_from_the_car_latch_pre /* 2131432003 */:
                ...
                break;
            case R.id.klc_Smart_from_the_car_latch_next /* 2131432005 */:
                ...
                break;
            case R.id.klc_remote_Remote_control_sliding_door_set_check /* 2131432007 */:

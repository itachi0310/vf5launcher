...
public class KlcPannelselectAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.klc_btn_pannel_select1_check /* 2131431966 */:
                KlcFunc.C_CAR_PANNEL_SELECT(1);
                break;
            case R.id.klc_btn_pannel_select2_check /* 2131431968 */:
                KlcFunc.C_CAR_PANNEL_SELECT(2);
                break;
            case R.id.klc_btn_pannel_select3_check /* 2131431970 */:
                KlcFunc.C_CAR_PANNEL_SELECT(5);
                break;
            case R.id.klc_btn_pannel_select4_check /* 2131431972 */:
                KlcFunc.C_CAR_PANNEL_SELECT(6);
                break;
            case R.id.klc_btn_pannel_select5_check /* 2131431974 */:
                KlcFunc.C_CAR_PANNEL_SELECT(7);
                break;
            case R.id.klc_btn_pannel_select6_check /* 2131431976 */:
                KlcFunc.C_CAR_PANNEL_SELECT(8);
                break;
            case R.id.klc_btn_pannel_select7_check /* 2131431978 */:

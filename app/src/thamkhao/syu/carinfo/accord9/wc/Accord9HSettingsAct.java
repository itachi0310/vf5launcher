...
public class Accord9HSettingsAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.accord9h_btn_bright_left /* 2131430143 */:
                setScreenBright(-1);
                break;
            case R.id.accord9h_btn_bright_right /* 2131430145 */:
                setScreenBright(1);
                break;
            case R.id.accord9h_btn_bk_left /* 2131430146 */:
                setBackgroundColor(-1);
                break;
            case R.id.accord9h_tv_bk /* 2131430147 */:
                setBackgroundColor(1);
                break;
            case R.id.accord9h_btn_bk_right /* 2131430148 */:
                setBackgroundColor(1);
                break;
            case R.id.accord9h_btn_depression /* 2131430149 */:
                setBackCameraMode(2);
                break;
            case R.id.accord9h_btn_standard /* 2131430150 */:
                setBackCameraMode(1);
                break;
            case R.id.accord9h_btn_wideangle /* 2131430151 */:
                setBackCameraMode(0);
                break;
        }
    }

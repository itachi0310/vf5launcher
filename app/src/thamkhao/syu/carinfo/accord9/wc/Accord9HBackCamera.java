...
public class Accord9HBackCamera extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.backcar_btn_wideangle /* 2131430134 */:
                setBackCameraMode(0);
                break;
            case R.id.backcar_btn_standard /* 2131430135 */:
                setBackCameraMode(1);
                break;
            case R.id.backcar_btn_depression /* 2131430136 */:
                setBackCameraMode(2);
                break;
        }
    }
    ...
    public void addNotify() {
        if (DataCanbus.DATA[1000] == 131114) {
            DataCanbus.NOTIFY_EVENTS[130].addNotify(this.mNotifyCanbusLo, 1);
        } else {
    ...
    public void removeNotify() {
        if (DataCanbus.DATA[1000] == 131114) {
            DataCanbus.NOTIFY_EVENTS[130].removeNotify(this.mNotifyCanbusLo);
        } else {
    ...
    public void mUpdateCameraStatus() {
        int mBackCameraMode = DataCanbus.DATA[130];
        setBtnCameraFocuse(mBackCameraMode);
    }

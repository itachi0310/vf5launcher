...
public class Accord9LowBackCarSet extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.accord9_low_backcar_brightness_add /* 2131430152 */:
                setBright(-1);
                break;
            case R.id.accord9_low_backcar_brightness_sub /* 2131430154 */:
                setBright(-2);
                break;
            case R.id.accord9_low_backcar_contrast_add /* 2131430155 */:
                setConstrast(-1);
                break;
            case R.id.accord9_low_backcar_contrast_sub /* 2131430157 */:
                setConstrast(-2);
                break;
            case R.id.accord9_low_backcar_color_add /* 2131430158 */:
                setColor(-1);
                break;
            case R.id.accord9_low_backcar_color_sub /* 2131430160 */:
                setColor(-2);
                break;
        }
    }

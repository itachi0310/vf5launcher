...
public class SO3Carbody1Act extends Activity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.saiou3.SO3Carbody1Act.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 7:
                    SO3Carbody1Act.this.updaterLookLight();
                    break;
                case 8:
                    SO3Carbody1Act.this.updaterDelaySet();
                    break;
                case 9:
                    SO3Carbody1Act.this.updatePreventAutoLatch();
                    break;
                case 10:
                    SO3Carbody1Act.this.updateAutoLatch();
                    break;
                case 11:
                    SO3Carbody1Act.this.updateParkingAutoUnLock();
                    break;
                case 12:
                    SO3Carbody1Act.this.updateDelayLatch();
                    break;
                case 13:
                    SO3Carbody1Act.this.updateUnlockLight();
                    break;
                case 14:
                    SO3Carbody1Act.this.updateLockDoorFeed();
                    break;
                case 15:
                    SO3Carbody1Act.this.updateRemoteOpen();
                    break;
                case 16:
                    SO3Carbody1Act.this.updaterreversWipersStart();
                    break;
                case 17:
                    SO3Carbody1Act.this.updateRemoteReLock();
                    break;
                case 18:
                    SO3Carbody1Act.this.updateRemoteSatrtCar();
                    break;
                case 19:
                    SO3Carbody1Act.this.mUpdaterSaturation();
                    break;
                case 20:
                    SO3Carbody1Act.this.mUpdaterContrast();
                    break;
                case 35:
                    SO3Carbody1Act.this.mUpdaterBrightness();
                    break;
                case 36:
                    SO3Carbody1Act.this.updateKeyFogget();
                    break;
                case 37:
                    SO3Carbody1Act.this.mUpdaterValue6();
                    break;
                case 38:
                    SO3Carbody1Act.this.updaterCheckEnable();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_sb_so3_car_body_set1);
        setUI();
    }
    ...
    public void mUpdaterBrightness() {
        ...
        if (((TextView) findViewById(R.id.tv_text8)) != null) {
            if (mInCarAutoUnLock == 0) {
                ((TextView) findViewById(R.id.tv_text8)).setText(R.string.xp_psa_all_string_door_open_0);
            } else {
                ((TextView) findViewById(R.id.tv_text8)).setText(R.string.xp_psa_all_string_door_open_1);
            }
        }
    }
    ...
    public void mUpdaterValue6() {
        ...
        if (((CheckedTextView) findViewById(R.id.ctv_checkedtext13)) != null) {
            ((CheckedTextView) findViewById(R.id.ctv_checkedtext13)).setChecked(mCarWarm != 0);
        }
    }
    ...
    public void updateRemoteOpen() {
        ...
        if (RemoteUnlockState == 0) {
            ((TextView) findViewById(R.id.tv_text7)).setText(R.string.klc_remote_Smart_Near_car_unlocked_only_driver);
        } else if (RemoteUnlockState == 1) {
            ((TextView) findViewById(R.id.tv_text7)).setText(R.string.klc_remote_Smart_Near_car_unlocked_all_door);
        }
    }

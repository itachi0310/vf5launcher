...
public class ActCarSet2_GM_SiBo extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int mFangzhuang = DataCanbus.DATA[80] - 1;
                if (mFangzhuang < 0) {
                    mFangzhuang = 2;
                }
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int mFangzhuang2 = DataCanbus.DATA[80] + 1;
                if (mFangzhuang2 > 2) {
                    mFangzhuang2 = 0;
                }
            ...
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                XflCkFunc.CAR_COMM_CONTROL(34, DataCanbus.DATA[79] != 0 ? 0 : 1);
                break;
        }
    }
    ...
    protected void uAntiCrash() {
        int mFangzhuang = DataCanbus.DATA[80];

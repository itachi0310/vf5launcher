...
public class LZ_0439_Nissan_GTR_AirControlAct extends Activity implements View.OnTouchListener {
    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.dj.huangguan.LZ_0439_Nissan_GTR_AirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 10:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdatePowerOn();
                    break;
                case 11:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateAcOn();
                    break;
                case 12:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateCycle();
                    break;
                case 13:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateAutoOn();
                    break;
                case 14:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdaterDual();
                    break;
                case 16:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateRearDefrost();
                    break;
                case 18:
                case 19:
                case 20:
                    LZ_0439_Nissan_GTR_AirControlAct.this.updateBtnSource();
                    break;
                case 21:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 27:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 28:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateAirTempRight();
                    break;
                case 65:
                    LZ_0439_Nissan_GTR_AirControlAct.this.mUpdateFrontDefrost();
                    break;
            }
        }
    };

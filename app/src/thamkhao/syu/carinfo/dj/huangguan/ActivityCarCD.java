...
public class ActivityCarCD extends BaseActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        if (DataCanbus.DATA[1000] != 590253 && DataCanbus.DATA[1000] != 655789 && DataCanbus.DATA[1000] != 721325 && DataCanbus.DATA[1000] != 786861 && DataCanbus.DATA[1000] != 852397 && DataCanbus.DATA[1000] != 917933 && DataCanbus.DATA[1000] != 983469 && DataCanbus.DATA[94] != 2) {
    ...
    public void updateDiscId() {
        int disc = DataCanbus.DATA[101] & 255;
        if (disc >= 1 && disc <= 6) {
            for (int i = 0; i < 6; i++) {
                if (i == disc - 1) {
    ...
    public void updatePlayTrack() {
        int track = DataCanbus.DATA[102] & 255;
    ...
    public void updatePlayMode() {
        int rep = DataCanbus.DATA[104];
        int random = DataCanbus.DATA[105];
    ...
    public void updateDiscMode() {
        int rep_disc = DataCanbus.DATA[106];
        int random_disc = DataCanbus.DATA[107];

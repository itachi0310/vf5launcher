    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_front_blow_auto /* 2131427574 */:
                data1 = 64;
                break;
            case R.id.air_xts_mode_right /* 2131428035 */:
                data0 = 64;
                break;
            case R.id.air_xts_rearpower /* 2131430115 */:
                data5 = 64;
                break;
            case R.id.air_xts_rearauto /* 2131430116 */:
                data5 = 4;
                break;
            case R.id.air_xts_rearmode /* 2131430117 */:
                data5 = 8;
                break;
            case R.id.btn_air_temp_left_plus_rear /* 2131430118 */:
                data5 = 2;
                break;
            case R.id.btn_air_temp_left_minus_rear /* 2131430120 */:
                data5 = 1;
                break;
            case R.id.dj_xts_air_win_plus_btn_rear /* 2131430121 */:
                data5 = 32;
                break;
            case R.id.dj_xts_air_win_minuts_btn_rear /* 2131430123 */:
                data5 = 16;
                break;
            case R.id.btn_air_temp_right_plus_rear /* 2131430124 */:
                data4 = 32;
                break;
            case R.id.btn_air_temp_right_minus_rear /* 2131430126 */:
                data4 = 16;
                break;
            case R.id.air_xts_seatwin_left_rear /* 2131430127 */:
                flag = true;
                data0 = 4;
                break;
            case R.id.air_xts_seathot_left_rear /* 2131430128 */:
                flag = true;
                data0 = 1;
                break;
            case R.id.air_xts_seatwin_right_rear /* 2131430129 */:
                flag = true;
                data0 = 8;
                break;
            case R.id.air_xts_seathot_right_rear /* 2131430130 */:
                flag = true;
                data0 = 2;
                break;
        }
        ...
        switch (event.getAction()) {
            case 0:
                ...
                break;
            case 1:
                DataCanbus.PROXY.cmd(151, new int[]{16, 0}, null, null);
                break;
        }
        return false;
    }

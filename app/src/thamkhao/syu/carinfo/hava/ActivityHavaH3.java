    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                setCarInfoCmd(10, DataCanbus.DATA[104] != 0 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCarInfoCmd(11, DataCanbus.DATA[107] != 0 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                setCarInfoCmd(1, DataCanbus.DATA[96] == 0 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                setCarInfoCmd(2, DataCanbus.DATA[95] != 0 ? 0 : 1);
                break;

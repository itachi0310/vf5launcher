...
public class ActivityHava18H6Index extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((1310964 == DataCanbus.DATA[1000] || 1638644 == DataCanbus.DATA[1000] || 2359540 == DataCanbus.DATA[1000] || 2425076 == DataCanbus.DATA[1000] || 2097396 == DataCanbus.DATA[1000] || 2162932 == DataCanbus.DATA[1000]) && DataCanbus.DATA[153] == 1) {

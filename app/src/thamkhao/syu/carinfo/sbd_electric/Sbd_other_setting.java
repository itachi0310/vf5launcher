...
public class Sbd_other_setting extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.Sbd_313_Info /* 2131429345 */:
                try {
                ...
                break;
            case R.id.Sbd_313_Charger /* 2131429346 */:
                try {
                ...
                break;
            case R.id.Sbd_313_Battery /* 2131429347 */:
                try {
                ...
                break;
            case R.id.Sbd_313_Motor /* 2131429348 */:
                try {
                ...
                break;
            case R.id.Sbd_313_voltage /* 2131429349 */:
                Intent intent5 = new Intent();
                intent5.setClass(this, Sbd_Settings_Voltage_Status.class);
                startActivity(intent5);
                break;
            case R.id.Sbd_313_soc_tachli /* 2131429350 */:

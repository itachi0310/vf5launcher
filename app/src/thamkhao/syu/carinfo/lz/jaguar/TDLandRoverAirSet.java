    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value9 = DataCanbus.DATA[100] - 1;
                if (value9 < 0) {
                    value9 = 1;
                }
                setCarInfo(9, value9);
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int bit0 = DataCanbus.DATA[102];
                int bit1 = DataCanbus.DATA[103];
                int bit2 = DataCanbus.DATA[104];
                int bit3 = DataCanbus.DATA[105];
                int bit4 = DataCanbus.DATA[106];
                int bit5 = DataCanbus.DATA[107];
                int bit6 = DataCanbus.DATA[108];
                int bit7 = DataCanbus.DATA[109];
                int bit02 = bit0 - 1;
                if (bit02 < 0) {
                    bit02 = 1;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int bit03 = DataCanbus.DATA[102];
                int bit12 = DataCanbus.DATA[103];
                int bit22 = DataCanbus.DATA[104];
                int bit32 = DataCanbus.DATA[105];
                int bit42 = DataCanbus.DATA[106];
                int bit52 = DataCanbus.DATA[107];
                int bit62 = DataCanbus.DATA[108];
                int bit72 = DataCanbus.DATA[109];
                int bit04 = bit03 - 1;
                if (bit04 < 0) {
                    bit04 = 1;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int bit05 = DataCanbus.DATA[102];
                int bit13 = DataCanbus.DATA[103];
                int bit23 = DataCanbus.DATA[104];
                int bit33 = DataCanbus.DATA[105];
                int bit43 = DataCanbus.DATA[106];
                int bit53 = DataCanbus.DATA[107];
                int bit63 = DataCanbus.DATA[108];
                int bit73 = DataCanbus.DATA[109];
                int bit14 = bit13 - 1;
                if (bit14 < 0) {
                    bit14 = 1;
                }
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int bit06 = DataCanbus.DATA[102];
                int bit15 = DataCanbus.DATA[103];
                int bit24 = DataCanbus.DATA[104];
                int bit34 = DataCanbus.DATA[105];
                int bit44 = DataCanbus.DATA[106];
                int bit54 = DataCanbus.DATA[107];
                int bit64 = DataCanbus.DATA[108];
                int bit74 = DataCanbus.DATA[109];
                int bit16 = bit15 - 1;
                if (bit16 < 0) {
                    bit16 = 1;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int bit07 = DataCanbus.DATA[102];
                int bit17 = DataCanbus.DATA[103];
                int bit25 = DataCanbus.DATA[104];
                int bit35 = DataCanbus.DATA[105];
                int bit45 = DataCanbus.DATA[106];
                int bit55 = DataCanbus.DATA[107];
                int bit65 = DataCanbus.DATA[108];
                int bit75 = DataCanbus.DATA[109];
                int bit26 = bit25 - 1;
                if (bit26 < 0) {
                    bit26 = 1;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int bit08 = DataCanbus.DATA[102];
                int bit18 = DataCanbus.DATA[103];
                int bit27 = DataCanbus.DATA[104];
                int bit36 = DataCanbus.DATA[105];
                int bit46 = DataCanbus.DATA[106];
                int bit56 = DataCanbus.DATA[107];
                int bit66 = DataCanbus.DATA[108];
                int bit76 = DataCanbus.DATA[109];
                int bit28 = bit27 - 1;
                if (bit28 < 0) {
                    bit28 = 1;
                }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int bit09 = DataCanbus.DATA[102];
                int bit19 = DataCanbus.DATA[103];
                int bit29 = DataCanbus.DATA[104];
                int bit37 = DataCanbus.DATA[105];
                int bit47 = DataCanbus.DATA[106];
                int bit57 = DataCanbus.DATA[107];
                int bit67 = DataCanbus.DATA[108];
                int bit77 = DataCanbus.DATA[109];
                int bit38 = bit37 - 1;
                if (bit38 < 0) {
                    bit38 = 1;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int bit010 = DataCanbus.DATA[102];
                int bit110 = DataCanbus.DATA[103];
                int bit210 = DataCanbus.DATA[104];
                int bit39 = DataCanbus.DATA[105];
                int bit48 = DataCanbus.DATA[106];
                int bit58 = DataCanbus.DATA[107];
                int bit68 = DataCanbus.DATA[108];
                int bit78 = DataCanbus.DATA[109];
                int bit310 = bit39 - 1;
                if (bit310 < 0) {
                    bit310 = 1;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int bit011 = DataCanbus.DATA[102];
                int bit111 = DataCanbus.DATA[103];
                int bit211 = DataCanbus.DATA[104];
                int bit311 = DataCanbus.DATA[105];
                int bit49 = DataCanbus.DATA[106];
                int bit59 = DataCanbus.DATA[107];
                int bit69 = DataCanbus.DATA[108];
                int bit79 = DataCanbus.DATA[109];
                int bit410 = bit49 - 1;
                if (bit410 < 0) {
                    bit410 = 1;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int bit012 = DataCanbus.DATA[102];
                int bit112 = DataCanbus.DATA[103];
                int bit212 = DataCanbus.DATA[104];
                int bit312 = DataCanbus.DATA[105];
                int bit411 = DataCanbus.DATA[106];
                int bit510 = DataCanbus.DATA[107];
                int bit610 = DataCanbus.DATA[108];
                int bit710 = DataCanbus.DATA[109];
                int bit412 = bit411 - 1;
                if (bit412 < 0) {
                    bit412 = 1;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int bit013 = DataCanbus.DATA[102];
                int bit113 = DataCanbus.DATA[103];
                int bit213 = DataCanbus.DATA[104];
                int bit313 = DataCanbus.DATA[105];
                int bit413 = DataCanbus.DATA[106];
                int bit511 = DataCanbus.DATA[107];
                int bit611 = DataCanbus.DATA[108];
                int bit711 = DataCanbus.DATA[109];
                int bit512 = bit511 - 1;
                if (bit512 < 0) {
                    bit512 = 1;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int bit014 = DataCanbus.DATA[102];
                int bit114 = DataCanbus.DATA[103];
                int bit214 = DataCanbus.DATA[104];
                int bit314 = DataCanbus.DATA[105];
                int bit414 = DataCanbus.DATA[106];
                int bit513 = DataCanbus.DATA[107];
                int bit612 = DataCanbus.DATA[108];
                int bit712 = DataCanbus.DATA[109];
                int bit514 = bit513 - 1;
                if (bit514 < 0) {
                    bit514 = 1;
                }
            ...
            case R.id.btn_minus13 /* 2131427491 */:
                int bit015 = DataCanbus.DATA[102];
                int bit115 = DataCanbus.DATA[103];
                int bit215 = DataCanbus.DATA[104];
                int bit315 = DataCanbus.DATA[105];
                int bit415 = DataCanbus.DATA[106];
                int bit515 = DataCanbus.DATA[107];
                int bit613 = DataCanbus.DATA[108];
                int bit713 = DataCanbus.DATA[109];
                int bit614 = bit613 - 1;
                if (bit614 < 0) {
                    bit614 = 1;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int bit016 = DataCanbus.DATA[102];
                int bit116 = DataCanbus.DATA[103];
                int bit216 = DataCanbus.DATA[104];
                int bit316 = DataCanbus.DATA[105];
                int bit416 = DataCanbus.DATA[106];
                int bit516 = DataCanbus.DATA[107];
                int bit615 = DataCanbus.DATA[108];
                int bit714 = DataCanbus.DATA[109];
                int bit616 = bit615 - 1;
                if (bit616 < 0) {
                    bit616 = 1;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int bit017 = DataCanbus.DATA[102];
                int bit117 = DataCanbus.DATA[103];
                int bit217 = DataCanbus.DATA[104];
                int bit317 = DataCanbus.DATA[105];
                int bit417 = DataCanbus.DATA[106];
                int bit517 = DataCanbus.DATA[107];
                int bit617 = DataCanbus.DATA[108];
                int bit715 = DataCanbus.DATA[109] - 1;
                if (bit715 < 0) {
                    bit715 = 1;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int bit018 = DataCanbus.DATA[102];
                int bit118 = DataCanbus.DATA[103];
                int bit218 = DataCanbus.DATA[104];
                int bit318 = DataCanbus.DATA[105];
                int bit418 = DataCanbus.DATA[106];
                int bit518 = DataCanbus.DATA[107];
                int bit618 = DataCanbus.DATA[108];
                int bit716 = DataCanbus.DATA[109] - 1;
                if (bit716 < 0) {
                    bit716 = 1;
                }
            ...
            case R.id.btn_minus15 /* 2131427520 */:
                int bit019 = DataCanbus.DATA[110] - 1;
                if (bit019 < 0) {
                    bit019 = 1;
                }
            ...
            case R.id.btn_plus15 /* 2131427522 */:
                int bit020 = DataCanbus.DATA[110] - 1;
                if (bit020 < 0) {
                    bit020 = 1;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value13 = DataCanbus.DATA[94];
                if (value13 == 0) {
                    value13 = 1;
                } else if (value13 == 1) {
                    value13 = 0;
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                int value14 = DataCanbus.DATA[95];
                if (value14 == 0) {
                    value14 = 1;
                } else if (value14 == 1) {
                    value14 = 0;

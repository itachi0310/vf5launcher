        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                ...
                case 133:
                    ...
                    break;
                case 167:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text3)).setText(new StringBuilder().append(val).toString());
                    break;
                case 168:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text4)).setText(new StringBuilder().append(val).toString());
                    break;
                case 169:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text5)).setText(new StringBuilder().append(val).toString());
                    break;
                case 170:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text6)).setText(new StringBuilder().append(val).toString());
                    break;
                case 171:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text7)).setText(new StringBuilder().append(val).toString());
                    break;
                case 173:
                    ((TextView) LuzNissanGTRCarSet.this.findViewById(R.id.tv_text8)).setText(new StringBuilder().append(val).toString());
                    break;
            }
        }
    };
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value7 = DataCanbus.DATA[128] - 1;
                if (value7 < 0) {
                    value7 = 7;
                }

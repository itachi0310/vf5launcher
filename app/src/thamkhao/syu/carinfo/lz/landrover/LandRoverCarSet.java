...
public class LandRoverCarSet extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.lz_landrover_btn_tempunit_minus /* 2131427909 */:
                ...
                setCarInfo(2, value);
                break;
            case R.id.lz_landrover_btn_tempunit_plus /* 2131427911 */:
                ...
                setCarInfo(2, value2);
                break;
            case R.id.lz_landrover_btn_oilunit_minus /* 2131428243 */:
                ...
                setCarInfo(3, value3);
                break;
            case R.id.lz_landrover_btn_oilunit_plus /* 2131428245 */:
                ...
                setCarInfo(3, value4);
                break;
            case R.id.lz_landrover_btn_distanceunit_minus /* 2131428246 */:
                ...
                setCarInfo(4, value5);
                break;
            case R.id.lz_landrover_btn_distanceunit_plus /* 2131428248 */:
                ...
                setCarInfo(4, value6);
                break;
            case R.id.lz_landrover_btn_speedwarning_minus /* 2131428249 */:
                ...
                setCarInfo(0, value7);
                break;
            case R.id.lz_landrover_btn_speedwarning_plus /* 2131428251 */:
                ...
                setCarInfo(0, value8);
                break;
            case R.id.ctv_lz_landrover_speedwarning_onoff /* 2131428252 */:
                ...
                setCarInfo(1, value9);
                break;
            case R.id.ctv_lz_landrover_limit_onoff /* 2131428253 */:
                ...
                break;
            case R.id.ctv_lz_landrover_range_onoff /* 2131428254 */:
                ...
                break;
            case R.id.ctv_lz_landrover_time_onoff /* 2131428255 */:
                ...
                break;
            case R.id.ctv_lz_landrover_consumption1_onoff /* 2131428256 */:
                ...
                break;
            case R.id.ctv_lz_landrover_consumption2_onoff /* 2131428257 */:
                ...
                break;
            case R.id.ctv_lz_landrover_avgspeed_onoff /* 2131428258 */:
                ...
                break;
            case R.id.ctv_lz_landrover_date_onoff /* 2131428259 */:
    ...
    public void updateSpeedWarning() {
        ...
        if (((TextView) findViewById(R.id.tv_lz_landrover_speedwarning)) != null) {
            if (DataCanbus.DATA[18] == 0) {
                ((TextView) findViewById(R.id.tv_lz_landrover_speedwarning)).setText(String.valueOf(value) + "km/h");
            } else if (DataCanbus.DATA[18] == 1) {
                ((TextView) findViewById(R.id.tv_lz_landrover_speedwarning)).setText(String.valueOf(value) + "mph");
            }
        }
    }

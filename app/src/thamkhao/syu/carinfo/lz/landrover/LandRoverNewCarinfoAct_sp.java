...
public class LandRoverNewCarinfoAct_sp extends BaseActivity implements View.OnClickListener {
    ...
    int bkNum = 0;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.lz.landrover.LandRoverNewCarinfoAct_sp.1
    ...
    protected void onResume() {
        super.onResume();
        Log.v("zed", " TheApp.getScreenWidth() == " + TheApp.getScreenWidth() + "  TheApp.getScreenHeight() = " + TheApp.getScreenHeight());
        updateTireDistance_delay();
        switch (this.bkNum) {
            case 0:
                findViewById(R.id.layout_view1).setVisibility(8);
    ...
    private void updateTireDistance_delay() {
        HandlerUI.getInstance().postDelayed(new Runnable() { // from class: com.syu.carinfo.lz.landrover.LandRoverNewCarinfoAct_sp.2
    ...
    public void updateTire1Distance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 255) / 800, (((((value - 7) * 20) / 13) + 662) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 317) / 800, ((((((value - 7) * 20) / 13) + 662) + 180) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 255) / 800, (((((value - 20) * 24) / 10) + 682) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 317) / 800, ((((((value - 20) * 24) / 10) + 682) + 180) * TheApp.getScreenHeight()) / 1100);
            }
    ...
    public void updateGanFDistance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 328) / 800, (((((value - 7) * 20) / 13) + 742) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_D50_D1_B30) / 800, ((((((value - 7) * 20) / 13) + 742) + 14) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 328) / 800, (((((value - 20) * 24) / 10) + 762) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_D50_D1_B30) / 800, ((((((value - 20) * 24) / 10) + 762) + 14) * TheApp.getScreenHeight()) / 1100);
            }
    ...
    public void updateTire2Distance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_D51_D1_B76) / 800, (((((value - 7) * 20) / 13) + 662) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 541) / 800, ((((((value - 7) * 20) / 13) + 662) + 180) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_D51_D1_B76) / 800, (((((value - 20) * 24) / 10) + 682) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 541) / 800, ((((((value - 20) * 24) / 10) + 682) + 180) * TheApp.getScreenHeight()) / 1100);
            }
    ...
    public void updateGanRDistance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 280) / 800, (((((value - 7) * 22) / 13) + 782) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 509) / 800, ((((((value - 7) * 22) / 13) + 782) + 24) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 280) / 800, (((((value - 20) * 24) / 10) + 802) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 509) / 800, ((((((value - 20) * 24) / 10) + 802) + 24) * TheApp.getScreenHeight()) / 1100);
            }
    ...
    public void updateTire3Distance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 192) / 800, (((((value - 7) * 22) / 13) + 688) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 273) / 800, ((((((value - 7) * 22) / 13) + 688) + 213) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 192) / 800, (((((value - 20) * 24) / 10) + 708) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 273) / 800, ((((((value - 20) * 24) / 10) + 708) + 213) * TheApp.getScreenHeight()) / 1100);
            }
    ...
    public void updateTire4Distance() {
        ...
        if (mIvIconTire1 != null) {
            if (value <= 20) {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 526) / 800, (((((value - 7) * 22) / 13) + 688) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 607) / 800, ((((((value - 7) * 22) / 13) + 688) + 213) * TheApp.getScreenHeight()) / 1100);
            } else {
                mIvIconTire1.layout((TheApp.getScreenWidth() * 526) / 800, (((((value - 20) * 24) / 10) + 708) * TheApp.getScreenHeight()) / 1100, (TheApp.getScreenWidth() * 607) / 800, ((((((value - 20) * 24) / 10) + 708) + 213) * TheApp.getScreenHeight()) / 1100);
            }

    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int value2 = DataCanbus.DATA[55] - 1;
                if (DataCanbus.DATA[1000] == 65986 || DataCanbus.DATA[1000] == 197058) {
                    if (value2 < 0) {
                        value2 = 3;
                    }
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int value3 = DataCanbus.DATA[55] + 1;
                if (DataCanbus.DATA[1000] == 65986 || DataCanbus.DATA[1000] == 197058) {
                    if (value3 > 3) {
                        value3 = 0;
                    }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int value6 = DataCanbus.DATA[58] - 1;
                if (value6 < 1) {
                    value6 = 15;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int value8 = DataCanbus.DATA[59] - 1;
                if (value8 < 0) {
                    value8 = 1;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int value9 = DataCanbus.DATA[59] + 1;
                if (value9 > 1) {
                    value9 = 0;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int value10 = DataCanbus.DATA[60] - 1;
                if (value10 < 0) {
                    value10 = 1;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value11 = DataCanbus.DATA[60] + 1;
                if (value11 > 1) {
                    value11 = 0;
                }
            ...
            case R.id.btn_minus13 /* 2131427491 */:
                int value12 = DataCanbus.DATA[65] - 1;
                if (value12 < 0) {
                    value12 = 2;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value13 = DataCanbus.DATA[65] + 1;
                if (value13 > 2) {
                    value13 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value14 = DataCanbus.DATA[66] - 1;
                if (value14 < 0) {
                    value14 = 1;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value15 = DataCanbus.DATA[66] + 1;
                if (value15 > 1) {
                    value15 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                ...
                setCarInfo(4, ((mirr << 4) & 16) | ((auto3604 << 5) & 32) | ((guij4 << 6) & 64) | (DataCanbus.DATA[50] & 7), 0, 0);
                break;

...
public class LZBBAFenweiLightAct extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.zhtd.bmw.LZBBAFenweiLightAct.1
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int d0_b7 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b70 = DataCanbus.DATA[97];
                int d2_b70 = DataCanbus.DATA[98];
                int d3_b70 = DataCanbus.DATA[99];
                int d4_b70 = DataCanbus.DATA[100];
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int d0_b72 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b703 = DataCanbus.DATA[97];
                int d2_b702 = DataCanbus.DATA[98];
                int d3_b702 = DataCanbus.DATA[99];
                int d4_b702 = DataCanbus.DATA[100];
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int d0_b73 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b705 = DataCanbus.DATA[97];
                int d2_b703 = DataCanbus.DATA[98];
                int d3_b703 = DataCanbus.DATA[99];
                int d4_b703 = DataCanbus.DATA[100];
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int d0_b74 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b706 = DataCanbus.DATA[97];
                int d2_b705 = DataCanbus.DATA[98];
                int d3_b704 = DataCanbus.DATA[99];
                int d4_b704 = DataCanbus.DATA[100];
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int d0_b75 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b707 = DataCanbus.DATA[97];
                int d2_b707 = DataCanbus.DATA[98];
                int d3_b705 = DataCanbus.DATA[99];
                int d4_b705 = DataCanbus.DATA[100];
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int d0_b76 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b708 = DataCanbus.DATA[97];
                int d2_b708 = DataCanbus.DATA[98];
                int d3_b707 = DataCanbus.DATA[99];
                int d4_b706 = DataCanbus.DATA[100];
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                int d0_b77 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b709 = DataCanbus.DATA[97];
                int d2_b709 = DataCanbus.DATA[98];
                int d3_b709 = DataCanbus.DATA[99];
                int d4_b707 = DataCanbus.DATA[100] - 10;
                if (d4_b707 < 0) {
                    d4_b707 = 0;
                }
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int d0_b78 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b7010 = DataCanbus.DATA[97];
                int d2_b7010 = DataCanbus.DATA[98];
                int d3_b7010 = DataCanbus.DATA[99];
                int d4_b708 = DataCanbus.DATA[100] + 10;
                if (d4_b708 > 255) {
                    d4_b708 = 255;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int d0_b79 = (DataCanbus.DATA[96] >> 7) & 1;
                int d1_b7011 = DataCanbus.DATA[97];
                int d2_b7011 = DataCanbus.DATA[98];
                int d3_b7011 = DataCanbus.DATA[99];
                int d4_b709 = DataCanbus.DATA[100];
                if (d0_b79 == 1) {
                    d0_b79 = 0;
                } else if (d0_b79 == 0) {
                    d0_b79 = 1;

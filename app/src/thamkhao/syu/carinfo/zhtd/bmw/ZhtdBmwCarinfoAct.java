        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                case 0:
                    ...
                    break;
                case 1:
                    ((ImageView) ZhtdBmwCarinfoAct.this.findViewById(R.id.image_car_door_fl)).setImageDrawable(ZhtdBmwCarinfoAct.this.getResources().getDrawable(DataCanbus.DATA[1] == 1 ? R.drawable.ic_bmw_dashboard_car_door_fl : R.drawable.ic_bmw_dashboard_car_null));
                    break;
                case 2:

...
public class ActivityWCLandRover extends Activity implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (DataCanbus.DATA[10] != 0 || v.getId() == R.id.btn_power) {
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_power /* 2131429868 */:
                    ...
                    if (DataCanbus.DATA[1000] == 65947) {
                        this.x = Callback_0374_XP1_ZiYouGuang.U_CARRADIO_D12_D0_B3;
                        this.y = 360;
                    }
                    break;
                case R.id.btn_dual /* 2131429869 */:

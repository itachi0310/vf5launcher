    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int value27 = DataCanbus.DATA[124];
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value30 = DataCanbus.DATA[125];
                setCarInfo(7, (value30 + 1) % 3);
                break;
            case R.id.btn_minus10 /* 2131427482 */:
                int value31 = DataCanbus.DATA[130];
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int value33 = DataCanbus.DATA[130];
                setCarInfo(27, (value33 + 1) % 5);
                break;
            case R.id.btn_minus11 /* 2131427485 */:
                int value34 = DataCanbus.DATA[131];
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int value36 = DataCanbus.DATA[131];
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value39 = DataCanbus.DATA[142];
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value43 = DataCanbus.DATA[154];
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value45 = DataCanbus.DATA[154];
                ...
                break;
            case R.id.layout_view1 /* 2131427531 */:
                try {
            ...
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                int value48 = DataCanbus.DATA[122];
            ...
            case R.id.ctv_checkedtext13 /* 2131427560 */:
                int value57 = DataCanbus.DATA[136];
            ...
            case R.id.ctv_checkedtext24 /* 2131427850 */:
                if (isBNRSiYuOrGuanDao()) {
                    value = DataCanbus.DATA[153] == 0 ? 1 : 0;
                } else {
                    value = 0;
                }
                setCarInfo(40, value);
            ...
            case R.id.ctv_checkedtext25 /* 2131427852 */:
                setCarInfo(42, DataCanbus.DATA[189] == 0 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext26 /* 2131427854 */:
                setCarInfo(43, DataCanbus.DATA[190] == 0 ? 1 : 0);
                break;

        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_minus2 /* 2131427458 */:
                    int value3 = DataCanbus.DATA[180];
                    if (value3 > 0) {
                        value3--;
                    }
                ...
                case R.id.btn_minus3 /* 2131427461 */:
                    int value5 = DataCanbus.DATA[181];
                    if (value5 > 0) {
                        value5--;
                    }
                ...
                case R.id.btn_minus4 /* 2131427464 */:
                    int value7 = DataCanbus.DATA[182];
                    if (value7 > 0) {
                        value7--;
                    }
                ...
                case R.id.btn_plus4 /* 2131427466 */:
                    int value8 = DataCanbus.DATA[182];
                    if (value8 < 12) {
                        value8++;
                    }
                ...
                case R.id.btn_plus5 /* 2131427469 */:
                    int value10 = DataCanbus.DATA[183];
                    if (value10 < 12) {
                        value10++;
                    }
                ...
                case R.id.btn_minus6 /* 2131427470 */:
                    int value11 = DataCanbus.DATA[184];
                    if (value11 > 0) {
                        value11--;
                    }
                ...
                case R.id.btn_plus7 /* 2131427475 */:
                    int value14 = DataCanbus.DATA[185];
                    if (value14 < 12) {
                        value14++;
                    }
                ...
                case R.id.btn_minus8 /* 2131427476 */:
                    int value15 = DataCanbus.DATA[186];
                    if (value15 > 0) {
                        value15--;
                    }
                ...
                case R.id.btn_plus8 /* 2131427478 */:
                    int value16 = DataCanbus.DATA[186];
                    if (value16 < 3) {
                        value16++;
                    }
        ...
        if (((CheckedTextView) findViewById(R.id.ctv_checkedtext1)) != null) {
            ((CheckedTextView) findViewById(R.id.ctv_checkedtext1)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.honda.ActiAMP_Bnr.3
                ...
                public void onClick(View arg0) {
                    int value = DataCanbus.DATA[187] & 255;
        ...
        builder.setPositiveButton(getResources().getString(R.string.confirm), new DialogInterface.OnClickListener() { // from class: com.syu.carinfo.honda.ActiAMP_Bnr.4
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new Thread(new Runnable() { // from class: com.syu.carinfo.honda.ActiAMP_Bnr.4.1
                    ...
                    public void run() {
                        DataCanbus.PROXY.cmd(108, new int[]{i, 0}, null, null);
                    }
                }).start();
                dialog.dismiss();
            }

...
public class Huiteng_AirRearCtrl extends Activity implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        int id = v.getId();
        switch (id) {
            case R.id.huiteng_rearair_power /* 2131430092 */:
                this.cmdId = 13;
                break;
            case R.id.huiteng_rearair_templeft_plus_btn /* 2131430093 */:
                this.cmdId = 3;
                break;
            case R.id.huiteng_rearair_templeft_munits_btn /* 2131430095 */:
                this.cmdId = 4;
                break;
            case R.id.huiteng_rearair_win_left /* 2131430096 */:
                this.cmdId = 7;
                break;
            case R.id.huiteng_rearair_win_right /* 2131430097 */:
                this.cmdId = 10;
                break;
            case R.id.huiteng_rearair_body_left /* 2131430098 */:
                this.cmdId = 8;
                break;
            case R.id.huiteng_rearair_body_right /* 2131430099 */:
                this.cmdId = 11;
                break;
            case R.id.huiteng_rearair_foot_left /* 2131430100 */:
                this.cmdId = 9;
                break;
            case R.id.huiteng_rearair_foot_right /* 2131430101 */:
                this.cmdId = 12;
                break;
            case R.id.huiteng_rearair_tempright_plus_btn /* 2131430102 */:
                this.cmdId = 5;
                break;
            case R.id.huiteng_rearair_tempright_munits_btn /* 2131430104 */:
                this.cmdId = 6;
                break;
            case R.id.huiteng_rearair_autoleft /* 2131430105 */:
                this.cmdId = 1;
                break;
            case R.id.huiteng_rearair_autoright /* 2131430106 */:
                this.cmdId = 2;
                break;
        }

...
public class ActivitySR7Setting_Bnr extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.xfy_sr7_btn_headlight_angle_control_minus /* 2131427727 */:
                ...
                break;
            case R.id.xfy_sr7_btn_headlight_angle_control_plus /* 2131427729 */:
                int value2 = DataCanbus.DATA[148] + 1;
                if (value2 > 3) {
                    value2 = 0;
                }

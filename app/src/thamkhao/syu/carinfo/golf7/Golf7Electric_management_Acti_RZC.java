...
public class Golf7Electric_management_Acti_RZC extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSelfClick((Button) findViewById(R.id.btn_minus1), new View.OnClickListener() { // from class: com.syu.carinfo.golf7.Golf7Electric_management_Acti_RZC.2
        ...
        setSelfClick((Button) findViewById(R.id.btn_plus1), new View.OnClickListener() { // from class: com.syu.carinfo.golf7.Golf7Electric_management_Acti_RZC.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                int val = DataCanbus.DATA[360] & 255;
                if (val >= 60 && val < 195 && val != 255) {
        ...
        setSelfClick((Button) findViewById(R.id.btn_minus2), new View.OnClickListener() { // from class: com.syu.carinfo.golf7.Golf7Electric_management_Acti_RZC.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        setSelfClick((Button) findViewById(R.id.btn_plus2), new View.OnClickListener() { // from class: com.syu.carinfo.golf7.Golf7Electric_management_Acti_RZC.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                int val = (DataCanbus.DATA[357] & 255) + 1;
                if (val > 3) {

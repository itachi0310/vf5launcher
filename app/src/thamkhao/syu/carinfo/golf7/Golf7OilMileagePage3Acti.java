...
public class Golf7OilMileagePage3Acti extends BaseActivity {
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.golf7.Golf7OilMileagePage3Acti.1
    ...
    protected void onResume() {
        ...
        if (((ImageView) findViewById(R.id.golf7_icon_car)) != null) {
            ...
            HandlerUI.getInstance().postDelayed(new Runnable() { // from class: com.syu.carinfo.golf7.Golf7OilMileagePage3Acti.2
                @Override // java.lang.Runnable
                public void run() {
                    Golf7OilMileagePage3Acti.this.move_end = (50 - DataCanbus.DATA[236]) * 10;
    ...
    public void mUpdaterAverageDian() {
        int value = DataCanbus.DATA[394] & 65535;
        int unit = DataCanbus.DATA[393] & 1;
    ...
    private void car_move() {
        if (this.move_start != this.move_end) {
            ...
            car_moving.setAnimationListener(new Animation.AnimationListener() { // from class: com.syu.carinfo.golf7.Golf7OilMileagePage3Acti.3

    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_air_blow3_fl /* 2131427406 */:
                int value2 = DataCanbus.DATA[192];
                if (value2 != 3) {
                    setAirCmd(37, 3);
                }
                break;
            case R.id.btn_air_blow2_fl /* 2131427407 */:
                int value3 = DataCanbus.DATA[192];
                if (value3 != 2) {
                    setAirCmd(37, 2);
                }
                break;
            case R.id.btn_air_blow1_fl /* 2131427408 */:
                int value4 = DataCanbus.DATA[192];
                if (value4 != 1) {
                    setAirCmd(37, 1);
                }
                break;
            ...
            case R.id.btn_air_hot_onoff_fl /* 2131427413 */:
                int value9 = DataCanbus.DATA[92];
                if (value9 != 0) {
                    setAirCmd(33, 0);
                }
                break;
            case R.id.btn_air_hot1_fl /* 2131427414 */:
                int value10 = DataCanbus.DATA[92];
                if (value10 != 1) {
                    setAirCmd(33, 1);
                }
                break;
            ...
            case R.id.btn_air_hot2_fr /* 2131427419 */:
                int value15 = DataCanbus.DATA[93];
                if (value15 != 2) {
                    setAirCmd(34, 2);
                }
                break;

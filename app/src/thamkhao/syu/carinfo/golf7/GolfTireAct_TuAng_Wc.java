...
public class GolfTireAct_TuAng_Wc extends BaseActivity {
    ...
    protected void uTireDisplay(int i) {
        int color = (i & 128) == 0 ? R.color.white : R.color.red;
        ...
        int color1 = (i & 64) == 0 ? R.color.white : R.color.red;
        ...
        int color2 = (i & 32) == 0 ? R.color.white : R.color.red;
        ...
        int color3 = (i & 16) == 0 ? R.color.white : R.color.red;

...
public class Golf7DashBoardVW_DZSJ extends Activity {
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                ...
                case 259:
                    ...
                    ((ImageView) Golf7DashBoardVW_DZSJ.this.findViewById(R.id.image_car_light)).setImageDrawable(Golf7DashBoardVW_DZSJ.this.getResources().getDrawable(value9 == 1 ? R.drawable.ic_dashboard_car_light : R.drawable.ic_dashboard_car_null));
    ...
    Runnable mShowTurnLeftLight = new Runnable() { // from class: com.syu.carinfo.golf7.Golf7DashBoardVW_DZSJ.3
        ...
        public void run() {
            ...
            ((ImageView) Golf7DashBoardVW_DZSJ.this.findViewById(R.id.image_car_turnl_light)).setImageDrawable(Golf7DashBoardVW_DZSJ.this.getResources().getDrawable(Golf7DashBoardVW_DZSJ.this.num == 1 ? R.drawable.ic_dashboard_car_turnl_light : R.drawable.ic_dashboard_car_null));
    ...
    Runnable mShowTurnRightLight = new Runnable() { // from class: com.syu.carinfo.golf7.Golf7DashBoardVW_DZSJ.4
        ...
        public void run() {
            ...
            ((ImageView) Golf7DashBoardVW_DZSJ.this.findViewById(R.id.image_car_turnr_light)).setImageDrawable(Golf7DashBoardVW_DZSJ.this.getResources().getDrawable(Golf7DashBoardVW_DZSJ.this.num1 == 1 ? R.drawable.ic_dashboard_car_turnr_light : R.drawable.ic_dashboard_car_null));
    ...
    public void mUpdaterDashBoardinfo1(int data) {
        switch (data) {
            case 0:
                ...
                if (value != 65535) {
                    ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d.%d", Integer.valueOf(value / 10), Integer.valueOf(value % 10)));
                } else {
            ...
            case 1:
                ...
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_since_start1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d", Integer.valueOf(value2)));
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("km/H");
                break;
            case 2:
                int value3 = DataCanbus.DATA[2];
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_since_start1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + String.format("%d.%d", Integer.valueOf(value3 / 10), Integer.valueOf(value3 % 10)));
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("km");
                break;
            case 3:
                int value4 = DataCanbus.DATA[3];
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_since_start1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + (value4 / 60) + ":" + (value4 % 60));
            ...
            case 4:
                ...
                if (value5 != 65535) {
                    ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d.%d", Integer.valueOf(value5 / 10), Integer.valueOf(value5 % 10)));
                } else {
                    ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText("--.--");
                }
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("L/100km");
            ...
            case 5:
                ...
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_long_term1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d", Integer.valueOf(value6)));
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("km/h");
                break;
            case 6:
                int value7 = DataCanbus.DATA[7];
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_long_term1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + String.format("%d.%d", Integer.valueOf(value7 / 10), Integer.valueOf(value7 % 10)));
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("km");
                break;
            case 7:
                int value8 = DataCanbus.DATA[8];
                ((TextView) findViewById(R.id.golf_dashboard1_info)).setText(R.string.vehicle_detail_status_long_term1);
                ((TextView) findViewById(R.id.golf_dashboard1_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + (value8 / 60) + ":" + (value8 % 60));
                ((TextView) findViewById(R.id.golf_dashboard1_info3)).setText("h");
                break;
            case 8:
    ...
    public void mUpdaterDashBoardinfo2(int data) {
        switch (data) {
            ...
            case 1:
                ...
                if (value2 != 65535) {
                    ((TextView) findViewById(R.id.golf_dashboard2_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d.%d", Integer.valueOf(value2 / 10), Integer.valueOf(value2 % 10)));
                } else {
            ...
            case 2:
                ...
                ((TextView) findViewById(R.id.golf_dashboard2_info)).setText(R.string.vehicle_detail_status_since_refuelling1);
                ((TextView) findViewById(R.id.golf_dashboard2_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.average1)) + " " + String.format("%d", Integer.valueOf(value3)));
                ((TextView) findViewById(R.id.golf_dashboard2_info3)).setText("km/h");
                break;
            case 3:
                int value4 = DataCanbus.DATA[12];
                ((TextView) findViewById(R.id.golf_dashboard2_info)).setText(R.string.vehicle_detail_status_since_refuelling1);
                ((TextView) findViewById(R.id.golf_dashboard2_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + String.format("%d.%d", Integer.valueOf(value4 / 10), Integer.valueOf(value4 % 10)));
                ((TextView) findViewById(R.id.golf_dashboard2_info3)).setText("km");
                break;
            case 4:
                int value5 = DataCanbus.DATA[13];
                ((TextView) findViewById(R.id.golf_dashboard2_info)).setText(R.string.vehicle_detail_status_since_refuelling1);
                ((TextView) findViewById(R.id.golf_dashboard2_info2)).setText(String.valueOf(TheApp.getInstance().getResources().getString(R.string.str_227_drivered1)) + " " + (value5 / 60) + ":" + (value5 % 60));

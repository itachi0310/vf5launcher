...
public class Golf7Functional_OffRoadCustom_Wc_Acti extends BaseActivity {
    private View.OnClickListener mClick = new View.OnClickListener() { // from class: com.syu.carinfo.golf7.Golf7Functional_OffRoadCustom_Wc_Acti.1
        ...
        public void onClick(View v) {
            ...
            int val = -1;
            switch (v.getId()) {
                case R.id.wc_golf_4engine_m /* 2131431217 */:
                case R.id.wc_golf_4engine_p /* 2131431219 */:
                    cmd = 3;
                    int val2 = DataCanbus.DATA[211] & 255;
                    val = val2 != 1 ? 1 : 0;
                    break;
                case R.id.wc_golf_air_downhill_m /* 2131431224 */:
                case R.id.wc_golf_air_downhill_p /* 2131431226 */:
                    cmd = 7;
                    int val3 = DataCanbus.DATA[213] & 255;
                    val = val3 != 1 ? 1 : 0;
                    break;
                case R.id.wc_golf_air_ramp_m /* 2131431228 */:
                case R.id.wc_golf_air_ramp_p /* 2131431230 */:
                    cmd = 8;
                    int val4 = DataCanbus.DATA[214] & 255;
                    val = val4 != 1 ? 1 : 0;
                    break;
                case R.id.wc_golf_air_parkassit_m /* 2131431232 */:
                case R.id.wc_golf_air_parkassit_p /* 2131431234 */:
                    cmd = 9;

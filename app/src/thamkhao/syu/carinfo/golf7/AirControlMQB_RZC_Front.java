...
public class AirControlMQB_RZC_Front extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.air_xts_clearair /* 2131427447 */:
                cmdId = 175;
                value = DataCanbus.DATA[190] != 0 ? 0 : 1;
                break;
            ...
            case R.id.air_xts_steer_hot /* 2131427453 */:
                cmdId = 172;
                value = DataCanbus.DATA[101] != 0 ? 0 : 1;
                break;
            case R.id.air_xts_seatwin_right /* 2131427454 */:
                cmdId = 192;
                value = (DataCanbus.DATA[191] + 1) % 4;
                break;
            case R.id.air_xts_aqs /* 2131427519 */:
                cmdId = 176;
                value = DataCanbus.DATA[102] != 0 ? 0 : 1;
                break;
            case R.id.air_xts_fronthot /* 2131427595 */:
                cmdId = 205;
                value = DataCanbus.DATA[124] != 0 ? 0 : 1;
                break;
            case R.id.air_xts_steer_seat_hot /* 2131427596 */:
    ...
    private void removeNotify() {
        ...
        DataCanbus.NOTIFY_EVENTS[124].removeNotify(this.mCanbusNotify);

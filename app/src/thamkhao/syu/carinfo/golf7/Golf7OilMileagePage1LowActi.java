...
public class Golf7OilMileagePage1LowActi extends BaseActivity {
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.golf7.Golf7OilMileagePage1LowActi.1
    ...
    public void mUpdaterAverageOil() {
        ...
        if (((TextView) findViewById(R.id.golf7_tv_oil_since_start_average_oil_low)) != null) {
            if (ConstGolf.isWcGolf()) {
                if (value != 65535) {
                    ((TextView) findViewById(R.id.golf7_tv_oil_since_start_average_oil_low)).setText(String.valueOf(String.format("%d.%d", Integer.valueOf(value / 10), Integer.valueOf(value % 10))) + "L/100km");
                    return;
                } else {

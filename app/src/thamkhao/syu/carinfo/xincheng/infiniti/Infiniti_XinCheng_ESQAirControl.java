    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_cycle /* 2131427437 */:
                data0 = (DataCanbus.DATA[1000] == 1573316 || DataCanbus.DATA[1000] == 2032068) ? DataCanbus.DATA[12] == 1 ? 35 : 34 : 25;
                break;
            ...
            case R.id.air_xts_mode_right /* 2131428035 */:
                data0 = 66;
                break;
            case R.id.air_xts_blowup /* 2131428564 */:
                data0 = 22;
                break;
            case R.id.air_xts_forest /* 2131428565 */:
                data0 = 67;
                break;
        }
        if (!flag) {

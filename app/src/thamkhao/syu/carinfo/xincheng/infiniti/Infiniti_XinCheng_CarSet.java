    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value11 = DataCanbus.DATA[151] - 1;
                if (value11 < 0) {
                    value11 = 2;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value12 = DataCanbus.DATA[151] + 1;
                if (value12 > 2) {
                    value12 = 0;
                }
            ...
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                int value19 = DataCanbus.DATA[108];
                if (value19 == 1) {
                    value19 = 0;
                } else if (value19 == 0) {
                    value19 = 1;
            ...
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                int value22 = DataCanbus.DATA[111];
                if (value22 == 1) {
                    value22 = 0;
                } else if (value22 == 0) {
                    value22 = 1;
            ...
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                int value23 = DataCanbus.DATA[118];
                if (value23 == 1) {
                    value23 = 0;
                } else if (value23 == 0) {
                    value23 = 1;
            ...
            case R.id.ctv_checkedtext10 /* 2131427557 */:
                int value26 = DataCanbus.DATA[150];
                if (value26 == 1) {
                    value26 = 0;
                } else if (value26 == 0) {
                    value26 = 1;
            ...
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                int value27 = DataCanbus.DATA[153];
                if (value27 == 1) {
                    value27 = 0;
                } else if (value27 == 0) {
                    value27 = 1;
            ...
            case R.id.ctv_checkedtext12 /* 2131427559 */:
                int value28 = DataCanbus.DATA[154];
                if (value28 == 1) {
                    value28 = 0;
                } else if (value28 == 0) {
                    value28 = 1;
            ...
            case R.id.ctv_checkedtext13 /* 2131427560 */:
                int value29 = DataCanbus.DATA[155];
                if (value29 == 1) {
                    value29 = 0;
                } else if (value29 == 0) {
                    value29 = 1;

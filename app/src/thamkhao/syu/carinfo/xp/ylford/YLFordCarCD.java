...
public class YLFordCarCD extends BaseActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        addNotify();
        DataCanbus.PROXY.cmd(2, new int[]{178, 4, 0, 0}, null, null);
        mIsFront = true;
    ...
    public void updaterRandom() {
        int randomState = DataCanbus.DATA[109] & 255;
        if (randomState == 0) {
    ...
    public void updaterWorkState() {
        int workStateValue = DataCanbus.DATA[111] & 255;
        if (workStateValue == 1) {
    ...
    public void updaterCurTime() {
        int playtime = DataCanbus.DATA[113] & 16777215;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.xp_ylford_cd_prev /* 2131429654 */:
                CD_CONRTROL_CMD(176, 3, 0, 0);
                break;
            case R.id.xp_ylford_cd_fb /* 2131429655 */:
                if (this.carcd_fb == 0) {
                    this.carcd_fb = 1;
                } else {
                    this.carcd_fb = 0;
                ...
                break;
            case R.id.xp_ylford_cd_repeat /* 2131429656 */:
                ...
                break;
            case R.id.xp_ylford_play /* 2131429657 */:
                CD_CONRTROL_CMD(176, 13, 1, 0);
                break;
            case R.id.xp_ylford_cd_pause /* 2131429658 */:
                CD_CONRTROL_CMD(176, 13, 0, 0);
                break;
            case R.id.xp_ylford_cd_repeat_random /* 2131429659 */:
                if (this.cycleState == 7) {
                    this.cycleState = 9;
                ...
                CD_CONRTROL_CMD(176, this.cycleState, 0, 0);
                break;
            case R.id.xp_ylford_cd_ff /* 2131429660 */:
                if (this.carcd_ff == 0) {
                    this.carcd_ff = 1;
                } else {
                    this.carcd_ff = 0;
                ...
                break;
            case R.id.xp_ylford_cd_next /* 2131429661 */:

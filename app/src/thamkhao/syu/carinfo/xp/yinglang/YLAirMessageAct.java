...
public class YLAirMessageAct extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.xp_yl_btn_Autoc_air_volume_pre /* 2131433407 */:
                ...
                break;
            case R.id.xp_yl_btn_Auto_air_volume_next /* 2131433409 */:
                ...
                break;
            case R.id.xp_yl_btn_Air_conditioning_pre /* 2131433411 */:
                ...
                break;
            case R.id.xp_yl_btn_Air_conditioning_next /* 2131433413 */:
                ...
                break;
            case R.id.xp_yl_air_Air_quality_sensor_pre /* 2131433415 */:
                ...
                break;
            case R.id.xp_yl_air_Air_quality_sensor_next /* 2131433417 */:
                ...
                break;
            case R.id.xp_yl_btn_Auto_zone_climate_control_pre /* 2131433419 */:
                ...
                break;
            case R.id.xp_yl_btn_Auto_zone_climate_control_next /* 2131433421 */:
                ...
                break;
            case R.id.xp_yl_btn_remote_Seat_auto_heating_check /* 2131433423 */:
                int valRemoteSeatHeat = DataCanbus.DATA[5];
                YLFunc.CAR_AIR_CONTROL(5, valRemoteSeatHeat == 0 ? 1 : 0);
                break;
            case R.id.xp_wr_remote_Seat_auto_heating_pre /* 2131433425 */:
                ...
                break;
            case R.id.xp_wr_remote_Seat_auto_heating_next /* 2131433427 */:
                ...
                break;
            case R.id.xp_yl_btn_Auto_front_window_defogging_check /* 2131433429 */:
                int valAutFrontDefog = DataCanbus.DATA[4];
                YLFunc.CAR_AIR_CONTROL(4, valAutFrontDefog == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_air_Auto_rear_window_defogging_check /* 2131433431 */:
                int valRearWindowDefog = DataCanbus.DATA[3];
                YLFunc.CAR_AIR_CONTROL(3, valRearWindowDefog == 0 ? 1 : 0);
                break;
            case R.id.rzc_gl8_remote_start_seat_blow /* 2131433433 */:
                YLFunc.CAR_AIR_CONTROL(66, DataCanbus.DATA[284] == 0 ? 1 : 0);
                break;
            case R.id.rzc_gl8_remote_start_seat_heat /* 2131433435 */:

...
public class YLIndexAct extends Activity implements View.OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        if (TheApp.getConfiguration() == 1 || DataCanbus.DATA[1000] == 393241 || DataCanbus.DATA[1000] == 2424857 || DataCanbus.DATA[1000] == 2687001 || DataCanbus.DATA[1000] == 2359321) {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        switch (id) {
            case R.id.xp_yl_car_settings_check /* 2131433445 */:
                try {
                ...
                break;
            case R.id.xp_yl_air_message_check /* 2131433446 */:
                try {
                ...
                break;
            case R.id.xp_yl_onstar_set_check /* 2131433448 */:
                try {
                ...
                break;
            case R.id.xp_yl_air_control_set_check /* 2131433450 */:
                try {
                    if (DataCanbus.DATA[1000] == 359 || DataCanbus.DATA[1000] == 65895 || DataCanbus.DATA[1000] == 262503 || DataCanbus.DATA[1000] == 196967 || DataCanbus.DATA[1000] == 131431 || DataCanbus.DATA[1000] == 6422589 || DataCanbus.DATA[1000] == 6488125 || DataCanbus.DATA[1000] == 6553661) {
                        ...
                        intent2 = new Intent(this, (Class<?>) YLAirControlAct.class);
                    }
                ...
                break;
            case R.id.rzc_klc_onstar_wifi_check /* 2131433452 */:
                try {
                ...
                break;
            case R.id.rzc_klc_carinfo_check /* 2131433454 */:
                try {

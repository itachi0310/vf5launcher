...
public class YLInfoSetSecondAct_BNR extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.wc_weilang_remote_car_window_control_check /* 2131432010 */:
                int value1 = DataCanbus.DATA[126];
                YLFunc.CAR_COMM_CONTROL(27, value1 == 0 ? 1 : 0);
                break;
            case R.id.xfl_ck_air_rear_window_auto_foggest_check /* 2131432852 */:
                int value12 = DataCanbus.DATA[137];
                YLFunc.CAR_AIR_CONTROL(98, value12 == 0 ? 1 : 0);
                break;
            case R.id.rzc_gl8_remote_start_air /* 2131433437 */:
                int value13 = DataCanbus.DATA[135];
                YLFunc.CAR_AIR_CONTROL(96, value13 == 0 ? 1 : 0);
                break;
            case R.id.rzc_gl8_start_rear_air /* 2131433439 */:
                int value14 = DataCanbus.DATA[136] + 1;
                YLFunc.CAR_AIR_CONTROL(97, value14 % 3);
                break;
            case R.id.xp_yl_lane_assist_pre /* 2131433467 */:
            case R.id.xp_yl_lane_assist_next /* 2131433469 */:
                int value15 = DataCanbus.DATA[125];
                YLFunc.CAR_COMM_CONTROL(28, value15 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_Near_car_unlocked_set_check /* 2131433476 */:
                int value16 = DataCanbus.DATA[20];
                YLFunc.CAR_COMM_CONTROL(12, value16 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_remote_Forgotten_Keys_check /* 2131433479 */:
                int value2 = DataCanbus.DATA[21];
                YLFunc.CAR_COMM_CONTROL(13, value2 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_PERSONALIZATION_BY_DRIVER_check /* 2131433481 */:
                int value3 = DataCanbus.DATA[22];
                YLFunc.CAR_COMM_CONTROL(14, value3 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_AUTO_RELOCK_DOORS_check /* 2131433483 */:
                int value4 = DataCanbus.DATA[23];
                YLFunc.CAR_COMM_CONTROL(15, value4 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_car_set_Second_auto_rain_refresh_check /* 2131433485 */:
                int value5 = DataCanbus.DATA[24];
                YLFunc.CAR_COMM_CONTROL(24, value5 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_Side_blind_zone_check /* 2131433487 */:
                int value6 = DataCanbus.DATA[25];
                YLFunc.CAR_COMM_CONTROL(22, value6 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_leave_door_latch_pre /* 2131433489 */:
                ...
                break;
            case R.id.xp_yl_leave_door_latch_next /* 2131433491 */:
                ...
                break;
            case R.id.xp_yinglang_left_right_traffic_check /* 2131433493 */:
                int value7 = DataCanbus.DATA[27];
                YLFunc.CAR_COMM_CONTROL(16, value7 == 0 ? 1 : 0);
                break;
            case R.id.xp_yinglang_adaptive_forward_lighting_check /* 2131433496 */:
                int value8 = DataCanbus.DATA[28];
                YLFunc.CAR_COMM_CONTROL(17, value8 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_comfort_Automatic_folding_mirrors_check /* 2131433499 */:
                int value9 = DataCanbus.DATA[29];
                YLFunc.CAR_COMM_CONTROL(18, value9 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_comfort_Mirror_reversing_automatic_tilt_check /* 2131433501 */:
                int value10 = DataCanbus.DATA[30];
                YLFunc.CAR_COMM_CONTROL(19, value10 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_easy_exit_check /* 2131433503 */:
                int value11 = DataCanbus.DATA[31];
                YLFunc.CAR_COMM_CONTROL(20, value11 == 0 ? 1 : 0);
                break;
            case R.id.xp_yl_auto_memory_check /* 2131433505 */:
                int value122 = DataCanbus.DATA[32];
                YLFunc.CAR_COMM_CONTROL(21, value122 == 0 ? 1 : 0);
                break;
            case R.id.wc_weilang_auto_fangzhuang_preper_pre /* 2131433507 */:
            case R.id.wc_weilang_auto_fangzhuang_preper_next /* 2131433509 */:
                int value17 = DataCanbus.DATA[124] + 1;
                if (value17 == 4) {
                    value17 = 3;
                }
                YLFunc.CAR_COMM_CONTROL(25, value17 % 3);
                break;
            case R.id.wc_weilang_car_state_check /* 2131433511 */:
                int value18 = DataCanbus.DATA[127];
                YLFunc.CAR_COMM_CONTROL(26, value18 == 0 ? 1 : 0);
                break;
            case R.id.wc_gm_cruise_check /* 2131433513 */:
                int value19 = DataCanbus.DATA[138];
                YLFunc.CAR_COMM_CONTROL(96, value19 == 0 ? 1 : 0);
                break;
            case R.id.wc_gm_rearseat_reminder /* 2131433515 */:
                int value110 = DataCanbus.DATA[139];
                YLFunc.CAR_COMM_CONTROL(97, value110 == 0 ? 1 : 0);
                break;
            case R.id.wc_gm_crash_remind_type /* 2131433517 */:
                int value111 = DataCanbus.DATA[140];
                YLFunc.CAR_COMM_CONTROL(98, value111 == 0 ? 1 : 0);
                break;
            case R.id.wc_gm_walker_m /* 2131433520 */:
            case R.id.wc_gm_walker_p /* 2131433522 */:
                int value112 = DataCanbus.DATA[141] + 1;
                YLFunc.CAR_COMM_CONTROL(99, value112 % 3);
                break;
            case R.id.ctv_sb_so3_change_wall_warm /* 2131433524 */:
                int value113 = DataCanbus.DATA[142];
                YLFunc.CAR_COMM_CONTROL(100, value113 == 0 ? 1 : 0);
                break;
            case R.id.ctv_sb_so3_back_car_accose_warm /* 2131433526 */:

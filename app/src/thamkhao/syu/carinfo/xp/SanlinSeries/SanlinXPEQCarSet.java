    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[123] + 1;
                if (value6 > 4) {
                    value6 = 0;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                int value10 = DataCanbus.DATA[125];
                if (value10 < 12) {
                    value10++;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value17 = DataCanbus.DATA[130] - 1;
                if (value17 < 0) {
                    value17 = 2;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value18 = DataCanbus.DATA[130] + 1;
                if (value18 > 2) {
                    value18 = 0;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int value23 = DataCanbus.DATA[133] - 1;
                if (value23 < 0) {
                    value23 = 3;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value24 = DataCanbus.DATA[133] + 1;
                if (value24 > 3) {
                    value24 = 0;
                }

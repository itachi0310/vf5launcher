            ...
            if (Activity_0452_PA_Ford_PitchAndRoll.this.num == 5) {
                switch (DataCanbus.DATA[1000]) {
                    ...
                    case FinalCanbus.CAR_PA_BNR_Toyota_GX460_10 /* 6357389 */:
                        DataCanbus.PROXY.cmd(42, new int[]{2, 0}, null, null);
                        break;
                    default:

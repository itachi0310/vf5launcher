    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.tv_sp_rear /* 2131427944 */:
                ...
                mUpdatePowerOn();
                break;
            case R.id.air_pa_jeep_seatback_left /* 2131427946 */:
                data0 = 32;
                break;
            case R.id.air_pa_jeep_aux /* 2131427947 */:
                data0 = 34;
                break;
            case R.id.air_pa_jeep_seatback_right /* 2131427948 */:
                data0 = 33;
                break;
            case R.id.air_pa_jeep_auto_rear /* 2131427951 */:
                data0 = 2;
                break;
            case R.id.air_pa_jeep_temp_left_plus_rear /* 2131427952 */:
            case R.id.air_pa_jeep_temp_right_plus_rear /* 2131427956 */:
                data0 = 4;
                break;
            case R.id.air_pa_jeep_temp_left_munits_rear /* 2131427954 */:
            case R.id.air_pa_jeep_temp_right_munits_rear /* 2131427958 */:
                data0 = 5;
                break;
            case R.id.air_pa_jeep_mode_foot_rear /* 2131427959 */:
                data0 = 10;
                break;
            case R.id.air_pa_jeep_mode_body_rear /* 2131427960 */:
                data0 = 8;
                break;
            case R.id.air_pa_jeep_mode_footbody_rear /* 2131427961 */:
                data0 = 9;
                break;
            case R.id.air_pa_jeep_wind_minuts_rear /* 2131427962 */:
                data0 = 7;
                break;
            case R.id.air_pa_jeep_wind_plus_rear /* 2131427964 */:
                data0 = 6;
                break;
        }

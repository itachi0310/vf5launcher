...
public class Activity_374_FordCarSet2 extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 456, "Auto Highbeam");
        carInfo.setCmd(0, 37);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 457, "Daytime Running Lights");
        carInfo2.setCmd(0, 38);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 458, "Autolamp Delay");
        carInfo3.setCmd(0, 39);
        carInfo3.setDiplsys(new String[]{"off", "10s", "20s", "120s"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 459, "Autounlock");
        carInfo4.setCmd(0, 40);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 460, "Mislock Chirp");
        carInfo5.setCmd(0, 41);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 461, "Switches Inhibit");
        carInfo6.setCmd(0, 42);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 462, "Audible feedback");
        carInfo7.setCmd(0, 43);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(1, 463, "Remote Unlock");
        carInfo8.setCmd(0, 44);
        carInfo8.setDiplsys(new String[]{"All doors", "Driver's door"});
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(0, 464, "Auto hold");
        carInfo9.setCmd(0, 45);
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(0, 465, "Key Detection Alert");
        ...
        CarInfo carInfo13 = new CarInfo(0, 468, "Motion Sensors");
        carInfo13.setCmd(0, 49);
        this.mList.add(carInfo13);
        CarInfo carInfo14 = new CarInfo(0, 469, "Seats and Steering Wheel");

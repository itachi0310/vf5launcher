...
public class Activity_0452_PA_Ford_AmbientLightSet extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 94, R.string.str_374_ambientlight1);
        carInfo.setCmd(9, 1);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 95, R.string.str_374_ambientlight2);
        carInfo2.setCmd(9, 2);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 96, R.string.str_374_ambientlight3);
        carInfo3.setCmd(9, 3);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 97, R.string.str_374_ambientlight4);
        carInfo4.setCmd(9, 4);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 98, R.string.str_374_ambientlight5);
        carInfo5.setCmd(9, 5);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 99, R.string.str_374_ambientlight6);
        carInfo6.setCmd(9, 6);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 100, R.string.str_374_ambientlight7);
        carInfo7.setCmd(9, 7);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(0, 101, R.string.str_374_ambientlight8);
        carInfo8.setCmd(9, 8);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(1, 102, R.string.light_color);
        carInfo9.setCmd(9, 9);
        ...
        CarInfo carInfo10 = new CarInfo(1, 103, R.string.str_374_ambientlight9);
        ...
        CarInfo carInfo11 = new CarInfo(1, 104, R.string.str_374_ambientlight10);
        ...
        CarInfo carInfo12 = new CarInfo(1, 105, R.string.str_374_ambientlight11);

...
public class Activity_424_FuncSet_beifen extends Activity {
    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xp.ziyouguang.Activity_424_FuncSet_beifen.1
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(1, 101, R.string.rzc_others_language_setting);
        carInfo.setCmd(0, 3);
        ...
        CarInfo carInfo2 = new CarInfo(0, 102, R.string.radar_set);
        carInfo2.setCmd(0, 1);

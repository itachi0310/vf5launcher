...
public class Activity_374_Luopan extends Activity {
    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xp.ziyouguang.Activity_374_Luopan.1
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(2, 139, R.string.str_other_set_compass_Calibration);
        ...
        CarInfo carInfo2 = new CarInfo(2, 140, R.string.str_compass_deviation_value);

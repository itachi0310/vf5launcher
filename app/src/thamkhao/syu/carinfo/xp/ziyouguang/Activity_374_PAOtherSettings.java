...
public class Activity_374_PAOtherSettings extends Activity {
    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xp.ziyouguang.Activity_374_PAOtherSettings.1
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 373, R.string.str_fuel_saver_display_in_cluster);
        carInfo.setCmd(0, 2);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(1, 374, R.string.str_fwd_collision_sensitivity);
        carInfo2.setCmd(0, 96);
        carInfo2.setDiplsys(new String[]{"OFF", "NEAR", "FAR"});
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 375, R.string.str_park_assist);
        carInfo3.setCmd(0, 97);
        carInfo3.setDiplsys(new String[]{"OFF", "Sound", "Sound+display"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 376, R.string.str_steering_directed_headlights);
        carInfo4.setCmd(0, 98);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 377, R.string.str_auto_on_driver_heated);
        carInfo5.setCmd(0, 99);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 378, R.string.str_srt_mode);
        carInfo6.setCmd(0, 100);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(1, 410, R.string.rzc_side_stop_assit_str);
        carInfo7.setCmd(0, 102);
        carInfo7.setDiplsys(new String[]{"OFF", "Sound", "Sound+display"});
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(1, 411, R.string.rzc_side_stop_assit_str);
        ...
        CarInfo carInfo9 = new CarInfo(1, 413, R.string.str_107_str1);

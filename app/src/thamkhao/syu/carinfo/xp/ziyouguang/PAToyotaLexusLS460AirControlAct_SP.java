    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_pa_jeep_wind_plus_rear /* 2131427964 */:
                data0 = 41;
                break;
            case R.id.air_pa_jeep_mode_rear_plus /* 2131428030 */:
                data0 = 43;
                break;
            case R.id.air_xts_flower /* 2131428031 */:
                data0 = 32;
                break;
            case R.id.air_xts_purifier /* 2131428032 */:
                data0 = 80;
                break;
        }
        if (data0 != 0) {
    ...
    public void mUpdateSyncOn() {
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_PA_BNR_Toyota_GX460_10 /* 6357389 */:
                findViewById(R.id.air_xts_dual).setBackgroundResource(acOn == 0 ? R.drawable.ic_air_pa_jeep_zone_n : R.drawable.ic_air_pa_jeep_zone_p);
                break;
        }
    }

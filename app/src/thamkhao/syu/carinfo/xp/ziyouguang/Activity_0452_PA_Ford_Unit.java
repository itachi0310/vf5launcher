...
public class Activity_0452_PA_Ford_Unit extends Activity {
    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xp.ziyouguang.Activity_0452_PA_Ford_Unit.1
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(3, 110, R.string.str_dongjian_wc2_ds5_car_computer_unit_set);
        carInfo.setCmd(1, 1);

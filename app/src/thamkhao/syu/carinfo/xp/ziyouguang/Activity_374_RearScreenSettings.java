...
public class Activity_374_RearScreenSettings extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 345, R.string.str_rear_seat_screen);
        carInfo.setCmd(18, 0);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 346, R.string.str_remote_control_lock);
        carInfo2.setCmd(18, 1);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 347, R.string.str_backseat_media_source);

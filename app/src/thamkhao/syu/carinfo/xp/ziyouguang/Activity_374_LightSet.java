...
public class Activity_374_LightSet extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(1, 98, R.string.rzc_biglight_sleep_value);
        carInfo.setCmd(0, 32);
        carInfo.setDiplsys(new String[]{"0 s", "30 s", "60 s", "90 s"});
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 99, R.string.jeep_locklights);
        carInfo2.setCmd(0, 35);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 100, R.string.wc_372_nearlight);
        carInfo3.setCmd(0, 33);
        carInfo3.setDiplsys(new String[]{"0 s", "30 s", "60 s", "90 s"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 101, R.string.wc_372_daylightstr);
        carInfo4.setCmd(0, 36);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 102, R.string.str_cornering_lights);
        carInfo5.setCmd(0, 37);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 103, R.string.str_374_lightwiper);
        carInfo6.setCmd(0, 38);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 104, R.string.jeep_373_rearview_mirror);
        carInfo7.setCmd(0, 39);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(0, 105, R.string.jeep_autodimminghighbeams);
        carInfo8.setCmd(0, 40);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(1, 106, R.string.str_372_headlight_sensitivity);
        carInfo9.setCmd(0, 41);
        carInfo9.setDiplsys(new String[]{"1", "2", "3"});
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(1, 175, R.string.str_turui_str5);
        carInfo10.setCmd(0, 43);
        carInfo10.setDiplsys(new String[]{"0", "1", "2", "3", "4", "5", "6"});
        this.mList.add(carInfo10);
        CarInfo carInfo11 = new CarInfo(0, 107, R.string.str_372_greeting_light);
        carInfo11.setCmd(0, 42);
        this.mList.add(carInfo11);
        CarInfo carInfo12 = new CarInfo(0, 167, R.string.str_374_lightwiper);
        carInfo12.setCmd(0, 34);
        this.mList.add(carInfo12);
        CarInfo carInfo13 = new CarInfo(0, 382, R.string.str_adaptive_front_lights);
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < this.mList.size(); i++) {
            if (this.mList.get(i).getUpdateCode() == 103 || this.mList.get(i).getUpdateCode() == 104) {
            ...
            if (this.mList.get(i).getUpdateCode() == 100 || this.mList.get(i).getUpdateCode() == 105) {
                if (DataCanbus.carId == 0 || DataCanbus.carId == 1 || DataCanbus.carId == 14 || DataCanbus.carId == 15 || DataCanbus.carId == 21 || DataCanbus.carId == 22 || DataCanbus.carId == 23 || DataCanbus.carId == 24 || DataCanbus.carId == 25 || DataCanbus.carId == 26 || DataCanbus.carId == 28 || DataCanbus.carId == 29 || DataCanbus.carId == 32 || DataCanbus.carId == 33 || DataCanbus.carId == 40 || DataCanbus.carId == 41 || DataCanbus.carId == 42 || DataCanbus.carId == 43) {
                    this.mList.get(i).setShowable(true);
                } else {
                    this.mList.get(i).setShowable(false);
            ...
            if (this.mList.get(i).getUpdateCode() == 107) {
            ...
            if (this.mList.get(i).getUpdateCode() == 382) {
            ...
            if (this.mList.get(i).getUpdateCode() == 106) {
            ...
            if (DataCanbus.carId == 10) {
                if (this.mList.get(i).getUpdateCode() == 100 || this.mList.get(i).getUpdateCode() == 167) {
                    this.mList.get(i).setShowable(true);
                }
                if (this.mList.get(i).getUpdateCode() == 102 || this.mList.get(i).getUpdateCode() == 101) {
                    this.mList.get(i).setShowable(false);
                }
            }
            ...
            if (this.mList.get(i).getUpdateCode() == 167) {

...
public class Activity_374_Suspension extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 144, R.string.str_373_auto_adjust_suspension);
        ...
        CarInfo carInfo2 = new CarInfo(0, 145, R.string.str_373_tire_jacks);
        carInfo2.setCmd(0, 209);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 146, R.string.str_373_transport_mode);
        carInfo3.setCmd(0, 210);
        carInfo3.setDiplsys(new String[]{"KM", "MI"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 147, R.string.str_373_wheel_alignment_mode);
        carInfo4.setCmd(0, 211);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(3, 148, R.string.str_373_display_suspension1);
        ...
        CarInfo carInfo6 = new CarInfo(0, 220, R.string.str_flash_Light_with_Lower);
        carInfo6.setCmd(0, 228);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 221, R.string.str_sound_Horn_with_Lower);
        carInfo7.setCmd(0, 229);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(0, 222, R.string.str_aero_Mode);

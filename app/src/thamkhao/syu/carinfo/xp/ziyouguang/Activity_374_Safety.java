...
public class Activity_374_Safety extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(3, 122, R.string.jeep_parksense);
        ...
        CarInfo carInfo2 = new CarInfo(0, 123, R.string.wc_372_parksensebreakstr);
        carInfo2.setCmd(0, 163);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 124, R.string.wc_372_video_movestr);
        carInfo3.setCmd(0, 164);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 125, R.string.wc_372_video_staticstr);
        carInfo4.setCmd(0, 165);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 126, R.string.xp_yl_lane_assist_str);
        carInfo5.setCmd(0, 166);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(1, 127, R.string.jeep_blindwarn);
        ...
        CarInfo carInfo7 = new CarInfo(1, 128, R.string.wc_372_frontsensevolstr);
        ...
        CarInfo carInfo8 = new CarInfo(1, 129, R.string.wc_372_backsensevolstr);
        ...
        CarInfo carInfo9 = new CarInfo(3, 130, R.string.jeep_forwardcollisionwarn);
        ...
        CarInfo carInfo10 = new CarInfo(1, 207, R.string.jeep_forwardcollisionwarn);
        ...
        CarInfo carInfo11 = new CarInfo(1, 131, R.string.jeep_forwardcollisionbrake);
        ...
        CarInfo carInfo12 = new CarInfo(0, 132, R.string.str_373_parksense_brakeassist);
        carInfo12.setCmd(0, 173);
        this.mList.add(carInfo12);
        CarInfo carInfo13 = new CarInfo(1, 133, R.string.str_lanesense_strength);
        ...
        CarInfo carInfo14 = new CarInfo(0, 134, R.string.wc_372_rainautostr);
        carInfo14.setCmd(0, 175);
        this.mList.add(carInfo14);
        CarInfo carInfo15 = new CarInfo(0, 135, R.string.jeep_rear_parksense_auto_brakeassist);
        carInfo15.setCmd(0, 240);
        this.mList.add(carInfo15);
        CarInfo carInfo16 = new CarInfo(0, 136, R.string.jeep_auto_parksense_brakeassist);
        carInfo16.setCmd(0, 241);
        this.mList.add(carInfo16);
        CarInfo carInfo17 = new CarInfo(1, 137, R.string.wc_372_lanewar);
        ...
        CarInfo carInfo18 = new CarInfo(0, 174, R.string.str_374_hillstart);
        carInfo18.setCmd(0, 16);
        this.mList.add(carInfo18);
        CarInfo carInfo19 = new CarInfo(0, 215, R.string.wc_372_front_video_staticstr);
        carInfo19.setCmd(0, 198);
        this.mList.add(carInfo19);
        CarInfo carInfo20 = new CarInfo(0, 216, R.string.wc_372_tire_fill_assist);
        carInfo20.setCmd(0, 197);
        this.mList.add(carInfo20);
        CarInfo carInfo21 = new CarInfo(1, 214, R.string.str_deploy_step);
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < this.mList.size(); i++) {
            if (this.mList.get(i).getUpdateCode() == 215 || this.mList.get(i).getUpdateCode() == 216) {
            ...
            if (this.mList.get(i).getUpdateCode() == 130) {
                if (DataCanbus.DATA[1000] == 1376630 || DataCanbus.DATA[1000] == 1442166 || DataCanbus.DATA[1000] == 1507702 || DataCanbus.DATA[1000] == 1573238 || DataCanbus.DATA[1000] == 1638774 || DataCanbus.DATA[1000] == 1704310 || DataCanbus.DATA[1000] == 2621814 || DataCanbus.DATA[1000] == 2687350 || DataCanbus.DATA[1000] == 2752886 || DataCanbus.DATA[1000] == 2818422 || DataCanbus.DATA[1000] == 1835382 || DataCanbus.DATA[1000] == 1900918 || DataCanbus.DATA[1000] == 2097526 || DataCanbus.DATA[1000] == 2163062) {
                    this.mList.get(i).setShowable(false);
                } else {
                    this.mList.get(i).setShowable(true);
            ...
            if (this.mList.get(i).getUpdateCode() == 124 || this.mList.get(i).getUpdateCode() == 122) {
            ...
            if (this.mList.get(i).getUpdateCode() == 174) {

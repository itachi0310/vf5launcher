...
public class Activity_374_Door_Lock extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 108, R.string.str_298_auto_door_unlock);
        carInfo.setCmd(0, 48);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 109, R.string.wc_372_offautolocktstr);
        carInfo2.setCmd(0, 49);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(0, 110, R.string.wc_372_lockturnlightstr);
        carInfo3.setCmd(0, 50);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(1, 111, R.string.wc_372_lock_voice);
        ...
        CarInfo carInfo5 = new CarInfo(0, 112, R.string.str_smar_key_settings);
        carInfo5.setCmd(0, 56);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 113, R.string.wc_372_dorrwarringstr);
        carInfo6.setCmd(0, 58);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(3, 114, R.string.jeep_presskeyunlock);
        ...
        CarInfo carInfo8 = new CarInfo(0, 115, R.string.jeep_keylessentry);
        carInfo8.setCmd(0, 54);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(0, 116, R.string.c_321_civic_beep_start_str);
        carInfo9.setCmd(0, 59);
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(0, 117, R.string.str_remote_door_unlock);
        carInfo10.setCmd(0, 60);
        this.mList.add(carInfo10);
        CarInfo carInfo11 = new CarInfo(0, 168, R.string.str_374_hornlock);
        carInfo11.setCmd(0, 51);
        this.mList.add(carInfo11);
        CarInfo carInfo12 = new CarInfo(0, 169, R.string.str_374_autoclose);
        carInfo12.setCmd(0, 53);
        this.mList.add(carInfo12);
        CarInfo carInfo13 = new CarInfo(0, 218, R.string.jeep_powertailgatealarm);
        carInfo13.setCmd(0, 57);
        this.mList.add(carInfo13);
        CarInfo carInfo14 = new CarInfo(0, 215, R.string.klc_comfort_Automatic_folding_mirrors);
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < this.mList.size(); i++) {
            if (this.mList.get(i).getUpdateCode() == 112 || this.mList.get(i).getUpdateCode() == 114 || this.mList.get(i).getUpdateCode() == 113) {
            ...
            if (this.mList.get(i).getUpdateCode() == 215) {
            ...
            if (this.mList.get(i).getUpdateCode() == 116) {
            ...
            if (this.mList.get(i).getUpdateCode() == 117) {
            ...
            if (this.mList.get(i).getUpdateCode() == 168) {
            ...
            if (DataCanbus.DATA[1000] == 655734 || DataCanbus.DATA[1000] == 4063606 || DataCanbus.DATA[1000] == 4129142) {
                if (this.mList.get(i).getUpdateCode() == 114 || this.mList.get(i).getUpdateCode() == 168) {
                    this.mList.get(i).setShowable(true);
                }
                if (this.mList.get(i).getUpdateCode() == 111 || this.mList.get(i).getUpdateCode() == 115 || this.mList.get(i).getUpdateCode() == 169) {
                    this.mList.get(i).setShowable(false);
                }
            }
            if (DataCanbus.DATA[1000] == 524662) {
                if (this.mList.get(i).getUpdateCode() == 169) {
                    this.mList.get(i).setShowable(true);
                } else {
                    this.mList.get(i).setShowable(false);
                }

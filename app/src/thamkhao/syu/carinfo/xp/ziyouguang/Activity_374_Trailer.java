...
public class Activity_374_Trailer extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(1, 170, R.string.str_374_trailer);
        carInfo.setCmd(0, 80);
        carInfo.setDiplsys(new String[]{"Trailer 1", "Trailer 2", "Trailer 3", "Trailer 4"});
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(1, 171, R.string.str_374_trailertype);
        ...
        CarInfo carInfo3 = new CarInfo(1, 319, R.string.str_374_trailer_length);
        carInfo3.setCmd(0, 82);
        carInfo3.setDiplsys(new String[]{"Auto", "Max(39.5 ft)"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(1, 397, R.string.str_374_trailer_name);

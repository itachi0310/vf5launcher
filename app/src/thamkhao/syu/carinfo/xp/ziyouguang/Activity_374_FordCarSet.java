...
public class Activity_374_FordCarSet extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(1, 436, R.string.str_wc_174008_str1);
        carInfo.setCmd(0, 16);
        carInfo.setDiplsys(new String[]{"alert", "aid", "aid+alert"});
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(1, 437, R.string.str_lane_assist_sensitivity);
        ...
        CarInfo carInfo3 = new CarInfo(0, 438, R.string.bsd_klj_str9);
        carInfo3.setCmd(0, 18);
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(1, 439, R.string.dj_airuize7_warning);
        ...
        CarInfo carInfo5 = new CarInfo(0, 440, R.string.rzc_others_assist_car_assister);
        carInfo5.setCmd(0, 20);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 441, R.string.str_rear_view_camera_delay);
        carInfo6.setCmd(0, 21);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(0, 442, "Evasive Steering");
        carInfo7.setCmd(0, 22);
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(0, 443, "Blind Spot Information System");
        carInfo8.setCmd(0, 23);
        this.mList.add(carInfo8);
        CarInfo carInfo9 = new CarInfo(0, 444, "Trailer Sway Control");
        carInfo9.setCmd(0, 24);
        this.mList.add(carInfo9);
        CarInfo carInfo10 = new CarInfo(0, 445, "Park Aid");
        carInfo10.setCmd(0, 25);
        this.mList.add(carInfo10);
        CarInfo carInfo11 = new CarInfo(0, 446, "Cross Traffic Alert");
        carInfo11.setCmd(0, 26);
        this.mList.add(carInfo11);
        CarInfo carInfo12 = new CarInfo(0, 447, "Driver Alert");
        carInfo12.setCmd(0, 27);
        this.mList.add(carInfo12);
        CarInfo carInfo13 = new CarInfo(0, 448, "30 min Max Idle");
        carInfo13.setCmd(0, 28);
        this.mList.add(carInfo13);
        CarInfo carInfo14 = new CarInfo(0, 449, "Activate remote start");
        carInfo14.setCmd(0, 29);
        this.mList.add(carInfo14);
        CarInfo carInfo15 = new CarInfo(1, 450, "Remote Start ->Climate Control");
        carInfo15.setCmd(0, 31);
        carInfo15.setDiplsys(new String[]{"AUTO", "Last"});
        this.mList.add(carInfo15);
        CarInfo carInfo16 = new CarInfo(1, 451, "Remote Start ->Duration");
        carInfo16.setCmd(0, 32);
        carInfo16.setDiplsys(new String[]{"5min", "10min", "15min"});
        this.mList.add(carInfo16);
        CarInfo carInfo17 = new CarInfo(0, 452, "Courtesy Wipe");
        carInfo17.setCmd(0, 33);
        this.mList.add(carInfo17);
        CarInfo carInfo18 = new CarInfo(0, 453, "Reverse Wipe");
        carInfo18.setCmd(0, 34);
        this.mList.add(carInfo18);
        CarInfo carInfo19 = new CarInfo(0, 454, "Mirrors Autofold");
        carInfo19.setCmd(0, 35);
        this.mList.add(carInfo19);
        CarInfo carInfo20 = new CarInfo(0, 455, "Power Liftgate");

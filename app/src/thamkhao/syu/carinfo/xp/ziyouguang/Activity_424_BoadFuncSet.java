...
public class Activity_424_BoadFuncSet extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xp.ziyouguang.Activity_424_BoadFuncSet.1
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value3 = DataCanbus.DATA[159] - 1;
                if (value3 < 1) {
                    value3 = 4;
                }
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int value4 = DataCanbus.DATA[159] + 1;
                if (value4 > 4) {
                    value4 = 1;
                }
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int value5 = DataCanbus.DATA[160] - 5;
                if (value5 < 0) {
                    value5 = 0;
                }
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[160] + 5;
                if (value6 > 100) {
                    value6 = 100;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value7 = DataCanbus.DATA[161];
                if (value7 == 0) {
                    value7 = 1;
                } else if (value7 == 1) {
                    value7 = 0;
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(2, new int[]{97, 0}, null, null);
        addNotify();
    }

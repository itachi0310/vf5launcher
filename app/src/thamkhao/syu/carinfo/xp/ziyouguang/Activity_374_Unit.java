...
public class Activity_374_Unit extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(3, 93, R.string.str_dongjian_wc2_ds5_car_computer_unit_set);
        carInfo.setCmd(0, 1);
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_PA_Ford_mustang_15_CD /* 3998070 */:
                CarInfo carInfo2 = new CarInfo(1, 94, R.string.str_372_oil_unit);
                carInfo2.setCmd(0, 2);
                carInfo2.setDiplsys(new String[]{"Miles&MPG", "km&L/100km", "km&km/L"});
                this.mList.add(carInfo2);
                break;
            default:
                CarInfo carInfo3 = new CarInfo(1, 94, R.string.str_372_oil_unit);
                carInfo3.setCmd(0, 5);
                carInfo3.setDiplsys(new String[]{"L/100KM", "KM/L", "MPG(US)", "MPG(UK)"});
                this.mList.add(carInfo3);
                break;
        }
        CarInfo carInfo4 = new CarInfo(3, 95, R.string.jeep_format_set);
        carInfo4.setCmd(0, 3);
        carInfo4.setDiplsys(new String[]{"KM", "MI"});
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(3, 217, R.string.str_speed_unit);
        carInfo5.setCmd(0, 8);
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_PA_Ford_F_Super_duty_21_CD /* 3866998 */:
            case FinalCanbus.CAR_PA_Ford_mustang_15_CD /* 3998070 */:
                CarInfo carInfo6 = new CarInfo(3, 96, R.string.str_372_temp_unit);
                carInfo6.setCmd(0, 4);
                ...
                break;
            default:
                CarInfo carInfo7 = new CarInfo(3, 96, R.string.str_372_temp_unit);
                carInfo7.setCmd(0, 4);

...
public class PAJeepDrivingHistroyAct extends BaseActivity {
    ...
    public void mUpdateDayNews() {
        int engine = DataCanbus.DATA[240];
        int battery = DataCanbus.DATA[241];
        ...
        int engine1 = DataCanbus.DATA[242];
        int battery1 = DataCanbus.DATA[243];
        ...
        int engine2 = DataCanbus.DATA[244];
        int battery2 = DataCanbus.DATA[245];
        ...
        int engine3 = DataCanbus.DATA[246];
        int battery3 = DataCanbus.DATA[247];
        ...
        int engine4 = DataCanbus.DATA[248];
        int battery4 = DataCanbus.DATA[249];
        ...
        int engine5 = DataCanbus.DATA[250];
        int battery5 = DataCanbus.DATA[251];
        ...
        int engine6 = DataCanbus.DATA[252];
        int battery6 = DataCanbus.DATA[253];
        ...
        int engine7 = DataCanbus.DATA[254];
        int battery7 = DataCanbus.DATA[255];
        ...
        int engine8 = DataCanbus.DATA[256];
        int battery8 = DataCanbus.DATA[257];
        ...
        int engine9 = DataCanbus.DATA[258];
        int battery9 = DataCanbus.DATA[259];
        ...
        int engine10 = DataCanbus.DATA[260];
        int battery10 = DataCanbus.DATA[261];
        ...
        int engine11 = DataCanbus.DATA[262];
        int battery11 = DataCanbus.DATA[263];
        ...
        int engine12 = DataCanbus.DATA[264];
        int battery12 = DataCanbus.DATA[265];
        ...
        int engine13 = DataCanbus.DATA[266];
        int battery13 = DataCanbus.DATA[267];

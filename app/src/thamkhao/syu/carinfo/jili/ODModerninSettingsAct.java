...
public class ODModerninSettingsAct extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.jili.ODModerninSettingsAct.1
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                ...
                case 131:
                case 133:
                    int b3 = DataCanbus.DATA[130];
                    int b2 = DataCanbus.DATA[131];
                    int b0 = DataCanbus.DATA[133];
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus6 /* 2131427470 */:
                int value11 = DataCanbus.DATA[102] - 1;
                if (value11 < 0) {
                    value11 = 4;
                }
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                int value34 = DataCanbus.DATA[100];
                if (value34 == 1) {
                    value34 = 0;
                } else if (value34 == 0) {
                    value34 = 1;
            ...
            case R.id.ctv_checkedtext8 /* 2131427555 */:
                int value40 = DataCanbus.DATA[116];
                if (value40 == 1) {
                    value40 = 0;
                } else if (value40 == 0) {
                    value40 = 1;
            ...
            case R.id.ctv_checkedtext14 /* 2131427561 */:
                int value43 = DataCanbus.DATA[134];
                if (value43 == 1) {
                    value43 = 0;
                } else if (value43 == 0) {
                    value43 = 1;
            ...
            case R.id.ctv_checkedtext15 /* 2131427562 */:
                int value44 = DataCanbus.DATA[135];
                if (value44 == 1) {
                    value44 = 0;
                } else if (value44 == 0) {
                    value44 = 1;

    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int value5 = DataCanbus.DATA[177] - 1;
                if (value5 < 0) {
                    value5 = 3;
                }
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[177] + 1;
                if (value6 > 3) {
                    value6 = 0;
                }
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                int value7 = DataCanbus.DATA[178] - 1;
                if (value7 < 0) {
                    value7 = 3;
                }
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value8 = DataCanbus.DATA[178] + 1;
                if (value8 > 3) {
                    value8 = 0;
                }
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                int value10 = DataCanbus.DATA[169];
                if (value10 == 1) {
                    value10 = 0;
                } else if (value10 == 0) {
                    value10 = 1;
            ...
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                int value11 = DataCanbus.DATA[171];
                if (value11 == 1) {
                    value11 = 0;
                } else if (value11 == 0) {
                    value11 = 1;
            ...
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                int value12 = DataCanbus.DATA[172];
                if (value12 == 1) {
                    value12 = 0;
                } else if (value12 == 0) {
                    value12 = 1;
            ...
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                int value13 = DataCanbus.DATA[173];
                if (value13 == 1) {
                    value13 = 0;
                } else if (value13 == 0) {
                    value13 = 1;

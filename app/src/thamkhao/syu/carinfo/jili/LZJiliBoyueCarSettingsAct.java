...
public class LZJiliBoyueCarSettingsAct extends BaseActivity implements View.OnClickListener {
    private int[] eventIds = {94, 95, 96, 97, 98, 99, 100, 101, 102};
    ...
    public void addNotify() {
        DataCanbus.PROXY.cmd(1, new int[]{50, 0}, null, null);
    ...
    @Override // com.syu.canbus.BaseActivity
    public void init() {
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext1), 1, 95);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext2), 2, 96);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext8), 12, 97);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext3), 7, 98);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext4), 8, 99);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext5), 9, 100);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext6), 10, 101);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext7), 11, 102);

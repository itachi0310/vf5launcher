        ...
        if (event.getAction() == 0) {
            switch (v.getId()) {
                ...
                case R.id.lexus_radio_fm /* 2131427873 */:
                    DataCanbus.PROXY.cmd(1, new int[]{28, 0}, null, null);
                    break;
            ...
            switch (v.getId()) {
                case R.id.lexus_radio_prev /* 2131427868 */:
                    DataCanbus.PROXY.cmd(1, new int[]{34, 0}, null, null);
                    break;
                case R.id.lexus_radio_next /* 2131427869 */:
                    DataCanbus.PROXY.cmd(1, new int[]{35, 0}, null, null);
                    break;
                case R.id.lexus_radio_scan_plus /* 2131427871 */:
                    DataCanbus.PROXY.cmd(1, new int[]{35, 0}, null, null);
                    break;
                ...
                case R.id.btn_lexus_radio_frq1 /* 2131427876 */:
                    ...
                    this.mHandler.postDelayed(new Runnable() { // from class: com.syu.carinfo.xc.lexus.XCLexusRadio.9
                        @Override // java.lang.Runnable
                        public void run() {
                            DataCanbus.PROXY.cmd(1, new int[]{32, 0}, null, null);
                        }
                    }, 100L);
                    break;
                case R.id.btn_lexus_radio_frq2 /* 2131427878 */:

    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int value9 = DataCanbus.DATA[95] + 1;
                if (value9 > 2) {
                    value9 = 0;
                }
                setCarInfo(1, value9);
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value10 = DataCanbus.DATA[97];
                if (value10 == 0) {
                    value10 = 90;
                } else if (value10 == 1) {
                    value10 = 0;
            ...
            case R.id.btn_minus6 /* 2131427470 */:
                int vol = DataCanbus.DATA[106];
                int bal = DataCanbus.DATA[107];
                int fad = DataCanbus.DATA[108];
                int bass = DataCanbus.DATA[109];
                int mid = DataCanbus.DATA[110];
                int treb = DataCanbus.DATA[111];
                int onoff = DataCanbus.DATA[112];
                if (vol > 0) {
                    vol--;
                }
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int vol2 = DataCanbus.DATA[106];
                int bal2 = DataCanbus.DATA[107];
                int fad2 = DataCanbus.DATA[108];
                int bass2 = DataCanbus.DATA[109];
                int mid2 = DataCanbus.DATA[110];
                int treb2 = DataCanbus.DATA[111];
                int onoff2 = DataCanbus.DATA[112];
                if (vol2 < 38) {
                    vol2++;
                }
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int vol3 = DataCanbus.DATA[106];
                int bal3 = DataCanbus.DATA[107];
                int fad3 = DataCanbus.DATA[108];
                int bass3 = DataCanbus.DATA[109];
                int mid3 = DataCanbus.DATA[110];
                int treb3 = DataCanbus.DATA[111];
                int onoff3 = DataCanbus.DATA[112];
                if (bal3 > 0) {
                    bal3--;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int vol4 = DataCanbus.DATA[106];
                int bal4 = DataCanbus.DATA[107];
                int fad4 = DataCanbus.DATA[108];
                int bass4 = DataCanbus.DATA[109];
                int mid4 = DataCanbus.DATA[110];
                int treb4 = DataCanbus.DATA[111];
                int onoff4 = DataCanbus.DATA[112];
                if (bal4 < 19) {
                    bal4++;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int vol5 = DataCanbus.DATA[106];
                int bal5 = DataCanbus.DATA[107];
                int fad5 = DataCanbus.DATA[108];
                int bass5 = DataCanbus.DATA[109];
                int mid5 = DataCanbus.DATA[110];
                int treb5 = DataCanbus.DATA[111];
                int onoff5 = DataCanbus.DATA[112];
                if (fad5 > 0) {
                    fad5--;
                }
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int vol6 = DataCanbus.DATA[106];
                int bal6 = DataCanbus.DATA[107];
                int fad6 = DataCanbus.DATA[108];
                int bass6 = DataCanbus.DATA[109];
                int mid6 = DataCanbus.DATA[110];
                int treb6 = DataCanbus.DATA[111];
                int onoff6 = DataCanbus.DATA[112];
                if (fad6 < 19) {
                    fad6++;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int vol7 = DataCanbus.DATA[106];
                int bal7 = DataCanbus.DATA[107];
                int fad7 = DataCanbus.DATA[108];
                int bass7 = DataCanbus.DATA[109];
                int mid7 = DataCanbus.DATA[110];
                int treb7 = DataCanbus.DATA[111];
                int onoff7 = DataCanbus.DATA[112];
                if (bass7 > 0) {
                    bass7--;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int vol8 = DataCanbus.DATA[106];
                int bal8 = DataCanbus.DATA[107];
                int fad8 = DataCanbus.DATA[108];
                int bass8 = DataCanbus.DATA[109];
                int mid8 = DataCanbus.DATA[110];
                int treb8 = DataCanbus.DATA[111];
                int onoff8 = DataCanbus.DATA[112];
                if (bass8 < 19) {
                    bass8++;
                }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int vol9 = DataCanbus.DATA[106];
                int bal9 = DataCanbus.DATA[107];
                int fad9 = DataCanbus.DATA[108];
                int bass9 = DataCanbus.DATA[109];
                int mid9 = DataCanbus.DATA[110];
                int treb9 = DataCanbus.DATA[111];
                int onoff9 = DataCanbus.DATA[112];
                if (mid9 > 0) {
                    mid9--;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int vol10 = DataCanbus.DATA[106];
                int bal10 = DataCanbus.DATA[107];
                int fad10 = DataCanbus.DATA[108];
                int bass10 = DataCanbus.DATA[109];
                int mid10 = DataCanbus.DATA[110];
                int treb10 = DataCanbus.DATA[111];
                int onoff10 = DataCanbus.DATA[112];
                if (mid10 < 19) {
                    mid10++;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int vol11 = DataCanbus.DATA[106];
                int bal11 = DataCanbus.DATA[107];
                int fad11 = DataCanbus.DATA[108];
                int bass11 = DataCanbus.DATA[109];
                int mid11 = DataCanbus.DATA[110];
                int treb11 = DataCanbus.DATA[111];
                int onoff11 = DataCanbus.DATA[112];
                if (treb11 > 0) {
                    treb11--;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int vol12 = DataCanbus.DATA[106];
                int bal12 = DataCanbus.DATA[107];
                int fad12 = DataCanbus.DATA[108];
                int bass12 = DataCanbus.DATA[109];
                int mid12 = DataCanbus.DATA[110];
                int treb12 = DataCanbus.DATA[111];
                int onoff12 = DataCanbus.DATA[112];
                if (treb12 < 19) {
                    treb12++;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int vol13 = DataCanbus.DATA[106];
                int bal13 = DataCanbus.DATA[107];
                int fad13 = DataCanbus.DATA[108];
                int bass13 = DataCanbus.DATA[109];
                int mid13 = DataCanbus.DATA[110];
                int treb13 = DataCanbus.DATA[111];
                int onoff13 = DataCanbus.DATA[112];
                if (onoff13 > 0) {
                    onoff13--;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int vol14 = DataCanbus.DATA[106];
                int bal14 = DataCanbus.DATA[107];
                int fad14 = DataCanbus.DATA[108];
                int bass14 = DataCanbus.DATA[109];
                int mid14 = DataCanbus.DATA[110];
                int treb14 = DataCanbus.DATA[111];
                int onoff14 = DataCanbus.DATA[112];
                if (onoff14 < 3) {
                    onoff14++;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value17 = DataCanbus.DATA[113] + 1;
                if (value17 > 1) {
                    value17 = 0;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value19 = DataCanbus.DATA[114] + 1;
                if (value19 > 8) {
                    value19 = 1;
                }

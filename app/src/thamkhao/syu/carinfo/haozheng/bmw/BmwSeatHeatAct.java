...
public class BmwSeatHeatAct extends BaseActivity {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() { // from class: com.syu.carinfo.haozheng.bmw.BmwSeatHeatAct.2
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            int id = v.getId();
            if (action == 0) {
                if (id == R.id.bogoo_bmw_left_seat_heat_btn) {
                ...
                } else if (id == R.id.bogoo_bmw_right_seat_heat_btn) {
                ...
                } else if (id == R.id.bogoo_bmw_radar_switch_btn) {
                ...
                } else if (id == R.id.bogoo_bmw_window_switch_btn) {

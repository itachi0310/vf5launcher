        ...
        builder.setNegativeButton(getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() { // from class: com.syu.carinfo.wc.feiyate.WCFeiyateSetFunc2.3
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new Thread(new Runnable() { // from class: com.syu.carinfo.wc.feiyate.WCFeiyateSetFunc2.3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        DataCanbus.PROXY.cmd(4, new int[]{i, 0}, null, null);
                    }
                }).start();
                dialog.dismiss();
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[133] + 1;
                if (value6 > 2) {
                    value6 = 0;
                }
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value8 = DataCanbus.DATA[134] + 1;
                if (value8 > 2) {
                    value8 = 0;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                int value10 = DataCanbus.DATA[135] + 1;
                if (value10 > 2) {
                    value10 = 0;
                }
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int value12 = DataCanbus.DATA[136] + 1;
                if (value12 > 2) {
                    value12 = 0;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int value14 = DataCanbus.DATA[137] + 1;
                if (value14 > 2) {
                    value14 = 0;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int value15 = DataCanbus.DATA[139] - 1;
                if (value15 < 0) {
                    value15 = 1;
                }
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int value16 = DataCanbus.DATA[139] + 1;
                if (value16 > 1) {
                    value16 = 0;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value17 = DataCanbus.DATA[140] - 1;
                if (value17 < 0) {
                    value17 = 2;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value18 = DataCanbus.DATA[140] + 1;
                if (value18 > 2) {
                    value18 = 0;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int value21 = DataCanbus.DATA[146] - 5;
                if (value21 < 30) {
                    value21 = 30;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int value22 = DataCanbus.DATA[146] + 5;
                if (value22 > 180) {
                    value22 = 180;
                }
            ...
            case R.id.btn_minus13 /* 2131427491 */:
                int value25 = DataCanbus.DATA[160] - 1;
                if (value25 < 0) {
                    value25 = 2;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value26 = DataCanbus.DATA[160] + 1;
                if (value26 > 2) {
                    value26 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value27 = DataCanbus.DATA[161] - 1;
                if (value27 < 0) {
                    value27 = 2;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value28 = DataCanbus.DATA[161] + 1;
                if (value28 > 2) {
                    value28 = 0;
                }
            ...
            case R.id.btn_minus15 /* 2131427520 */:
                int value29 = DataCanbus.DATA[162] - 1;
                if (value29 < 0) {
                    value29 = 2;
                }
            ...
            case R.id.btn_plus15 /* 2131427522 */:
                int value30 = DataCanbus.DATA[162] + 1;
                if (value30 > 2) {
                    value30 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                setCarInfo(46, DataCanbus.DATA[138] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCarInfo(37, DataCanbus.DATA[141] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                setCarInfo(38, DataCanbus.DATA[142] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                setCarInfo(32, DataCanbus.DATA[145] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                dialog(R.string.jeep_brakemode, 34);
                break;
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                setCarInfo(50, DataCanbus.DATA[159] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                setCarInfo(53, DataCanbus.DATA[163] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext8 /* 2131427555 */:
                setCarInfo(54, DataCanbus.DATA[164] != 1 ? 1 : 0);
                break;
        }
    }

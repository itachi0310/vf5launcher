    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.wc.leinuo.LeinuoGuanjingSetActi.1
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                ...
                case 158:
                case 159:
                    int msb = DataCanbus.DATA[158];
                    int lsb = DataCanbus.DATA[159];
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                int value10 = DataCanbus.DATA[151];
                if (value10 == 0) {
                    value10 = 1;
                } else if (value10 == 1) {
                    value10 = 0;
            ...
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                int value11 = DataCanbus.DATA[152];
                if (value11 == 0) {
                    value11 = 1;
                } else if (value11 == 1) {
                    value11 = 0;
            ...
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                int value12 = DataCanbus.DATA[153];
                if (value12 == 0) {
                    value12 = 1;
                } else if (value12 == 1) {
                    value12 = 0;
            ...
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                int value15 = DataCanbus.DATA[160];
                if (value15 == 0) {
                    value15 = 1;
                } else if (value15 == 1) {
                    value15 = 0;

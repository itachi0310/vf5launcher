...
public class JYCarLightSet extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.ctv_toplight_delay_view /* 2131433018 */:
            case R.id.ctv_toplight_delay /* 2131433019 */:
                int id67d0b1 = (DataCanbus.DATA[89] & 15) + 1;
                DataCanbus.PROXY.cmd(1, new int[]{2, id67d0b1 % strId67d0b1.length}, null, null);
                break;
            case R.id.ctv_time2savepower_view /* 2131433021 */:
            case R.id.ctv_time2savepower /* 2131433022 */:

...
public class Wc_420_crown_CarCD extends BaseActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.jeep_btn_random /* 2131427742 */:
                ...
                break;
            case R.id.jeep_btn_disc_prev /* 2131430031 */:
                DataCanbus.PROXY.cmd(1, 6, 1);
                break;
            case R.id.jeep_btn_disc_next /* 2131430032 */:
                DataCanbus.PROXY.cmd(1, 6, 0);
                break;
            case R.id.jeep_btn_scan /* 2131430033 */:
                if (this.scan_disc == 1) {
    ...
    public boolean onLongClick(View v) {
        ...
        switch (id) {
            case R.id.jeep_btn_play /* 2131427589 */:
                DataCanbus.PROXY.cmd(1, 8, 0);
                return true;
            case R.id.jeep_btn_pause /* 2131427590 */:
                DataCanbus.PROXY.cmd(1, 8, 1);
                return true;
            case R.id.jeep_btn_fr /* 2131427625 */:
                DataCanbus.PROXY.cmd(1, 6, 1);
                return true;

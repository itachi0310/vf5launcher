...
public class Wc_372_CdAct extends BaseActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.wc_ziyouguang_cd_prev /* 2131429462 */:
                CD_CONRTROL_CMD(3, 0, 0);
                break;
            case R.id.wc_ziyouguang_cd_repeat /* 2131429463 */:
                CD_CONRTROL_CMD(5, this.cycleState == 1 ? 0 : 1, 0);
                break;
            case R.id.wc_ziyouguang_cd_repeat_random /* 2131429464 */:
                CD_CONRTROL_CMD(6, this.randomState == 1 ? 0 : 1, 0);
                break;
            case R.id.wc_ziyouguang_play /* 2131429465 */:
                CD_CONRTROL_CMD(1, 0, 0);
                break;
            case R.id.wc_ziyouguang_cd_pause /* 2131429466 */:
                CD_CONRTROL_CMD(2, 0, 0);
                break;
            case R.id.wc_ziyouguang_cd_next /* 2131429467 */:
    ...
    public boolean onLongClick(View v) {
        switch (v.getId()) {
            case R.id.wc_ziyouguang_cd_prev /* 2131429462 */:
                CD_CONRTROL_CMD(3, 1, 0);
                return false;
            case R.id.wc_ziyouguang_cd_next /* 2131429467 */:
                CD_CONRTROL_CMD(4, 1, 0);
                return false;
            default:
                return false;
        }

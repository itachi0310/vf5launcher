    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_air_temp_left_plus /* 2131427425 */:
                ...
                DataCanbus.PROXY.cmd(0, new int[]{13, 0}, null, null);
                break;
            ...
            case R.id.air_xts_power /* 2131427428 */:
                ...
                DataCanbus.PROXY.cmd(0, new int[]{1, 0}, null, null);
                break;
            case R.id.dj_xts_air_win_minuts_btn /* 2131427429 */:
                DataCanbus.PROXY.cmd(0, new int[]{12, 1}, null, null);
                DataCanbus.PROXY.cmd(0, new int[]{12, 0}, null, null);
                break;
            case R.id.dj_xts_air_win_plus_btn /* 2131427431 */:
                DataCanbus.PROXY.cmd(0, new int[]{11, 1}, null, null);
                DataCanbus.PROXY.cmd(0, new int[]{11, 0}, null, null);
                break;
            ...
            case R.id.air_xts_ac /* 2131427439 */:
                ...
                DataCanbus.PROXY.cmd(0, new int[]{2, 0}, null, null);
                break;
            case R.id.air_xts_maxac /* 2131427440 */:
                DataCanbus.PROXY.cmd(0, new int[]{30, 1}, null, null);
                DataCanbus.PROXY.cmd(0, new int[]{30, 0}, null, null);
                break;

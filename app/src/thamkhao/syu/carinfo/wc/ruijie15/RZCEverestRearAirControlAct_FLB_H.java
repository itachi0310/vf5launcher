...
public class RZCEverestRearAirControlAct_FLB_H extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.wc.ruijie15.RZCEverestRearAirControlAct_FLB_H.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 40:
                    RZCEverestRearAirControlAct_FLB_H.this.mUpdateAirTempLeft();
                    break;
                case 42:
                    RZCEverestRearAirControlAct_FLB_H.this.mUpdatePowerOn();
                    break;
                case 44:
                    RZCEverestRearAirControlAct_FLB_H.this.mUpdaterAirWindLevelLeft();
                    break;
                case 67:
                    RZCEverestRearAirControlAct_FLB_H.this.mUpdateRearCtrlOn();
                    break;
            }
        }
    };

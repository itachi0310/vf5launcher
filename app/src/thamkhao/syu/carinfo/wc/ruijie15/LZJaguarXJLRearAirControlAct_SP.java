    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_power /* 2131427428 */:
                data0 = (DataCanbus.DATA[1000] == 12779972 || DataCanbus.DATA[1000] == 13238724) ? 52 : 11;
                break;
            case R.id.dj_xts_air_win_minuts_btn /* 2131427429 */:
                data0 = (DataCanbus.DATA[1000] == 12779972 || DataCanbus.DATA[1000] == 13238724) ? 54 : 6;
                break;
            case R.id.dj_xts_air_win_plus_btn /* 2131427431 */:
                data0 = (DataCanbus.DATA[1000] == 12779972 || DataCanbus.DATA[1000] == 13238724) ? 53 : 5;
                break;
            ...
            case R.id.air_xts_mode_foot_right /* 2131428595 */:
                data0 = 39;
                break;
            case R.id.air_xts_blowbody_rear /* 2131428596 */:
                data0 = 55;
                break;
        }
        if (!flag) {

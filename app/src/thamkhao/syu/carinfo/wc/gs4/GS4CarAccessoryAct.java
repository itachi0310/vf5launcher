    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.wc_gs4_romote_unlock_check /* 2131429074 */:
                int mRomoteUnlockInt = DataCanbus.DATA[107];
            ...
            case R.id.wc_gs4_car_speed_lock_check /* 2131429076 */:
                int mSpeedLockInt = DataCanbus.DATA[108];
            ...
            case R.id.wc_gs4_auto_unlock_check /* 2131429077 */:
                int mAutoLockInt = DataCanbus.DATA[109];
            ...
            case R.id.wc_gs4_romote_front_rear_window_check /* 2131429078 */:
                int mRomoteFrontWindInt = DataCanbus.DATA[110];
            ...
            case R.id.wc_gs4_front_yugua_weihu_check /* 2131429079 */:
                int mFrontYuGuaFixInt = DataCanbus.DATA[111];
            ...
            case R.id.wc_gs4_rear_yugua_check /* 2131429080 */:
                int mRearYuGuaInt = DataCanbus.DATA[112];
                ...
                break;
            case R.id.wc_ga6_auto_fold_outside_mirrors /* 2131429117 */:
                int mAutoFoldOutSideMirrors = DataCanbus.DATA[113];
                ...
                break;
            case R.id.wc_gs3_unlock_whistle_tone /* 2131429119 */:
                int mUnlockWhistleTone = DataCanbus.DATA[118];

...
public class ActivityChangAnCS75 extends Activity {
    ...
    private void addNotify() {
        DataCanbus.NOTIFY_EVENTS[95].addNotify(this.canbusNotify, 1);
        DataCanbus.NOTIFY_EVENTS[96].addNotify(this.canbusNotify, 1);
    }

    private void removeNotify() {
        DataCanbus.NOTIFY_EVENTS[95].removeNotify(this.canbusNotify);
        DataCanbus.NOTIFY_EVENTS[96].removeNotify(this.canbusNotify);
    }
}

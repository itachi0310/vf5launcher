...
public class FocusSyncBtActi extends BaseActivity implements View.OnClickListener {
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (DataCanbus.DATA[1000] == 293 || DataCanbus.DATA[1000] == 319 || DataCanbus.DATA[1000] == 65855) {
                switch (updateCode) {
                    ...
                    case 98:
                        ...
                        break;
                    case 99:
                        FocusSyncBtActi.this.setTime(DataCanbus.DATA[99]);
                        break;
                    case 101:
            ...
            switch (updateCode) {
                ...
                case 96:
                    ...
                    break;
                case 97:
                    FocusSyncBtActi.this.setTime(DataCanbus.DATA[97]);
                    break;
                case 98:
                    if (ints != null && ints.length > 0) {
                        int value3 = ints[0];
    ...
    Runnable setAutoRequest = new Runnable() { // from class: com.syu.carinfo.focus.FocusSyncBtActi.5
        ...
        public void run() {
            int workState = DataCanbus.DATA[103];
    ...
    private boolean isBtState() {
        if (DataCanbus.DATA[1000] == 293 || DataCanbus.DATA[1000] == 319 || DataCanbus.DATA[1000] == 65855) {
            return DataCanbus.DATA[98] == 2;
        }
        if (isCanbusWC()) {
            return DataCanbus.DATA[99] == 2;
        }
        return isSyncPhoto();
    }

    private boolean isSyncPhoto() {
        return DataCanbus.DATA[103] == 3;
    }
    ...
    private void addUpdate() {
        ...
        DataCanbus.NOTIFY_EVENTS[97].addNotify(this.mNotifyCanbus, 1);
        DataCanbus.NOTIFY_EVENTS[98].addNotify(this.mNotifyCanbus, 1);
        DataCanbus.NOTIFY_EVENTS[99].addNotify(this.mNotifyCanbus, 0);
        DataCanbus.NOTIFY_EVENTS[101].addNotify(this.mNotifyCanbus, 1);
        DataCanbus.NOTIFY_EVENTS[102].addNotify(this.mNotifyCanbus, 1);
        DataCanbus.NOTIFY_EVENTS[106].addNotify(this.mNotifyCanbus, 0);
    ...
    private void onClickWCFocus(View v) {
        switch (v.getId()) {
            case R.id.sync_speech /* 2131430973 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 18);
                break;
            case R.id.sync_usbIpod /* 2131430974 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 17);
                break;
            case R.id.sync_info /* 2131430975 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 19);
                break;
            case R.id.sync_ok /* 2131430976 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 16);
                break;
            case R.id.sync_up /* 2131430977 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 12);
                break;
            case R.id.sync_left /* 2131430978 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 14);
                break;
            case R.id.sync_right /* 2131430979 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 15);
                break;
            case R.id.sync_down /* 2131430980 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 13);
                break;
            case R.id.sync_prev /* 2131430981 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 10);
                break;
            case R.id.sync_next /* 2131430982 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 11);
                break;
            case R.id.sync_bottom_btn1 /* 2131431005 */:
                FocusFun.C_SET_BUTTON_TOUCH(1, 1);
                break;
            case R.id.sync_bottom_btn2 /* 2131431006 */:
                FocusFun.C_SET_BUTTON_TOUCH(1, 2);
                break;
            case R.id.sync_bottom_btn3 /* 2131431007 */:
                FocusFun.C_SET_BUTTON_TOUCH(1, 3);
                break;
            case R.id.sync_bottom_btn4 /* 2131431008 */:
                FocusFun.C_SET_BUTTON_TOUCH(1, 4);
                break;
            case R.id.sync_btn_open /* 2131431011 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 30);
                break;
            case R.id.sync_btn_close /* 2131431012 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 31);
                break;
            case R.id.sync_btn2 /* 2131431013 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 22);
                break;
            case R.id.sync_btn1 /* 2131431014 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 21);
                break;
            case R.id.sync_btn3 /* 2131431015 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 23);
                break;
            case R.id.sync_btn5 /* 2131431016 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 25);
                break;
            case R.id.sync_btn4 /* 2131431017 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 24);
                break;
            case R.id.sync_btn6 /* 2131431018 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 26);
                break;
            case R.id.sync_btn8 /* 2131431019 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 28);
                break;
            case R.id.sync_btn7 /* 2131431020 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 27);
                break;
            case R.id.sync_btn9 /* 2131431021 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 29);
                break;
            case R.id.sync_btn0 /* 2131431022 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 20);
                break;
            case R.id.sync_btn_xing /* 2131431023 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 32);
                break;
            case R.id.sync_btn_jing /* 2131431024 */:
                FocusFun.C_SET_BUTTON_TOUCH(2, 33);
                break;
            case R.id.back /* 2131432973 */:
                if (!isBtState()) {
                    moveTaskToBack(true);
                }
                break;
            case R.id.home /* 2131432974 */:
                if (!isBtState()) {
                    moveToHome(v);
                }
                break;
            case R.id.textvol /* 2131432975 */:
                FFuncSound.showVol();
                break;
        }
    }
    ...
    private void onClickXPFocus(View v) {
        switch (v.getId()) {
            ...
            case R.id.sync_next /* 2131430982 */:
                ...
                break;
            case R.id.sync_layout_line1 /* 2131430985 */:
                FocusFun.C_CONTRAL(161, 145);
                break;
            case R.id.sync_layout_line2 /* 2131430989 */:
                FocusFun.C_CONTRAL(161, 146);
                break;
            case R.id.sync_layout_line3 /* 2131430993 */:
                FocusFun.C_CONTRAL(161, 147);
                break;
            case R.id.sync_layout_line4 /* 2131430997 */:
                FocusFun.C_CONTRAL(161, 148);
                break;
            case R.id.sync_layout_line5 /* 2131431001 */:
            ...
            case R.id.sync_bottom_btn4 /* 2131431008 */:
                ...
                break;
            case R.id.sync_photo /* 2131431010 */:

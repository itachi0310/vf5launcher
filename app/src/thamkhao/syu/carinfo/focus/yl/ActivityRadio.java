...
public class ActivityRadio extends Activity implements DialogInterface.OnClickListener, View.OnLongClickListener {
    ...
    public boolean onLongClick(View v) {
        int viewid = v.getId();
        switch (viewid) {
            case R.id.freqm /* 2131430064 */:
                Seek_down = 1;
                DataCanbus.PROXY.cmd(3, 18, 11);
                return true;
            case R.id.freqp /* 2131430065 */:
                Seek_down = -1;
                DataCanbus.PROXY.cmd(3, 18, 9);
                return true;
            case R.id.btn_skipb /* 2131432398 */:
            case R.id.btn_skipf /* 2131432401 */:
            default:
                return true;
        }
    }

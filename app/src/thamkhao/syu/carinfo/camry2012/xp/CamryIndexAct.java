...
public class CamryIndexAct extends TabActivity {
    ...
    private void init() {
        ...
        if (DataCanbus.DATA[1000] == 196628 || DataCanbus.DATA[1000] == 5177741 || DataCanbus.DATA[1000] == 5243277 || DataCanbus.DATA[1000] == 6029709 || DataCanbus.DATA[1000] == 6095245 || DataCanbus.DATA[1000] == 6160781 || DataCanbus.DATA[1000] == 6226317 || DataCanbus.DATA[1000] == 6291853 || DataCanbus.DATA[1000] == 6357389 || DataCanbus.DATA[1000] == 5308813 || DataCanbus.DATA[1000] == 5374349 || DataCanbus.DATA[1000] == 5439885 || DataCanbus.DATA[1000] == 5505421 || DataCanbus.DATA[1000] == 5570957 || DataCanbus.DATA[1000] == 5636493 || DataCanbus.DATA[1000] == 5833101 || DataCanbus.DATA[1000] == 5898637 || DataCanbus.DATA[1000] == 5964173) {
        ...
        if (DataCanbus.DATA[1000] == 5308813 || DataCanbus.DATA[1000] == 5374349 || DataCanbus.DATA[1000] == 5177741 || DataCanbus.DATA[1000] == 5243277 || DataCanbus.DATA[1000] == 6029709 || DataCanbus.DATA[1000] == 6095245 || DataCanbus.DATA[1000] == 6160781 || DataCanbus.DATA[1000] == 6226317 || DataCanbus.DATA[1000] == 6291853 || DataCanbus.DATA[1000] == 6357389 || DataCanbus.DATA[1000] == 5439885 || DataCanbus.DATA[1000] == 5505421 || DataCanbus.DATA[1000] == 5570957 || DataCanbus.DATA[1000] == 5636493 || DataCanbus.DATA[1000] == 5833101 || DataCanbus.DATA[1000] == 5898637 || DataCanbus.DATA[1000] == 5964173) {
        ...
        if (DataCanbus.DATA[1000] == 131184 || DataCanbus.DATA[1000] == 3342448 || DataCanbus.DATA[1000] == 458864 || DataCanbus.DATA[1000] == 214 || DataCanbus.DATA[1000] == 65750 || DataCanbus.DATA[1000] == 131286 || DataCanbus.DATA[1000] == 983152 || DataCanbus.DATA[1000] == 1114224 || DataCanbus.DATA[1000] == 1507440 || (DataCanbus.DATA[1000] & 65535) == 112) {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    ...
                    case R.id.camry_btn_settings /* 2131428122 */:
                        ...
                        break;
                    case R.id.camry_btn_base_info /* 2131430691 */:

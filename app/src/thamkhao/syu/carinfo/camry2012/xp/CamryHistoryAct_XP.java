...
public class CamryHistoryAct_XP extends BaseActivity {
    public static CamryHistoryAct_XP mInit;
    private TextView[] mTvHisOil = new TextView[4];
    private VerticalProgressbar[] mProgressbarHis = new VerticalProgressbar[5];
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.camry2012.xp.CamryHistoryAct_XP.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 98:
                    CamryHistoryAct_XP.this.mUpdaterDrivingTime();
                    break;
                case 100:
                    CamryHistoryAct_XP.this.mUpdaterAverageOilExpend();
                    break;
                case 101:
                    CamryHistoryAct_XP.this.mUpdaterCurTripOilExpend();
                    break;
                case 102:
                    if (ints == null) {
                        for (int i = 0; i < 5; i++) {
                            ...
                            CamryHistoryAct_XP.this.mUpdaterTripOilValue(ints2);
                        }
                    } else {
                        CamryHistoryAct_XP.this.mUpdaterTripOilValue(ints);
                    }
                    break;
            }
        }
    ...
    public void init() {
        ...
        findViewById(R.id.camry_btn_update).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry2012.xp.CamryHistoryAct_XP.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(8, null, null, null);
            }
        });
        findViewById(R.id.camry_btn_delete).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry2012.xp.CamryHistoryAct_XP.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {

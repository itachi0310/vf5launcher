...
public class RzcPeroduaHistoryAct extends BaseActivity {
    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.camry2012.xp.RzcPeroduaHistoryAct.1
    ...
    public void init() {
        ...
        findViewById(R.id.camry_btn_update).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry2012.xp.RzcPeroduaHistoryAct.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(8, null, null, null);
            }
        });
        findViewById(R.id.camry_btn_delete).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry2012.xp.RzcPeroduaHistoryAct.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {

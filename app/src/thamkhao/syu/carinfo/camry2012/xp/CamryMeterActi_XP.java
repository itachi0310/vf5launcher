...
public class CamryMeterActi_XP extends BaseActivity {
    ...
    public void mUpdaterRearLock() {
        ...
        if (((DataCanbus.DATA[1000] & 65535) == 397 && this.carid >= 42 && this.carid <= 77) || (DataCanbus.DATA[1000] & 65535) == 112) {
            ((TextView) findViewById(R.id.camry_lock_rear_left)).setBackgroundResource((value & 2) == 0 ? R.drawable.ic_camry_lock_lock : R.drawable.ic_camry_lock_unlock);
        ...
        ((TextView) findViewById(R.id.camry_lock_rear_left)).setBackgroundResource(value == 0 ? R.drawable.ic_camry_lock_lock : R.drawable.ic_camry_lock_unlock);

...
public class RzcPeroduaTripAct extends BaseActivity {
    private VerticalProgressbar[] mProgressbar = new VerticalProgressbar[15];
    private TextView[] mOilTv = new TextView[4];
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.camry2012.xp.RzcPeroduaTripAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 94:
                    RzcPeroduaTripAct.this.mUpdaterAveragVelocity();
                    break;
                case 96:
                    RzcPeroduaTripAct.this.mUpdaterDrivingMileage();
                    break;
                case 97:
                    RzcPeroduaTripAct.this.mUpdaterOilExpend();
                    break;
                case 101:
                    if (ints != null) {
                        RzcPeroduaTripAct.this.mUpdaterOilValue(ints);
                    }
                    break;
            }
        }
    ...
    public void init() {
        ...
        findViewById(R.id.camry_btn_clear).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.camry2012.xp.RzcPeroduaTripAct.2

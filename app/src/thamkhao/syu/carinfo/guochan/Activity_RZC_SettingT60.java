...
public class Activity_RZC_SettingT60 extends BaseActivity {
    private int[] eventIds = {154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 167, 168};
    ...
    public void init() {
        ...
        if (btn5 != null) {
            btn5.setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.guochan.Activity_RZC_SettingT60.6
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    int val = DataCanbus.DATA[164] - 10;
                    if (val < 30) {
                        val = 30;
                    }
        ...
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext1), 7, 161);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext2), 10, 162);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext3), 8, 163);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext4), 0, 154);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext5), 14, 168);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext6), 3, 157);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext7), 4, 158);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext8), 6, 160);
        sendClick((CheckedTextView) findViewById(R.id.ctv_checkedtext9), 11, 165);
    }

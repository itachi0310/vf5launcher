...
public class ActivityHuanSuAirSet extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ctv_419_air_remote_open_air /* 2131429953 */:
                setCmd(6, (DataCanbus.DATA[60] & 255) != 0 ? 0 : 1);
                break;
            case R.id.btn_419_air_phone_down_wind_minus /* 2131429955 */:
                ...
                setCmd(5, value);
                break;
            case R.id.btn_419_air_phone_down_wind_plus /* 2131429957 */:
                ...
                setCmd(5, value2);
                break;
            case R.id.ctv_419_air_hightemp_auto_inter_cycle /* 2131429959 */:
                setCmd(4, (DataCanbus.DATA[62] & 255) != 0 ? 0 : 1);
                break;
            case R.id.ctv_419_air_auto_wind /* 2131429961 */:
                setCmd(3, (DataCanbus.DATA[63] & 255) != 0 ? 0 : 1);
                break;
            case R.id.ctv_419_air_auto_ac /* 2131429963 */:
                setCmd(2, (DataCanbus.DATA[64] & 255) != 0 ? 0 : 1);
                break;
            case R.id.ctv_419_air_pack_auto_inter_cycle /* 2131429965 */:

...
public class ActivityDaMaiX7 extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ctv_damaix7_seat_comity /* 2131428982 */:
                this.value = DataCanbus.DATA[94];
                DataCanbus.PROXY.cmd(1, this.value == 0 ? 1 : 0);
                break;
            case R.id.btn_damaix7_atmosphere_lights_minus /* 2131428984 */:
                this.value = DataCanbus.DATA[95] - 1;
                if (this.value < 0) {
                    this.value = 0;
                }
                DataCanbus.PROXY.cmd(2, this.value);
                break;
            case R.id.btn_damaix7_atmosphere_lights_plus /* 2131428986 */:
                this.value = DataCanbus.DATA[95] + 1;
                if (this.value > 6) {
                    this.value = 6;
                }

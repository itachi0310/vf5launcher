...
public class LZMustangCarRadioAct extends Activity implements View.OnTouchListener {
    ...
    protected void onResume() {
        ...
        if (DataCanbus.DATA[134] != 1) {
            DataCanbus.PROXY.cmd(1, new int[]{176, 1}, null, null);
            DataCanbus.PROXY.cmd(0, new int[]{97, 0}, null, null);
        }
    }
    ...
    public void updaterRadioBand() {
        if (this.radioband != DataCanbus.DATA[115]) {
            ...
            switch (v.getId()) {
                ...
                case R.id.lexus_radio_fm /* 2131427873 */:
                    if (DataCanbus.DATA[115] == 0) {
                        ...
                        DataCanbus.PROXY.cmd(2, new int[]{13, 0}, null, null);
                    }
                    break;

...
public class MustangCarEQSet extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value3 = DataCanbus.DATA[156];
                if (value3 > 0) {
                    value3--;
                }
                setCarInfo(1, value3);
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int value4 = DataCanbus.DATA[156];
                if (value4 < 14) {
                    value4++;
                }
                setCarInfo(1, value4);
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int value5 = DataCanbus.DATA[157];
                if (value5 > 0) {
                    value5--;
                }
                setCarInfo(2, value5);
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[157];
                if (value6 < 14) {
                    value6++;
                }
                setCarInfo(2, value6);
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value8 = DataCanbus.DATA[158];
                if (value8 < 14) {
                    value8++;
                }
                setCarInfo(3, value8);
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int value12 = DataCanbus.DATA[160];
                if (value12 < 3) {
                    value12++;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int value13 = DataCanbus.DATA[161];
                if (value13 == 0) {
                    value13 = 1;
                } else if (value13 == 1) {
                    value13 = 0;
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value15 = DataCanbus.DATA[162];
                if (value15 > 0) {
                    value15--;
                }
                setCarInfo1(value15);
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value16 = DataCanbus.DATA[162];
                if (value16 < 30) {
                    value16++;
                }
                setCarInfo1(value16);
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(0, new int[]{98, 0}, null, null);
        addNotify();
    }

...
public class FordCarSet_RZC2 extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int value = DataCanbus.DATA[196] - 1;
                if (value < 0) {
                    value = 2;
                }
                setCarInfo(0, value);
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int value2 = DataCanbus.DATA[196] + 1;
                if (value2 > 2) {
                    value2 = 0;
                }
                setCarInfo(0, value2);
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value3 = DataCanbus.DATA[197] - 1;
                if (value3 < 0) {
                    value3 = 2;
                }
                setCarInfo(1, value3);
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int value4 = DataCanbus.DATA[197] + 1;
                if (value4 > 2) {
                    value4 = 0;
                }
                setCarInfo(1, value4);
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int value5 = DataCanbus.DATA[200] - 1;
                if (value5 < 0) {
                    value5 = 1;
                }
                setCarInfo(4, value5);
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value6 = DataCanbus.DATA[200] + 1;
                if (value6 > 1) {
                    value6 = 0;
                }
                setCarInfo(4, value6);
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                int value7 = DataCanbus.DATA[206] - 1;
                if (value7 < 0) {
                    value7 = 2;
                }
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value8 = DataCanbus.DATA[206] + 1;
                if (value8 > 2) {
                    value8 = 0;
                }
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int value12 = DataCanbus.DATA[210];
                if (value12 == 0) {
                    value12 = 10;
                } else if (value12 == 10) {
                    value12 = 20;
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int value13 = DataCanbus.DATA[213] - 1;
                if (value13 < 0) {
                    value13 = 3;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int value14 = DataCanbus.DATA[213] + 1;
                if (value14 > 3) {
                    value14 = 0;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int value15 = DataCanbus.DATA[214] - 1;
                if (value15 < 0) {
                    value15 = 2;
                }
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int value16 = DataCanbus.DATA[214] + 1;
                if (value16 > 2) {
                    value16 = 0;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value17 = DataCanbus.DATA[220] - 1;
                if (value17 < 0) {
                    value17 = 1;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value18 = DataCanbus.DATA[220] + 1;
                if (value18 > 1) {
                    value18 = 0;
                }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int value19 = DataCanbus.DATA[225] - 1;
                if (value19 < 0) {
                    value19 = 1;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int value20 = DataCanbus.DATA[225] + 1;
                if (value20 > 1) {
                    value20 = 0;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int value21 = DataCanbus.DATA[226] - 1;
                if (value21 < 0) {
                    value21 = 1;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int value22 = DataCanbus.DATA[226] + 1;
                if (value22 > 1) {
                    value22 = 0;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int value23 = DataCanbus.DATA[227] - 1;
                if (value23 < 0) {
                    value23 = 2;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value24 = DataCanbus.DATA[227] + 1;
                if (value24 > 2) {
                    value24 = 0;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value26 = DataCanbus.DATA[235] + 1;
                if (value26 > 2) {
                    value26 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value27 = DataCanbus.DATA[236];
                if (value27 == 0) {
                    value27 = 3;
                } else if (value27 == 2) {
                    value27 = 0;
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value28 = DataCanbus.DATA[236];
                if (value28 == 0) {
                    value28 = 2;
                } else if (value28 == 2) {
                    value28 = 3;
            ...
            case R.id.btn_minus15 /* 2131427520 */:
                int value29 = DataCanbus.DATA[237] - 1;
                if (value29 < 0) {
                    value29 = 1;
                }
            ...
            case R.id.btn_plus15 /* 2131427522 */:
                int value30 = DataCanbus.DATA[237] + 1;
                if (value30 > 1) {
                    value30 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value31 = DataCanbus.DATA[198];
                if (value31 == 1) {
                    value31 = 0;
                } else if (value31 == 0) {
                    value31 = 1;
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                int value32 = DataCanbus.DATA[199];
                if (value32 == 1) {
                    value32 = 0;
                } else if (value32 == 0) {
                    value32 = 1;
            ...
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                int value33 = DataCanbus.DATA[201];
                if (value33 == 1) {
                    value33 = 0;
                } else if (value33 == 0) {
                    value33 = 1;
            ...
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                int value34 = DataCanbus.DATA[202];
                if (value34 == 1) {
                    value34 = 0;
                } else if (value34 == 0) {
                    value34 = 1;
            ...
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                int value35 = DataCanbus.DATA[203];
                if (value35 == 1) {
                    value35 = 0;
                } else if (value35 == 0) {
                    value35 = 1;
            ...
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                int value36 = DataCanbus.DATA[204];
                if (value36 == 1) {
                    value36 = 0;
                } else if (value36 == 0) {
                    value36 = 1;
            ...
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                int value37 = DataCanbus.DATA[205];
                if (value37 == 1) {
                    value37 = 0;
                } else if (value37 == 0) {
                    value37 = 1;
            ...
            case R.id.ctv_checkedtext9 /* 2131427556 */:
                int value39 = DataCanbus.DATA[208];
                if (value39 == 1) {
                    value39 = 0;
                } else if (value39 == 0) {
                    value39 = 1;
            ...
            case R.id.ctv_checkedtext10 /* 2131427557 */:
                int value40 = DataCanbus.DATA[211];
                if (value40 == 1) {
                    value40 = 0;
                } else if (value40 == 0) {
                    value40 = 1;
            ...
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                int value41 = DataCanbus.DATA[212];
                if (value41 == 1) {
                    value41 = 0;
                } else if (value41 == 0) {
                    value41 = 1;
            ...
            case R.id.ctv_checkedtext12 /* 2131427559 */:
                int value42 = DataCanbus.DATA[215];
                if (value42 == 1) {
                    value42 = 0;
                } else if (value42 == 0) {
                    value42 = 1;
            ...
            case R.id.ctv_checkedtext13 /* 2131427560 */:
                int value43 = DataCanbus.DATA[216];
                if (value43 == 1) {
                    value43 = 0;
                } else if (value43 == 0) {
                    value43 = 1;
            ...
            case R.id.ctv_checkedtext14 /* 2131427561 */:
                int value44 = DataCanbus.DATA[217];
                if (value44 == 1) {
                    value44 = 0;
                } else if (value44 == 0) {
                    value44 = 1;
            ...
            case R.id.ctv_checkedtext15 /* 2131427562 */:
                int value45 = DataCanbus.DATA[218];
                if (value45 == 1) {
                    value45 = 0;
                } else if (value45 == 0) {
                    value45 = 1;
            ...
            case R.id.ctv_checkedtext16 /* 2131427563 */:
                int value46 = DataCanbus.DATA[219];
                if (value46 == 1) {
                    value46 = 0;
                } else if (value46 == 0) {
                    value46 = 1;
            ...
            case R.id.ctv_checkedtext17 /* 2131427564 */:
                int value47 = DataCanbus.DATA[221];
                if (value47 == 1) {
                    value47 = 0;
                } else if (value47 == 0) {
                    value47 = 1;
            ...
            case R.id.ctv_checkedtext18 /* 2131427663 */:
                int value48 = DataCanbus.DATA[222];
                if (value48 == 1) {
                    value48 = 0;
                } else if (value48 == 0) {
                    value48 = 1;
            ...
            case R.id.ctv_checkedtext19 /* 2131427665 */:
                int value49 = DataCanbus.DATA[223];
                if (value49 == 1) {
                    value49 = 0;
                } else if (value49 == 0) {
                    value49 = 1;
            ...
            case R.id.ctv_checkedtext20 /* 2131427667 */:
                int value50 = DataCanbus.DATA[224];
                if (value50 == 1) {
                    value50 = 0;
                } else if (value50 == 0) {
                    value50 = 1;
            ...
            case R.id.ctv_checkedtext21 /* 2131427669 */:
                int value51 = DataCanbus.DATA[228];
                if (value51 == 1) {
                    value51 = 0;
                } else if (value51 == 0) {
                    value51 = 1;
            ...
            case R.id.ctv_checkedtext22 /* 2131427671 */:
                int value52 = DataCanbus.DATA[229];
                if (value52 == 1) {
                    value52 = 0;
                } else if (value52 == 0) {
                    value52 = 1;
            ...
            case R.id.ctv_checkedtext23 /* 2131427674 */:
                int value53 = DataCanbus.DATA[230];
                if (value53 == 1) {
                    value53 = 0;
                } else if (value53 == 0) {
                    value53 = 1;
            ...
            case R.id.ctv_checkedtext24 /* 2131427850 */:
                int value54 = DataCanbus.DATA[231];
                if (value54 == 1) {
                    value54 = 0;
                } else if (value54 == 0) {
                    value54 = 1;
            ...
            case R.id.ctv_checkedtext25 /* 2131427852 */:
                int value55 = DataCanbus.DATA[232];
                if (value55 == 1) {
                    value55 = 0;
                } else if (value55 == 0) {
                    value55 = 1;
            ...
            case R.id.ctv_checkedtext26 /* 2131427854 */:
                int value56 = DataCanbus.DATA[233];
                if (value56 == 1) {
                    value56 = 0;
                } else if (value56 == 0) {
                    value56 = 1;
            ...
            case R.id.ctv_checkedtext27 /* 2131427856 */:
                int value57 = DataCanbus.DATA[234];
                if (value57 == 1) {
                    value57 = 0;
                } else if (value57 == 0) {
                    value57 = 1;
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(0, new int[]{40, 0}, null, null);
        addNotify();
    }

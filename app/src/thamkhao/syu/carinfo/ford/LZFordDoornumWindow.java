...
public class LZFordDoornumWindow extends BaseActivity implements View.OnClickListener {
    ...
    public LZFordDoornumWindow(LZFordDoornumSetAct act) {
        initView();
        initPop();
    }
    ...
    private void initView() {
        this.mRootView = View.inflate(TheApp.getInstance(), R.layout.layout_0374_pa_ford_doornum_ok, null);
    ...
    public void showWindow(View Parent, int num) {
        ...
        switch (num) {
            ...
            case 5:
                this.mRootView.findViewById(R.id.layout_view1).setVisibility(0);
                this.mRootView.findViewById(R.id.layout_view2).setVisibility(8);
                ((TextView) this.mRootView.findViewById(R.id.tv_text1)).setText("Added door keypad code is using.");
                break;
            case 14:
                this.mRootView.findViewById(R.id.layout_view1).setVisibility(0);
                this.mRootView.findViewById(R.id.layout_view2).setVisibility(8);

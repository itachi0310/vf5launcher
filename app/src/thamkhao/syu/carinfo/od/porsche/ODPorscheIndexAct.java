...
public class ODPorscheIndexAct extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.rzc_jianghuai_car_settings)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.od.porsche.ODPorscheIndexAct.1
        ...
        ((Button) findViewById(R.id.rzc_jianghuai_carinfo)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.od.porsche.ODPorscheIndexAct.2
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                try {
                    Intent intent = new Intent();

...
public class MazdAllMaintenanceAct extends BaseActivity implements View.OnClickListener {
            ...
            switch (updateCode) {
                ...
                case 47:
                    if (MazdAllMaintenanceAct.this.mTextReservationTime != null) {
                        MazdAllMaintenanceAct.this.mTextReservationTime.setText(String.valueOf(String.format("%d", Integer.valueOf(value + 6))) + TheApp.getInstance().getResources().getString(R.string.str_months));
                    }
                    break;
                case 48:
                    if (MazdAllMaintenanceAct.this.mTextReservationMile != null) {
                        MazdAllMaintenanceAct.this.mTextReservationMile.setText(String.valueOf(String.format("%d", Integer.valueOf((value + 10) * 1000))) + TheApp.getInstance().getResources().getString(R.string.wc_jianianhua_show__metric_unit_0));
                    }
                    break;
                case 49:
                    if (MazdAllMaintenanceAct.this.mTextTireChange != null) {
                        MazdAllMaintenanceAct.this.mTextTireChange.setText(String.valueOf(String.format("%d", Integer.valueOf((value + 10) * 1000))) + TheApp.getInstance().getResources().getString(R.string.wc_jianianhua_show__metric_unit_0));
                    }
                    break;
                case 50:
                    if (MazdAllMaintenanceAct.this.mTextOilChange != null) {
                        MazdAllMaintenanceAct.this.mTextOilChange.setText(String.valueOf(String.format("%d", Integer.valueOf((value + 10) * 1000))) + TheApp.getInstance().getResources().getString(R.string.wc_jianianhua_show__metric_unit_0));
                    }
                    break;
            }
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ctv_od_mazdall_reservation_onoff /* 2131428300 */:
                ...
                break;
            case R.id.od_mazdall_btn_reservetime_minus /* 2131428301 */:
                ...
                break;
            case R.id.od_mazdall_btn_reservetime_plus /* 2131428303 */:
                ...
                break;
            case R.id.od_mazdall_btn_reservemile_minus /* 2131428304 */:
                ...
                break;
            case R.id.od_mazdall_btn_reservemile_plus /* 2131428306 */:
                DataCanbus.PROXY.cmd(2, new int[]{3, DataCanbus.DATA[48] + 1}, null, null);
                break;
            case R.id.od_mazdall_btn_tirechange_minus /* 2131428307 */:
                ...
                break;
            case R.id.od_mazdall_btn_tirechange_plus /* 2131428309 */:
                DataCanbus.PROXY.cmd(2, new int[]{4, DataCanbus.DATA[49] + 1}, null, null);
                break;
            case R.id.od_mazdall_btn_motoroil_minus /* 2131428310 */:
                ...
                break;
            case R.id.od_mazdall_btn_motoroil_plus /* 2131428312 */:

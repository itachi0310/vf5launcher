...
public class FordFalconCarInfo extends BaseActivity implements View.OnClickListener {
    ...
    public void updateCarinfo3() {
        int value = DataCanbus.DATA[112] & 31;
        int unit = (DataCanbus.DATA[112] >> 5) & 1;
        switch (unit) {
            case 0:
    ...
    public void updateCarinfo2() {
        int value = DataCanbus.DATA[111] & 31;
        int unit = (DataCanbus.DATA[111] >> 5) & 1;
        switch (unit) {
            case 0:
    ...
    public void updateCarinfo1() {
        int hour = DataCanbus.DATA[109];
        int minute = DataCanbus.DATA[110];

...
public class RZC_XiandaiE_CarSettingAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View arg0) {
        ...
        switch (id) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value15 = DataCanbus.DATA[120];
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                ...
                int value23 = DataCanbus.DATA[121];
                int value310 = DataCanbus.DATA[122];
                int h = (value17 & 31) - 1;
                if (h < 0) {
                    h = 23;
                }
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                ...
                int value311 = DataCanbus.DATA[122];
                int h2 = (value18 & 31) + 1;
                if (h2 > 23) {
                    h2 = 0;
                }
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                ...
                int value312 = DataCanbus.DATA[122];
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value110 = DataCanbus.DATA[120];
                int value26 = DataCanbus.DATA[121];
                int value313 = DataCanbus.DATA[122];
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value111 = DataCanbus.DATA[120];
                int value27 = DataCanbus.DATA[121];
                int value314 = DataCanbus.DATA[122];
                int h3 = (value27 & 31) - 1;
                if (h3 < 0) {
                    h3 = 23;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                int value112 = DataCanbus.DATA[120];
                int value28 = DataCanbus.DATA[121];
                int value315 = DataCanbus.DATA[122];
                int h4 = (value28 & 31) + 1;
                if (h4 > 23) {
                    h4 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value113 = DataCanbus.DATA[120];
                int value29 = DataCanbus.DATA[121];
                int value316 = DataCanbus.DATA[122];
                if (((value316 >> 5) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                int value114 = DataCanbus.DATA[120];
                int value210 = DataCanbus.DATA[121];
                int value317 = DataCanbus.DATA[122];
                if (((value317 >> 4) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                int value115 = DataCanbus.DATA[120];
                int value211 = DataCanbus.DATA[121];
                int value318 = DataCanbus.DATA[122];
                if (((value318 >> 3) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                int value116 = DataCanbus.DATA[120];
                int value212 = DataCanbus.DATA[121];
                int value319 = DataCanbus.DATA[122];
                if (((value319 >> 2) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                int value117 = DataCanbus.DATA[120];
                int value213 = DataCanbus.DATA[121];
                int value320 = DataCanbus.DATA[122];
                if (((value320 >> 1) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                int value118 = DataCanbus.DATA[120];
                int value214 = DataCanbus.DATA[121];
                int value321 = DataCanbus.DATA[122];
                if (((value321 >> 0) & 1) == 1) {
            ...
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                int value119 = DataCanbus.DATA[120];
                int value215 = DataCanbus.DATA[121];
                int value322 = DataCanbus.DATA[122];
                if (((value322 >> 6) & 1) == 1) {
                    value3 = value322 & 191;
                } else {
                    value3 = value322 | 64;
    ...
    public void addNotify() {
        ...
        DataCanbus.PROXY.cmd(2, new int[]{85, 0}, null, null);

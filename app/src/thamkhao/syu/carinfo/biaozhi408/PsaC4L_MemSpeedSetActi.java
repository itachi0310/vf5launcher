...
public class PsaC4L_MemSpeedSetActi extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bz408_cruising_speed_speed_1 /* 2131433377 */:
                this.i1 = this.i1 != 1 ? 1 : 0;
                setState();
                break;
            case R.id.bz408_btn_cruising_speed_1_set_minus /* 2131433379 */:
                this.speed1 = setSpeedDown(this.speed1);
                break;
            case R.id.bz408_btn_cruising_speed_1_set_plus /* 2131433381 */:
                this.speed1 = setSpeedUp(this.speed1);
                break;
            case R.id.bz408_cruising_speed_speed_2 /* 2131433383 */:
                this.i2 = this.i2 != 1 ? 1 : 0;
                setState();
                break;
            case R.id.bz408_btn_cruising_speed_2_set_minus /* 2131433385 */:
                this.speed2 = setSpeedDown(this.speed2);
                break;
            case R.id.bz408_btn_cruising_speed_2_set_plus /* 2131433387 */:
                this.speed2 = setSpeedUp(this.speed2);
                break;
            case R.id.bz408_cruising_speed_speed_3 /* 2131433389 */:
                this.i3 = this.i3 != 1 ? 1 : 0;
                setState();
                break;
            case R.id.bz408_btn_cruising_speed_3_set_minus /* 2131433391 */:
                this.speed3 = setSpeedDown(this.speed3);
                break;
            case R.id.bz408_btn_cruising_speed_3_set_plus /* 2131433393 */:
                this.speed3 = setSpeedUp(this.speed3);
                break;
            case R.id.bz408_cruising_speed_speed_4 /* 2131433395 */:
                this.i4 = this.i4 != 1 ? 1 : 0;
                setState();
                break;
            case R.id.bz408_btn_cruising_speed_4_set_minus /* 2131433397 */:
                this.speed4 = setSpeedDown(this.speed4);
                break;
            case R.id.bz408_btn_cruising_speed_4_set_plus /* 2131433399 */:
                this.speed4 = setSpeedUp(this.speed4);
                break;
            case R.id.bz408_cruising_speed_speed_5 /* 2131433401 */:
                this.i5 = this.i5 != 1 ? 1 : 0;
                setState();
                break;
            case R.id.bz408_btn_cruising_speed_5_set_minus /* 2131433403 */:
                this.speed5 = setSpeedDown(this.speed5);
                break;
            case R.id.bz408_btn_cruising_speed_5_set_plus /* 2131433405 */:

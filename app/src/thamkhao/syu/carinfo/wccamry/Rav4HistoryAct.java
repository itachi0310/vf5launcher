...
public class Rav4HistoryAct extends BaseActivity {
    ...
    public void init() {
        ...
        ((Button) findViewById(R.id.rav4_btn_go2_minute_oil)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4HistoryAct.2
        ...
        ((Button) findViewById(R.id.btn_plus1)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4HistoryAct.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(29, new int[]{4, 4, 1}, null, null);
            }
        });
        ((Button) findViewById(R.id.rav4_btn_update)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4HistoryAct.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(15, null, null, null);
            }
        });
        ((Button) findViewById(R.id.rav4_btn_delete)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4HistoryAct.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        if (num != 65535) {
            if (unit == 0) {
                ...
                if (((TextView) findViewById(R.id.rav4_tv_trip_unit)) != null) {
                    ((TextView) findViewById(R.id.rav4_tv_trip_unit)).setText("MPG");
                }
                for (int i = 0; i < 4; i++) {
                ...
                numMax = 30;
                if (((TextView) findViewById(R.id.rav4_tv_trip_unit)) != null) {
                    ((TextView) findViewById(R.id.rav4_tv_trip_unit)).setText("km/L");
                }
                ...
                numMax = 30;
                if (((TextView) findViewById(R.id.rav4_tv_trip_unit)) != null) {
                    ((TextView) findViewById(R.id.rav4_tv_trip_unit)).setText("L/100km");
                }

...
public class Rav4TripAct extends BaseActivity {
    ...
    public void init() {
        ...
        ((Button) findViewById(R.id.btn_plus1)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4TripAct.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(29, new int[]{4, 5, 1}, null, null);
            }
        });
        ((Button) findViewById(R.id.rav4_btn_clear)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4TripAct.6
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                DataCanbus.PROXY.cmd(14, null, null, null);
            }
        });
        ((Button) findViewById(R.id.rav4_btn_setting)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.wccamry.Rav4TripAct.7
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                if (DataCanbus.DATA[1000] == 33) {
                    try {
    ...
    public void mUpdaterAveragVelocity() {
        if (((TextView) findViewById(R.id.rav4_tv_average_velocity)) != null) {
            int value = DataCanbus.DATA[96] & 16777215;

...
public class XBSTuleSettingDZSJ extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.id_reset /* 2131427594 */:
                setCarInfo(53, 9);
                break;
            case R.id.ctv_xbs_tule_parking_sensor /* 2131428493 */:
                setCarInfo(52, 1);
                break;
            case R.id.xbs_tule_btn_cornersensor_minus /* 2131428494 */:
                setCarInfo(52, 2);
                break;
            case R.id.xbs_tule_btn_cornersensor_plus /* 2131428496 */:
                setCarInfo(52, 3);
                break;
            case R.id.xbs_tule_btn_centresensor_minus /* 2131428497 */:
                setCarInfo(52, 4);
                break;
            case R.id.xbs_tule_btn_centresensor_plus /* 2131428499 */:
                setCarInfo(52, 5);
                break;
            case R.id.ctv_xbs_tule_interior_illumination /* 2131428500 */:
                setCarInfo(53, 1);
                break;
            case R.id.ctv_xbs_tule_wipersensor_speed /* 2131428501 */:
                setCarInfo(53, 6);
                break;
            case R.id.ctv_xbs_tule_selective_door_unlock /* 2131428502 */:
                setCarInfo(53, 7);
                break;
            case R.id.ctv_xbs_tule_intelligent_key_lock /* 2131428503 */:
                setCarInfo(53, 8);
                break;
            case R.id.xbs_tule_btn_lightsensitivity_minus /* 2131428504 */:
                setCarInfo(53, 2);
                break;
            case R.id.xbs_tule_btn_lightsensitivity_plus /* 2131428506 */:
                setCarInfo(53, 3);
                break;
            case R.id.xbs_tule_btn_lightoffdelay_minus /* 2131428507 */:
                setCarInfo(53, 4);
                break;
            case R.id.xbs_tule_btn_lightoffdelay_plus /* 2131428509 */:
                setCarInfo(53, 5);
                break;
            case R.id.ctv_xbs_tule_sonar_onoff /* 2131428510 */:
                setCarInfo(54, 1);
                break;
            case R.id.ctv_xbs_tule_frsonar_onoff /* 2131428511 */:
                setCarInfo(54, 2);
                break;
            case R.id.ctv_xbs_tule_interruptdisplay_onoff /* 2131428512 */:
                setCarInfo(54, 3);
                break;
            case R.id.xbs_tule_btn_sonarsensitivity_minus /* 2131428513 */:
                setCarInfo(54, 4);
                break;
            case R.id.xbs_tule_btn_sonarsensitivity_plus /* 2131428515 */:
                setCarInfo(54, 5);
                break;
            case R.id.xbs_tule_btn_sonarvolume_minus /* 2131428516 */:
                setCarInfo(54, 6);
                break;
            case R.id.xbs_tule_btn_sonarvolume_plus /* 2131428518 */:
                setCarInfo(54, 7);
                break;
            case R.id.ctv_xbs_tule_distance_control_assit_onoff /* 2131428519 */:
                setCarInfo(55, 1);
                break;
            case R.id.ctv_xbs_tule_lane_departure_prevention_onoff /* 2131428520 */:
                setCarInfo(55, 2);
                break;
            case R.id.ctv_xbs_tule_blind_spot_intervention_onoff /* 2131428521 */:
                setCarInfo(55, 3);
                break;
            case R.id.ctv_xbs_tule_forward_collision_warning_onoff /* 2131428522 */:
                setCarInfo(55, 4);
                break;
            case R.id.ctv_xbs_tule_lane_departure_warning_onoff /* 2131428523 */:
                setCarInfo(55, 5);
                break;
            case R.id.ctv_xbs_tule_blind_spot_warning_onoff /* 2131428524 */:
                setCarInfo(55, 6);
                break;
            case R.id.ctv_xbs_tule_left_headrest_onoff /* 2131428525 */:
                setCarInfo(56, 1);
                break;
            case R.id.ctv_xbs_tule_right_headrest_onoff /* 2131428526 */:
                setCarInfo(56, 2);
                break;
        }
    }

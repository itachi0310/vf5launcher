...
public class XBSAccord9SettingsActi extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mBtnAdjustOutsideTempDisplayMinus.setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.xbs.accord9.XBSAccord9SettingsActi.3
            ...
            public void onClick(View v) {
                XBSAccord9SettingsActi.this.updateCode = 114;
        ...
        this.mBtnFuelEfficiencyBacklight.setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.xbs.accord9.XBSAccord9SettingsActi.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                int value = DataCanbus.DATA[115] == 0 ? 1 : 0;
        ...
        this.mBtnTripaResetTimingMinus.setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.xbs.accord9.XBSAccord9SettingsActi.6
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                XBSAccord9SettingsActi.this.updateCode = 113;
                XBSAccord9SettingsActi.this.cmdCode = 2;
                if (XBSAccord9SettingsActi.this.isAccord9H()) {
                    XBSAccord9SettingsActi.this.updateCode = 115;
                }
        ...
        this.mBtnTripbResetTimingMinus.setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.xbs.accord9.XBSAccord9SettingsActi.8
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                XBSAccord9SettingsActi.this.updateCode = 112;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.xp_ctv_fuel_efficiency_backlight /* 2131430270 */:
                this.updateCode = 125;
                this.cmdCode = 26;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_smart_key_start_guide /* 2131430272 */:
                this.updateCode = 126;
                this.cmdCode = 27;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_energy_save_auto_engine /* 2131430274 */:
                this.updateCode = 128;
                this.cmdCode = 28;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_siyu_set_front_hazard_distance_minus /* 2131430276 */:
                this.updateCode = 132;
                this.cmdCode = 29;
                ...
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_siyu_btn_set_front_hazard_distance_plus /* 2131430278 */:
                this.updateCode = 132;
                this.cmdCode = 29;
                this.value = DataCanbus.DATA[this.updateCode] + 1;
                if (this.value < 0) {
                ...
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_traffic_sign_recognition_sys /* 2131430280 */:
                this.updateCode = 142;
                this.cmdCode = 30;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_acc_tone /* 2131430282 */:
                this.updateCode = 130;
                this.cmdCode = 31;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_siyu_btn_minor_lane_departure_sys_settings_minus /* 2131430284 */:
                this.updateCode = 143;
                this.cmdCode = 32;
                this.value = DataCanbus.DATA[this.updateCode] - 1;
                if (this.value < 0) {
                ...
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_siyu_btn_minor_lane_departure_sys_settings_plus /* 2131430286 */:
                this.updateCode = 143;
                this.cmdCode = 32;
                this.value = DataCanbus.DATA[this.updateCode] + 1;
                if (this.value < 0) {
                ...
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_pause_lkas_tone /* 2131430288 */:
                this.updateCode = 131;
                this.cmdCode = 33;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
                break;
            case R.id.xp_ctv_remote_start_system /* 2131430290 */:
                this.updateCode = 124;
                this.cmdCode = 34;
                this.value = DataCanbus.DATA[this.updateCode] == 0 ? 1 : 0;
                DataCanbus.PROXY.cmd(this.cmdCode, new int[]{this.value}, null, null);
    ...
    protected void onResume() {
        ...
        if (isAccord9H()) {
            DataCanbus.PROXY.cmd(100, new int[]{10, 0}, null, null);
        } else {
            DataCanbus.PROXY.cmd(100, new int[]{4, 0}, null, null);
        }
        addNotify();
    }
    ...
    public void addNotify() {
        if (isAccord9H()) {
            DataCanbus.NOTIFY_EVENTS[115].addNotify(this.mNotifyCanbusAccord9, 1);
            DataCanbus.NOTIFY_EVENTS[116].addNotify(this.mNotifyCanbusAccord9, 1);
            DataCanbus.NOTIFY_EVENTS[117].addNotify(this.mNotifyCanbusAccord9, 1);
            DataCanbus.NOTIFY_EVENTS[118].addNotify(this.mNotifyCanbusAccord9, 1);
            ...
            DataCanbus.NOTIFY_EVENTS[143].addNotify(this.mNotifyCanbusAccord9, 1);
            DataCanbus.NOTIFY_EVENTS[142].addNotify(this.mNotifyCanbusAccord9, 1);
    ...
    public void removeNotify() {
        if (isAccord9H()) {
            DataCanbus.NOTIFY_EVENTS[115].removeNotify(this.mNotifyCanbusAccord9);
            DataCanbus.NOTIFY_EVENTS[116].removeNotify(this.mNotifyCanbusAccord9);
            DataCanbus.NOTIFY_EVENTS[117].removeNotify(this.mNotifyCanbusAccord9);
            DataCanbus.NOTIFY_EVENTS[118].removeNotify(this.mNotifyCanbusAccord9);
            ...
            DataCanbus.NOTIFY_EVENTS[143].removeNotify(this.mNotifyCanbusAccord9);
            DataCanbus.NOTIFY_EVENTS[142].removeNotify(this.mNotifyCanbusAccord9);

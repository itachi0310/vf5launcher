...
public class GS3EnergySetAct extends BaseActivity implements View.OnClickListener {
    ...
    public void updaterCycleDate(int value) {
        ...
        this.mCycleWeek1.setBackgroundResource(this.mWeek1 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);
        this.mCycleWeek2.setBackgroundResource(this.mWeek2 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);
        this.mCycleWeek3.setBackgroundResource(this.mWeek3 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);
        this.mCycleWeek4.setBackgroundResource(this.mWeek4 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);
        this.mCycleWeek5.setBackgroundResource(this.mWeek5 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);
        this.mCycleWeek6.setBackgroundResource(this.mWeek6 == 0 ? R.drawable.ge3_btn3 : R.drawable.ge3_btn3_p);

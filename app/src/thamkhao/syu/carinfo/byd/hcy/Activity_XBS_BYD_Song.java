...
public class Activity_XBS_BYD_Song extends BaseActivityForFragment {
    ...
    String[] titles = {"PM2.5", TheApp.getInstance().getString(R.string.str_mrb_str1), TheApp.getInstance().getString(R.string.str_driving_settings), TheApp.getInstance().getString(R.string.others_settings), TheApp.getInstance().getString(R.string.xp_yinglang_car_set_Second_str10)};

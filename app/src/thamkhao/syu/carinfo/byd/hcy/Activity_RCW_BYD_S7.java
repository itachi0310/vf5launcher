...
import com.syu.carinfo.byd.hcy.fragment.Fragment_Driving_CarSet_RCW_S7;
import com.syu.carinfo.byd.hcy.fragment.Fragment_Surui_CarSet;
import com.syu.carinfo.byd.hcy.fragment.Fragment_Surui_CarSet_RCW_S7;
...
public class Activity_RCW_BYD_S7 extends BaseActivityForFragment {
    AdapterCarInfo adapter;
    ListView mListView;
    TextView mText;
    List<CarInfo> mList = new ArrayList();
    List<Fragment> mFrags = new ArrayList();
    String[] titles = {"PM2.5", TheApp.getInstance().getString(R.string.str_mrb_str1), TheApp.getInstance().getString(R.string.str_driving_settings), TheApp.getInstance().getString(R.string.others_settings)};
    ...
    private void initValue() {
        ...
        Fragment frag3 = new Fragment_Driving_CarSet_RCW_S7();
        this.mFrags.add(frag3);
        Fragment frag4 = new Fragment_Surui_CarSet_RCW_S7();

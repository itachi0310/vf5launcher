...
public class Fragment_Surui_CarSet6 extends BaseFragment implements View.OnClickListener {
    int[] ids = {142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164};
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int value11 = DataCanbus.DATA[142] + 1;
                if (value11 > 6) {
                    value11 = 0;
                }
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                int value16 = DataCanbus.DATA[153] - 1;
                if (value16 < 0) {
                    value16 = 2;
                }
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value18 = DataCanbus.DATA[155] - 5;
                if (value18 < 0) {
                    value18 = 0;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                DataCanbus.PROXY.cmd(5, new int[]{14, DataCanbus.DATA[155] + 5}, null, null);
                break;
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                DataCanbus.PROXY.cmd(5, new int[]{15, DataCanbus.DATA[156] + 1}, null, null);
                break;
            case R.id.btn_minus7 /* 2131427473 */:
                int value20 = DataCanbus.DATA[157] - 1;
                if (value20 < 0) {
                    value20 = 0;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int value27 = DataCanbus.DATA[160] + 1;
                if (value27 > 16) {
                    value27 = 16;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value31 = DataCanbus.DATA[163] + 1;
                if (value31 > 2) {
                    value31 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value34 = DataCanbus.DATA[161] - 1;
                if (value34 < 0) {
                    value34 = 1;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value35 = DataCanbus.DATA[161] + 1;
                if (value35 > 1) {
                    value35 = 0;
                }

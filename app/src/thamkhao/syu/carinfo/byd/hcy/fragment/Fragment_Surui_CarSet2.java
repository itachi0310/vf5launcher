...
public class Fragment_Surui_CarSet2 extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int sendvalue = DataCanbus.DATA[117];
        int SOCvalue = DataCanbus.DATA[118];
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                sendvalue = ((DataCanbus.DATA[117] >> 1) & 1) == 1 ? DataCanbus.DATA[117] & 253 : DataCanbus.DATA[117] | 2;
                break;
            case R.id.btn_plus1 /* 2131427457 */:
                sendvalue = ((DataCanbus.DATA[117] >> 1) & 1) == 1 ? DataCanbus.DATA[117] & 253 : DataCanbus.DATA[117] | 2;
                break;
            case R.id.btn_minus2 /* 2131427458 */:
                sendvalue = ((DataCanbus.DATA[117] >> 2) & 1) == 1 ? DataCanbus.DATA[117] & 251 : DataCanbus.DATA[117] | 4;
                break;
            case R.id.btn_plus2 /* 2131427460 */:
                sendvalue = ((DataCanbus.DATA[117] >> 2) & 1) == 1 ? DataCanbus.DATA[117] & 251 : DataCanbus.DATA[117] | 4;
                break;
            case R.id.btn_minus3 /* 2131427461 */:
                sendvalue = ((DataCanbus.DATA[117] >> 3) & 1) == 1 ? DataCanbus.DATA[117] & 247 : DataCanbus.DATA[117] | 8;
                break;
            case R.id.btn_plus3 /* 2131427463 */:
                sendvalue = ((DataCanbus.DATA[117] >> 3) & 1) == 1 ? DataCanbus.DATA[117] & 247 : DataCanbus.DATA[117] | 8;
                break;
            case R.id.btn_minus4 /* 2131427464 */:
                SOCvalue = DataCanbus.DATA[118] - 5;
                if (SOCvalue < 15) {
                    SOCvalue = 15;
                }
                break;

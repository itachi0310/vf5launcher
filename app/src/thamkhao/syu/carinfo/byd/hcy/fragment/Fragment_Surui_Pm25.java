...
public class Fragment_Surui_Pm25 extends BaseFragment implements View.OnClickListener {
    ...
    private int poweron;
    int[] ids = {109, 110, 101, 97, 98, 99, 100};
    ...
    public void onClick(View v) {
        ...
        if (DataCanbus.sCanbusId == 8782263) {
            int value6 = 0;
            switch (v.getId()) {
                case R.id.id_poweron /* 2131427604 */:
                    if (this.poweron == 0) {
                        value6 = 10;
                    } else {
                        value6 = 11;
                    ...
                    break;
                case R.id.id_opendoor /* 2131427606 */:
                    if (this.opendoor == 0) {
                        value6 = 12;
                    } else {
                        value6 = 13;
                    ...
                    break;
                case R.id.id_intime /* 2131427607 */:
                    if (this.intime == 0) {
                        value6 = 14;
                    } else {
                        value6 = 15;
        ...
        if (DataCanbus.sCanbusId == 12976567) {
            ...
            switch (v.getId()) {
                ...
                case R.id.id_intime /* 2131427607 */:
                    value7 = 5;
                    break;
                case R.id.id_detectin /* 2131427608 */:
                    value7 = 1;
                    break;
                case R.id.id_detectout /* 2131427609 */:
                    value7 = 2;
                    break;
            }
            if (value7 != 0) {

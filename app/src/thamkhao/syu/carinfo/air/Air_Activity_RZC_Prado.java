...
public class Air_Activity_RZC_Prado extends Activity implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_sp_cycle /* 2131430317 */:
                switch (DataCanbus.DATA[1000]) {
                    case FinalCanbus.CAR_439_HC_Nissan_Toread /* 7012791 */:
                        data0 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 3 : 2;
                        break;
                    default:
            ...
            case R.id.air_sp_sync_rear /* 2131430356 */:
                ...
                break;
            case R.id.air_sp_power_rear /* 2131430357 */:
            ...
            case R.id.air_sp_mode_add /* 2131430511 */:
                ...
                break;
            case R.id.air_sp_temp_rear_munits /* 2131430516 */:
                data0 = ConstAllAirDara.C_REAR_TEMP_DOWN;
                break;
            case R.id.air_sp_temp_rear_plus /* 2131430519 */:
                data0 = ConstAllAirDara.C_REAR_TEMP_UP;
                break;
            case R.id.air_sp_blow_body_foot_rear /* 2131430521 */:
                data0 = ConstAllAirDara.C_REAR_MODE_BODY_FOOT;
                break;
            case R.id.air_sp_blow_foot_rear /* 2131430522 */:
                data0 = ConstAllAirDara.C_REAR_MODE_FOOT;
                break;
            case R.id.air_sp_blow_body_rear /* 2131430523 */:
                data0 = ConstAllAirDara.C_REAR_MODE_BODY;
                break;
            case R.id.air_sp_seatheat_rear /* 2131430526 */:
                data0 = ConstAllAirDara.C_REAR_SEAT_HEAT;
                break;
            case R.id.air_sp_cool_rear /* 2131430528 */:
                data0 = ConstAllAirDara.C_REAR_COOL;
                break;
            case R.id.air_sp_heat_rear /* 2131430530 */:
                data0 = ConstAllAirDara.C_REAR_HEAT;
                break;
            case R.id.air_sp_seatmassage_left /* 2131430531 */:
                data0 = ConstAllAirDara.C_AIR_LEFT_MASSAGE;
                break;
            case R.id.air_sp_seatwaist_left /* 2131430532 */:
                data0 = ConstAllAirDara.C_AIR_LEFT_WAIST;
                break;
            case R.id.air_sp_rearviewhot /* 2131430533 */:
                data0 = ConstAllAirDara.C_AIR_REARVIEW_HOT;
                break;
            case R.id.air_sp_seatwaist_right /* 2131430534 */:
                data0 = ConstAllAirDara.C_AIR_RIGHT_WAIST;
                break;
            case R.id.air_sp_seatmassage_right /* 2131430535 */:
                data0 = ConstAllAirDara.C_AIR_RIGHT_MASSAGE;
                break;
            case R.id.air_sp_power_front /* 2131430537 */:
    ...
    private void updateBlowBackMode() {
        ...
        if (ConstAllAirDara.C_REAR_MODE_BODY_FOOT == 255) {
            findViewById(R.id.air_sp_blow_body_rear).setBackgroundResource(DataCanbus.DATA[ConstAllAirDara.U_AIR_BACK_BLOW_BODY] == 1 ? R.drawable.ic_sp_mode_body_p : R.drawable.ic_sp_mode_body_n);
            findViewById(R.id.air_sp_blow_foot_rear).setBackgroundResource(DataCanbus.DATA[ConstAllAirDara.U_AIR_BACK_BLOW_FOOT] == 1 ? R.drawable.ic_sp_mode_foot_p : R.drawable.ic_sp_mode_foot_n);
            return;
        }
        ...
        View viewFindViewById = findViewById(R.id.air_sp_blow_body_rear);
        if (!b_body) {
            i2 = R.drawable.ic_sp_mode_body_n;
        }
        viewFindViewById.setBackgroundResource(i2);
        View viewFindViewById2 = findViewById(R.id.air_sp_blow_foot_rear);
        if (!b_foot) {

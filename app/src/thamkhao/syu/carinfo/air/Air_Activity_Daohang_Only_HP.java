...
public class Air_Activity_Daohang_Only_HP extends Activity implements View.OnTouchListener {
    ...
    int pagenum = 0;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.air.Air_Activity_Daohang_Only_HP.1
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.tv_sp_rear /* 2131427944 */:
                ...
                break;
            case R.id.air_sp_mode_body /* 2131428575 */:
                data0 = 15;
                break;
            case R.id.air_sp_mode_foot /* 2131428577 */:
                data0 = 17;
                break;
            case R.id.air_sp_mode_body_right /* 2131428585 */:
                data0 = 40;
                break;
            case R.id.air_sp_mode_foot_right /* 2131428587 */:
                data0 = 41;
                break;
            ...
            case R.id.air_sp_temp_left_plus /* 2131430305 */:
                data0 = 1;
                break;
            case R.id.air_sp_mode_up /* 2131430306 */:
                data0 = 39;
                break;
            ...
            case R.id.air_sp_cycle /* 2131430317 */:
                data0 = 11;
                break;
            case R.id.tv_sp_seat /* 2131430318 */:
                this.pagenum = 1;
                findViewById(R.id.veiw_air_front).setVisibility(8);
                ...
                break;
            case R.id.air_sp_mode_up_right /* 2131430322 */:
                data0 = 42;
                break;
            ...
            case R.id.air_sp_steer /* 2131430336 */:
                data0 = 24;
                break;
            case R.id.air_sp_sunshade /* 2131430337 */:
                data0 = 19;
                break;
            ...
            case R.id.air_sp_temp_rearleft_plus /* 2131430340 */:
                data0 = 25;
                break;
            case R.id.air_sp_temp_rearleft_munits /* 2131430344 */:
                data0 = 26;
                break;
            case R.id.air_sp_rear_mode_body /* 2131430346 */:
                data0 = 35;
                break;
            case R.id.air_sp_rear_mode_foot /* 2131430347 */:
                data0 = 37;
                break;
            case R.id.air_sp_rear_mode_bodyfoot /* 2131430348 */:
                data0 = 36;
                break;
            case R.id.air_sp_temp_rearright_plus /* 2131430349 */:
                data0 = 27;
                break;
            case R.id.air_sp_temp_rearright_munits /* 2131430353 */:
                data0 = 28;
                break;

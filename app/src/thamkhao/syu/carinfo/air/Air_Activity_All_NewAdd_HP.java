...
public class Air_Activity_All_NewAdd_HP extends Activity implements View.OnTouchListener {
    ...
    int pagenum = 0;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.air.Air_Activity_All_NewAdd_HP.1
    ...
    private void sendCmd(int data0, int data1) {
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_RZC_XP1_18ZhongHuaV6_H /* 196915 */:
                int ints02 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0);
                int ints03 = ints02 | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_MAX_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_AC_MAX ? 1 : 0);
                int ints12 = 0 | (data0 == ConstAllAirDara.C_AIR_DUAL ? 8 : 0);
                int ints13 = ints12 | (data0 == ConstAllAirDara.C_AIR_REAR_DEFROST ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                ...
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints03, ints13, ints22, ints32, ints42, 0}, null, null);
                } else if (data1 == 0) {
            ...
            case FinalCanbus.CAR_454_OD_Dongfeng_Racing_EC75_23 /* 8454598 */:
                ...
                switch (DataCanbus.DATA[1000]) {
                    ...
                    case FinalCanbus.CAR_RZC_FengShen19AX7_Hand /* 1704191 */:
                    case FinalCanbus.CAR_RZC_FengShen15AX7_View /* 1769727 */:
                        int ints15 = 0 | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0);
                        ints14 = ints15 | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                        if (data0 != ConstAllAirDara.C_AIR_CYCLE) {
                            if (data0 == ConstAllAirDara.C_AIR_MODE_BODY) {
                                ints23 = 2;
                            } else if (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT) {
                    ...
                    case FinalCanbus.CAR_Oudi_XiaoYao /* 459007 */:
                        if (data0 == ConstAllAirDara.C_AIR_WIND_ADD) {
                            ...
                            ints05 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 8 : 4;
                        }
                        break;
                    case FinalCanbus.CAR_452_RZC_Subaru /* 7209412 */:
                    case FinalCanbus.CAR_454_RZC_Suburu_OUTBACK_18 /* 8323526 */:
                        ...
                        break;
                    case FinalCanbus.CAR_454_OD_Dongfeng_Racing_EC75_23 /* 8454598 */:
                        int ints16 = 0 | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0);
                        ints14 = ints16 | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0) | (data0 == ConstAllAirDara.C_AIR_HEAT ? 4 : 0);
                        break;
                }
                int ints17 = ints14 | (data0 == ConstAllAirDara.C_AIR_REAR_DEFROST ? 4 : 0);
                ...
                switch (DataCanbus.DATA[1000]) {
                    case FinalCanbus.CAR_452_RZC_Subaru /* 7209412 */:
                    case FinalCanbus.CAR_454_RZC_Suburu_OUTBACK_18 /* 8323526 */:
                        int ints44 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_ADD ? 2 : 0);
                        ints43 = ints44 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_SUB ? 1 : 0);
                        ints5 = 0 | (data0 == ConstAllAirDara.C_AIR_LEFT_HEAT ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_RIGHT_HEAT ? 1 : 0);
                        break;
                    default:
                        ints34 = ints34 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_ADD ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_SUB ? 1 : 0);
                        break;
                }
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints05, ints17, ints23, ints34, ints43, ints5}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_CZH_RZC_19Mingjue_MG6 /* 2097425 */:
                if (data1 == 1) {
                    ...
                    data0 = 25;
                } else if (data0 == ConstAllAirDara.C_AIR_MODE_BODY || data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT || data0 == ConstAllAirDara.C_AIR_MODE_FOOT || data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT) {
                    data0 = 16;
                }
                DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{data0, data1}, null, null);
                break;
            ...
            case FinalCanbus.CAR_RZC_SwMar_Amp_17 /* 1507408 */:
                ...
                int ints07 = ints06 | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0);
                if (data0 == ConstAllAirDara.C_AIR_CYCLE) {
                    if (DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1) {
                        ints07 = 8;
                    } else {
                ...
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints07, ints19, 0, ints36, ints46, 0}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_452_LZ_TATA_ALL /* 5898692 */:
                if (data1 == 1) {
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{13, 0}, null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_453_LZ_ALFA_ROMEO /* 7930309 */:
                if (data1 == 1) {
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{34, 0}, null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_453_LZ_Jili_Boyue_18_H /* 8847813 */:
                ...
                if (data1 == 1) {
                    if (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST) {
                        ints08 = 128;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_FRONT] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_CYCLE) {
                        ints08 = 64;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_AUTO) {
                        ints08 = 32;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_AUTO] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_AC) {
                        ints08 = 16;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_AC] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_AC_MAX) {
                        ints08 = 8;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_AC_MAX] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_DUAL) {
                        ints08 = 4;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_DUAL] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_ION) {
                        ints08 = 2;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_ION] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_REAR_DEFROST) {
                        ints08 = 1;
                        ints110 = DataCanbus.DATA[ConstAllAirDara.U_AIR_REAR] == 1 ? 0 : 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_WIND_ADD) {
                        ...
                        ints47 = value8 == -2 ? 1 : value8 == -3 ? 15 : value8 - 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_ADD) {
                        int value9 = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_LEFT];
                        ints47 = value9 == -2 ? 2 : value9 == -3 ? 16 : value9 + 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_SUB) {
                        int value10 = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_RIGHT];
                        ints52 = value10 == -2 ? 1 : value10 == -3 ? 15 : value10 - 1;
                    } else if (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_ADD) {
                        int value11 = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_RIGHT];
                        ints52 = value11 == -2 ? 2 : value11 == -3 ? 16 : value11 + 1;
                    }
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints08, ints110, ints24, ints37, ints47, ints52, 0}, null, null);
                } else {
            ...
            case FinalCanbus.CAR_454_RZC_Shanqi_DelongG2 /* 10027462 */:
                ...
                int ints010 = ints09 | (data0 == ConstAllAirDara.C_AIR_AC ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_CYCLE ? 8 : 0);
                int ints111 = 0 | (data0 == ConstAllAirDara.C_AIR_MODE_BODY ? 16 : 0);
                int ints112 = ints111 | (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_FOOT ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_UP ? 1 : 0);
                ...
                int ints48 = 0 | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0);
                int ints49 = ints48 | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints010, ints112, ints26, 0, ints49}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[5], null, null);
                }
                break;
            case FinalCanbus.CAR_454_OD_Yutong_Qingka /* 11338182 */:
                int ints011 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0);
                int ints012 = ints011 | (data0 == ConstAllAirDara.C_AIR_PTC ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_CYCLE ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_AC_MAX ? 1 : 0);
                int ints113 = 0 | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0);
                int ints114 = ints113 | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                ...
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints012, ints114, ints28, ints39, ints411, 0}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
    ...
    public void initCallbackId() {
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_WC2_OPEL_Meriva_10 /* 4194340 */:
                ...
                ConstAllAirDara.U_AIR_SYNC = 110;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_sp_em /* 2131430368 */:
                ...
                break;
            case R.id.air_sp_fronthot /* 2131430372 */:
    ...
    public void mUpdateBackTemp() {
        ...
        if (findViewById(R.id.air_sp_temp_rearleft1) != null) {
            ...
            switch (DataCanbus.DATA[1000]) {
                ...
                case FinalCanbus.CAR_453_LZ_Toyota_LAND_CRUISER_11_CD /* 8913349 */:
                case FinalCanbus.CAR_453_LZ_Toyota_LAND_CRUISER_11_CD_H /* 8978885 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 9) + 635 : (temp * 5) + 175;
                    break;
                case FinalCanbus.CAR_454_LZ_GMC_Sierra_19_Screen /* 11928006 */:
                case FinalCanbus.CAR_454_LZ_Chevrolet_Silverado_19_Screen /* 11993542 */:
                    if (temp >= 30 && temp <= 64) {
                        ...
                        temp = SystemProperties.getInt("persist.fyt.temperature", 0) == 1 ? ((temp + 15) * 18) + 320 : (temp * 10) + 150;
                    }
                    break;
            }
    ...
    public void mUpdateAirTempLeft() {
        ...
        if (findViewById(R.id.air_sp_temp_left1) != null) {
            ...
            switch (DataCanbus.DATA[1000]) {
                ...
                case 274:
                case FinalCanbus.CAR_DJ_XP1_ACCORD7_H /* 65810 */:
                    temp = SystemProperties.getInt("persist.fyt.temperature", 0) == 1 ? (temp * 9) + 320 : temp * 10;
                    break;
                case 276:
                    temp = (temp * 10) + 170;
                    break;
                ...
                case FinalCanbus.CAR_RZCexc_Feiyate_TORO /* 131111 */:
                case FinalCanbus.CAR_RZC_XP1_BeiQiBJ40_21_H /* 1048972 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 10) + 590 : (temp * 5) + 155;
                    break;
                case FinalCanbus.CAR_RZC_XP1_16HAIMAMV70 /* 131309 */:
                case FinalCanbus.CAR_RZC_XP1_HAIMA_F5 /* 262381 */:
                case FinalCanbus.CAR_443_WC2_Ford_Lincoln_MKZ /* 4981179 */:
                ...
                case FinalCanbus.CAR_443_WC2_Ford_Mustang_18_M /* 16318907 */:
                case FinalCanbus.CAR_443_WC2_Ford_Mustang_18_H /* 16384443 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 0 ? temp * 10 : temp * 5;
                    break;
                case FinalCanbus.CAR_RZC_XP1_ZiYouXia /* 131445 */:
                case FinalCanbus.CAR_RZC_17ZhiNanZhe /* 262517 */:
                case FinalCanbus.CAR_RZC_17ZhiNanZhe_H /* 328053 */:
                ...
                case FinalCanbus.CAR_RZC_Dodge_RAM_HY_H /* 2031989 */:
                case FinalCanbus.CAR_RZC_XP1_ZiYouXia_H /* 2163061 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 9) + 599 : (temp * 5) + 155;
                    break;
                case FinalCanbus.CAR_RZC_HanTeng_H /* 196863 */:
                case FinalCanbus.CAR_Oudi_HanTeng_X5 /* 393471 */:
                case FinalCanbus.CAR_Oudi_XiaoYao /* 459007 */:
                case FinalCanbus.CAR_RZC_HanTeng_X5 /* 524543 */:
                    temp = temp < 16 ? (temp * 10) + 160 : temp * 5;
                    break;
                case FinalCanbus.CAR_WC2_20BaoJun530_Auto /* 393462 */:
                case FinalCanbus.CAR_WC2_20BaoJun530_Hand /* 458998 */:
                    temp = (temp * 20) + 160;
                ...
                case FinalCanbus.CAR_RZC_SwMar_17 /* 1441872 */:
                case FinalCanbus.CAR_RZC_SwMar_Amp_17 /* 1507408 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 10) + 590 : (temp * 5) + 80;
                    break;
                case FinalCanbus.CAR_453_LZ_GM_Camaro_17 /* 2163141 */:
                case FinalCanbus.CAR_453_LZ_GM_GMC_TERRAIN_17 /* 2228677 */:
                case FinalCanbus.CAR_453_LZ_GM_Equinox_17 /* 2294213 */:
                ...
                case FinalCanbus.CAR_439_HC_Ruijie /* 6816183 */:
                case FinalCanbus.CAR_439_HC_Ruijie_H /* 6881719 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 0 ? ((temp - 12) * 5) + 155 : ((temp - 12) * 10) + 600;
                    break;
                case FinalCanbus.CAR_453_LZ_Jili_Boyue_18 /* 8782277 */:
                case FinalCanbus.CAR_453_LZ_Jili_Boyue_18_H /* 8847813 */:
    ...
    public void mUpdateAutoRight() {
        ...
        switch (DataCanbus.DATA[1000]) {
            case FinalCanbus.CAR_454_LZ_Nissan_05_Cima /* 9044422 */:
                View viewFindViewById = findViewById(R.id.air_sp_auto_right);
                if (vel != 2) {
                    i = R.drawable.ic_hp_auto_n;
                }
                viewFindViewById.setBackgroundResource(i);
                break;
            default:
                View viewFindViewById2 = findViewById(R.id.air_sp_auto_right);
                if (vel != 0) {
                    i2 = R.drawable.ic_hp_auto_p;
                }
    ...
    public void mUpdateAuto() {
        ...
        switch (DataCanbus.DATA[1000]) {
            case FinalCanbus.CAR_454_LZ_Nissan_05_Cima /* 9044422 */:
                View viewFindViewById = findViewById(R.id.air_sp_auto);
                if (vel != 2) {
                    i = R.drawable.ic_hp_auto_n;
                }
                viewFindViewById.setBackgroundResource(i);
                break;
            default:
                View viewFindViewById2 = findViewById(R.id.air_sp_auto);
                if (vel != 0) {
                    i2 = R.drawable.ic_hp_auto_p;
                }
                viewFindViewById2.setBackgroundResource(i2);

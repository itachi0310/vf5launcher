...
public class Air_Activity_All_Toyota_prado_HP extends Activity implements View.OnTouchListener {
    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.air.Air_Activity_All_Toyota_prado_HP.1
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            if (DataCanbus.DATA[1000] == 15860165) {
                if (updateCode == 113) {
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_RZC_XP1_19MaiRuiBaoXL /* 6553661 */:
                if (data1 == 1) {
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{7, 0}, null, null);
                }
                break;
            case 86:
                if (data1 == 1) {
                ...
                if (data1 == 1) {
                    if (data0 == ConstAllAirDara.C_AIR_AUTO) {
                        if (DataCanbus.DATA[ConstAllAirDara.U_AIR_AUTO] == 1) {
                            DataCanbus.PROXY.cmd(87, new int[]{data0, 0}, null, null);
                ...
                if (data1 == 1) {
                    if (data0 == ConstAllAirDara.C_AIR_POWER) {
                        ...
                        if (DataCanbus.DATA[ConstAllAirDara.U_AIR_WINLEV] == 0) {
                            ...
                            DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{data0, 0}, null, null);
                        }
                    } else if (data0 == ConstAllAirDara.C_AIR_DUAL) {
                ...
                if (DataCanbus.DATA[1000] == 3276939 && data1 == 1) {
                    if (data0 == ConstAllAirDara.C_AIR_STEER) {
                        if (DataCanbus.DATA[ConstAllAirDara.U_AIR_STEER] == 1) {
                            DataCanbus.PROXY.cmd(1, new int[]{ConstAllAirDara.C_AIR_STEER, 0}, null, null);
                        } else {
                        ...
                        if (DataCanbus.DATA[ConstAllAirDara.U_AIR_CLEAN] == 1) {
                            DataCanbus.PROXY.cmd(1, new int[]{ConstAllAirDara.C_CLEAN, 0}, null, null);
                        } else {
                        ...
                        if (DataCanbus.DATA[ConstAllAirDara.U_AIR_SWING] == 1) {
                            DataCanbus.PROXY.cmd(1, new int[]{ConstAllAirDara.C_AIR_SWING, 0}, null, null);
                        } else {
            ...
            case FinalCanbus.CAR_453_RZC_VinFast_PLUS_23 /* 15860165 */:
                int ints07 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_AC_MAX ? 1 : 0);
                ...
                int ints24 = 0 | (data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_FOOT ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODY ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_CYCLE ? 1 : 0);
                ...
                int ints56 = 0 | (data0 == ConstAllAirDara.C_AIR_RIGHT_COLD ? 8 : 0);
                int ints57 = ints56 | (data0 == ConstAllAirDara.C_AIR_LEFT_COLD ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_RIGHT_HEAT ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_LEFT_HEAT ? 1 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints07, ints19, ints24, ints38, ints46, ints57}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_RZC_ZhongTaiDaMaiX7 /* 14614967 */:
                int ints25 = 0;
                int ints08 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0);
                if (data0 == ConstAllAirDara.C_AIR_CYCLE) {
                    if (DataCanbus.DATA[1000] == 8520119) {
                        ints25 = 1;
                    } else {
                        ints08 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 8 : 4;
                    }
                }
                int ints09 = ints08 | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_AC_MAX ? 1 : 0);
                ...
                int ints26 = ints25 | (data0 == ConstAllAirDara.C_AIR_MODE_UP ? 160 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODY ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_FOOT ? 96 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT ? 128 : 0);
                ...
                int ints58 = 0 | (data0 == ConstAllAirDara.C_AIR_LEFT_HEAT ? 1 : 0);
                int ints59 = ints58 | (data0 == ConstAllAirDara.C_AIR_RIGHT_HEAT ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_ION ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_HEAT ? 4 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints09, ints111, ints26, ints310, ints48, ints59}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_RZC_23_Vios_Malaysia_H /* 7209072 */:
                int ints010 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER_RIGHT ? 8 : 0) | (data0 == ConstAllAirDara.C_CLEAN ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0);
                int ints112 = 0 | (data0 == ConstAllAirDara.C_AIR_ION ? 128 : 0);
                int ints113 = ints112 | (data0 == ConstAllAirDara.C_AIR_SWING ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_FLOWER_BLOW ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_SWING ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_ZONE ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_DUAL ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_REAR_DEFROST ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                int ints27 = 0 | (data0 == ConstAllAirDara.C_AIR_LEFT_COLD ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_RIGHT_COLD ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_LEFT_HEAT ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_RIGHT_HEAT ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_CYCLE ? 1 : 0);
                if (!SystemProperties.getBoolean("persist.fyt.reversetemp", false)) {
                    int ints311 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_ADD ? 2 : 0);
                    ints3 = ints311 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_SUB ? 1 : 0);
                    int ints49 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_ADD ? 2 : 0);
                    ints4 = ints49 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_SUB ? 1 : 0);
                } else {
                    int ints410 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_ADD ? 2 : 0);
                    ints4 = ints410 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_SUB ? 1 : 0);
                    int ints312 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_ADD ? 2 : 0);
                    ints3 = ints312 | (data0 == ConstAllAirDara.C_AIR_TEMP_RIGHT_SUB ? 1 : 0);
                }
                int ints411 = ints4 | (data0 == ConstAllAirDara.C_AIR_FRONT_ONLY ? 64 : 0) | (data0 == ConstAllAirDara.C_REAR_RIGHT_TEMP_UP ? 32 : 0) | (data0 == ConstAllAirDara.C_REAR_RIGHT_TEMP_DOWN ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_ECO ? 4 : 0);
                int ints510 = 0 | (data0 == ConstAllAirDara.C_REAR_OFF ? 64 : 0);
                int ints511 = ints510 | (data0 == ConstAllAirDara.C_REAR_WIND_UP ? 32 : 0) | (data0 == ConstAllAirDara.C_REAR_WIND_DOWN ? 16 : 0) | (data0 == ConstAllAirDara.C_REAR_MODE ? 8 : 0) | (data0 == ConstAllAirDara.C_REAR_AUTO ? 4 : 0) | (data0 == ConstAllAirDara.C_REAR_LEFT_TEMP_UP ? 2 : 0) | (data0 == ConstAllAirDara.C_REAR_LEFT_TEMP_DOWN ? 1 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints010, ints113, ints27, ints3, ints411, ints511, 0}, null, null);
                } else if (data1 == 0) {
            ...
            case FinalCanbus.CAR_454_OD_WeiCai_EHPro_24 /* 11469254 */:
                if (data1 == 1) {
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{1, 0}, null, null);
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{2, 0}, null, null);
                } else {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{data0, 0}, null, null);
                }
                break;
            case FinalCanbus.CAR_439_RZC_LufengXiaoyao /* 4325815 */:
                ...
                int ints314 = 0;
                boolean flag4 = false;
                int ints012 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0);
                if (data0 == ConstAllAirDara.C_AIR_WIND_ADD) {
                    int vuale3 = DataCanbus.DATA[ConstAllAirDara.U_AIR_WIND_LEVEL_LEFT];
                    if (vuale3 < 7) {
                        vuale3++;
                    }
                    ints115 = (vuale3 << 4) & 240;
                    flag4 = true;
                } else if (data0 == ConstAllAirDara.C_AIR_WIND_SUB) {
                    ...
                    if (tempAll4 == -3) {
                        ...
                        ints314 = (((tempAll4 - 1) + 18) << 2) & 252;
                    }
                    flag4 = true;
                }
                int ints29 = 0 | (data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT ? 16 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_FOOT ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODY ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_CYCLE ? 1 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints012, ints115, ints29, ints314, 0}, null, null);
                    break;
            ...
            case FinalCanbus.CAR_452_RZC_ChangAn_KESAI_Pro_21 /* 11010500 */:
                int ints013 = 0 | (data0 == ConstAllAirDara.C_AIR_POWER ? 128 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_CHANGER ? 64 : 0) | (data0 == ConstAllAirDara.C_AIR_AUTO ? 32 : 0) | (data0 == ConstAllAirDara.C_AIR_FRONT_DEFROST ? 16 : 0);
                if (data0 == ConstAllAirDara.C_AIR_CYCLE) {
                    if (DataCanbus.DATA[1000] != 4719044 && DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1) {
                        ints013 = 8;
                    } else {
                        ints013 = 4;
                    }
                }
                int ints014 = ints013 | (data0 == ConstAllAirDara.C_AIR_AC ? 2 : 0);
                int ints116 = 0 | (data0 == ConstAllAirDara.C_AIR_REAR_DEFROST ? 4 : 0);
                int ints117 = ints116 | (data0 == ConstAllAirDara.C_AIR_WIND_ADD ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_WIND_SUB ? 1 : 0);
                int ints210 = 0 | (data0 == ConstAllAirDara.C_AIR_MODE_BODY ? 2 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_BODYFOOT ? 4 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_FOOT ? 8 : 0) | (data0 == ConstAllAirDara.C_AIR_MODE_UPFOOT ? 16 : 0);
                int ints315 = 0 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_ADD ? 2 : 0);
                int ints316 = ints315 | (data0 == ConstAllAirDara.C_AIR_TEMP_LEFT_SUB ? 1 : 0);
                int ints512 = 0 | (data0 == ConstAllAirDara.C_REAR_CTRL ? 4 : 0);
                if (data1 == 1) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{ints014, ints117, ints210, ints316, 0, ints512}, null, null);
                } else if (data1 == 0) {
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[6], null, null);
                }
                break;
            ...
            case FinalCanbus.CAR_453_LZ_Maserati_Levante_18 /* 5636549 */:
                if (data1 == 1) {
                    ...
                    DataCanbus.PROXY.cmd(ConstAllAirDara.C_CONTRAL, new int[]{24, 0}, null, null);
                }
                break;
    ...
    public void initCallbackId() {
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_454_LZ_Ford_F150_15_H /* 3998150 */:
                ...
                ConstAllAirDara.U_AIR_TEMP_LEFT = 27;
                ConstAllAirDara.U_AIR_TEMP_RIGHT = 28;
                if (DataCanbus.DATA[1000] == 3998150) {
                    ConstAllAirDara.U_AIR_AUTO = 13;
                    ConstAllAirDara.U_AIR_DUAL = 14;
                    ConstAllAirDara.U_AIR_SEATHEAT_LEFT = 29;
                    ConstAllAirDara.U_AIR_SEATHEAT_RIGHT = 30;
    ...
    private void init() {
        ...
        } else if (ConstAllAirDara.U_AIR_HAVE_REAR != 255) {
            findViewById(R.id.tv_sp_front).setVisibility(0);
            findViewById(R.id.tv_sp_rear).setVisibility(0);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        int data0 = 255;
        switch (id) {
            case R.id.tv_sp_front /* 2131427943 */:
                this.pagenum = 0;
                ...
                break;
            case R.id.tv_sp_rear /* 2131427944 */:
                this.pagenum = 1;
                ...
                break;
            case R.id.air_sp_mode_change /* 2131428574 */:
            ...
            case R.id.air_sp_cycle /* 2131430317 */:
                switch (DataCanbus.DATA[1000]) {
                    ...
                    case FinalCanbus.CAR_RZC_XP1_21DR_F35 /* 2556308 */:
                    case FinalCanbus.CAR_453_OD_BQ_BJ30_21 /* 12845509 */:
                        data0 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 5 : 4;
                        break;
                    case FinalCanbus.CAR_452_OD_Nissan_Tule_low /* 6095300 */:
                        data0 = DataCanbus.DATA[ConstAllAirDara.U_AIR_CYCLE] == 1 ? 13 : 12;
                        break;
                    default:
            ...
            case R.id.air_sp_power /* 2131430331 */:
                data0 = this.pagenum == 1 ? ConstAllAirDara.C_REAR_OFF : ConstAllAirDara.C_AIR_POWER;
                break;
            ...
            case R.id.air_sp_seatwind_right /* 2131430339 */:
                ...
                break;
            case R.id.air_sp_temp_rearleft_plus /* 2131430340 */:
                data0 = ConstAllAirDara.C_REAR_LEFT_TEMP_UP;
                break;
            case R.id.air_sp_temp_rearright_plus /* 2131430349 */:
                data0 = ConstAllAirDara.C_REAR_RIGHT_TEMP_UP;
                break;
            case R.id.air_sp_rearlock_rear /* 2131430354 */:
                data0 = ConstAllAirDara.C_REAR_LOCK;
                break;
            case R.id.air_sp_ac_rear /* 2131430355 */:
                data0 = ConstAllAirDara.C_REAR_AC;
                break;
            case R.id.air_sp_sync_rear /* 2131430356 */:
                data0 = ConstAllAirDara.C_REAR_SYNC;
                break;
            case R.id.air_sp_rear_wind_minuts /* 2131430358 */:
                data0 = ConstAllAirDara.C_REAR_WIND_DOWN;
                break;
            case R.id.air_sp_rear_wind_plus /* 2131430360 */:
                data0 = ConstAllAirDara.C_REAR_WIND_UP;
                break;
            case R.id.air_sp_auto_rear /* 2131430361 */:
            ...
            case R.id.air_sp_em /* 2131430368 */:
                ...
                break;
            case R.id.air_sp_flowerblow /* 2131430374 */:
                data0 = ConstAllAirDara.C_AIR_FLOWER_BLOW;
                break;
            case R.id.air_sp_onlyfront_front /* 2131430376 */:
                data0 = ConstAllAirDara.C_AIR_FRONT_ONLY_F;
                break;
            case R.id.air_sp_airpark /* 2131430378 */:
            ...
            case R.id.air_sp_car_rear /* 2131430382 */:
                ...
                break;
            case R.id.air_sp_ion /* 2131430385 */:
            ...
            case R.id.air_sp_eco /* 2131430389 */:
                ...
                break;
            case R.id.air_sp_blowtop /* 2131430391 */:
            ...
            case R.id.air_sp_nanoe /* 2131430400 */:
                ...
                break;
            case R.id.air_sp_swing /* 2131430402 */:
            ...
            case R.id.air_sp_blow_win_right /* 2131430430 */:
                ...
                break;
            case R.id.air_sp_blow_mode_minus /* 2131430434 */:
                data0 = ConstAllAirDara.C_AIR_MODE_SUB;
                break;
            case R.id.air_sp_blow_changer_center /* 2131430436 */:
                data0 = ConstAllAirDara.C_AIR_MODE_CENTER;
                break;
            case R.id.air_sp_blow_mode_plus /* 2131430438 */:
            ...
            case R.id.air_sp_blow_changer_right /* 2131430440 */:
                ...
                break;
            case R.id.air_sp_seatwind_left_rear /* 2131430449 */:
                data0 = ConstAllAirDara.C_AIR_LEFT_COLD_REAR;
                break;
            case R.id.air_sp_seatheat_left_rear /* 2131430451 */:
                data0 = ConstAllAirDara.C_AIR_LEFT_HEAT_REAR;
                break;
            case R.id.air_sp_rear_manual /* 2131430454 */:
                data0 = ConstAllAirDara.C_AIR_REAR_MANUAL;
                break;
            case R.id.air_sp_rear_cool /* 2131430456 */:
                data0 = ConstAllAirDara.C_REAR_COOL;
                break;
            case R.id.air_sp_onlyfront /* 2131430458 */:
                data0 = ConstAllAirDara.C_AIR_FRONT_ONLY;
                break;
            case R.id.air_sp_auto_rear_right /* 2131430463 */:
                data0 = ConstAllAirDara.C_REAR_AUTO_RIGHT;
                break;
            case R.id.air_sp_seatheat_right_rear /* 2131430465 */:
                data0 = ConstAllAirDara.C_AIR_RIGHT_HEAT_REAR;
                break;
            case R.id.air_sp_seatwind_right_rear /* 2131430467 */:
                data0 = ConstAllAirDara.C_AIR_RIGHT_COLD_REAR;
                break;
            case R.id.air_sp_temp_rearleft_minus /* 2131430474 */:
                data0 = ConstAllAirDara.C_REAR_LEFT_TEMP_DOWN;
                break;
            case R.id.air_sp_rear_blow_changer /* 2131430484 */:
                data0 = ConstAllAirDara.C_REAR_MODE;
                break;
            case R.id.air_sp_rear_blow_body_foot /* 2131430486 */:
                data0 = ConstAllAirDara.C_REAR_MODE_BODY_FOOT;
                break;
            case R.id.air_sp_rear_blow_foot /* 2131430488 */:
                data0 = ConstAllAirDara.C_REAR_MODE_FOOT;
                break;
            case R.id.air_sp_rear_blow_body /* 2131430490 */:
                data0 = ConstAllAirDara.C_REAR_MODE_BODY;
                break;
            case R.id.air_sp_rear_blow_changer_right /* 2131430492 */:
                data0 = ConstAllAirDara.C_REAR_MODE_RIGHT;
                break;
            case R.id.air_sp_temp_rearright_minus /* 2131430499 */:
    ...
    public void mUpdateAirAQS() {
        ...
        switch (DataCanbus.DATA[1000]) {
            ...
            case FinalCanbus.CAR_453_Tangdu_Jaguar_XJXJL /* 15466949 */:
                ...
                break;
            default:
                View viewFindViewById = findViewById(R.id.air_sp_aqs);
                if (vel != 0) {
                    i = R.drawable.ic_hp_aqs_p;
                }
    ...
    public void mUpdateBackTemp() {
        ...
        if (findViewById(R.id.air_sp_temp_rearleft1) != null) {
            ...
            switch (DataCanbus.DATA[1000]) {
                ...
                case FinalCanbus.CAR_453_KYC_Toyota_Alpha_15 /* 7799237 */:
                case FinalCanbus.CAR_453_KYC_Toyota_Alpha_15_Top /* 7864773 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 10) + 310 : temp * 5;
                    break;
                case FinalCanbus.CAR_439_RZC_YinFeiNiDi_QX50 /* 6029751 */:
                case FinalCanbus.CAR_454_RZC_YinFeiNiDi_QX70_13 /* 6685126 */:
                case FinalCanbus.CAR_454_RZC_YinFeiNiDi_Q70_16_L /* 6750662 */:
                case FinalCanbus.CAR_454_RZC_YinFeiNiDi_Q70_16_H /* 6816198 */:
                case FinalCanbus.CAR_443_WC2_Feiyate_All_Brazil /* 14090683 */:
                    temp = SystemProperties.getInt("persist.fyt.temperature", 0) == 1 ? (temp * 9) + 320 : temp * 5;
                    break;
                case FinalCanbus.CAR_452_Xinchi_Dodge_JCUV /* 6226372 */:
                case FinalCanbus.CAR_439_XC_Feiyate_Feiyue /* 15532471 */:
                    temp *= 10;
                ...
                case FinalCanbus.CAR_453_Tangdu_Jaguar_XJXJL_16 /* 15401413 */:
                case FinalCanbus.CAR_453_Tangdu_Jaguar_XJXJL /* 15466949 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? temp * 10 : temp * 5;
                    break;
            }
    ...
    public void mUpdateAirTempLeft() {
        ...
        if (findViewById(R.id.air_sp_temp_left1) != null) {
            ...
            switch (DataCanbus.DATA[1000]) {
                ...
                case FinalCanbus.CAR_453_Tangdu_Jaguar_XJXJL_16 /* 15401413 */:
                case FinalCanbus.CAR_453_Tangdu_Jaguar_XJXJL /* 15466949 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 0 ? temp * 5 : temp * 10;
                    break;
                case 223:
                    temp = (temp * 5) - 400;
                    break;
                ...
                case FinalCanbus.CAR_453_OD_Jili_Panda_Mini /* 8454597 */:
                case FinalCanbus.CAR_453_OD_Jili_Dihao_EV /* 16056773 */:
                    temp = (temp >= 32 && temp <= 34) ? ((temp - 32) * 5) + 160 : (temp * 5) + 170;
                    break;
                case FinalCanbus.CAR_WC_17Haval_H2S /* 196740 */:
                case FinalCanbus.CAR_RZC_HavalLow_H2S_HongBiao /* 393460 */:
                case FinalCanbus.CAR_RZC_HavalLow_H2S_LanBiao /* 721140 */:
                ...
                case FinalCanbus.CAR_452_LZ_Volvo_10 /* 13631940 */:
                case FinalCanbus.CAR_452_LZ_Volvo_15 /* 16515524 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 1 ? (temp * 9) + 320 : temp * 5;
                    break;
                case FinalCanbus.CAR_439_OD_Qirui_KaiyiX3 /* 1507780 */:
                    temp = (temp * 5) + 155;
                    break;
                ...
                case FinalCanbus.CAR_453_LZ_Nissan_Teana_03 /* 2687429 */:
                case FinalCanbus.CAR_453_LZ_Nissan_Teana_03_H /* 2752965 */:
                    temp = DataCanbus.DATA[ConstAllAirDara.U_AIR_TEMP_UNIT] == 0 ? (temp * 5) + 175 : (temp * 10) + 590;
                    break;
                case FinalCanbus.CAR_454_LZ_Toyota_Prius_03_L /* 3539398 */:
                case FinalCanbus.CAR_454_LZ_Toyota_Prius_03_H /* 3604934 */:
                case FinalCanbus.CAR_454_LZ_Lexus_RX330_L /* 3801542 */:
                case FinalCanbus.CAR_454_LZ_Lexus_RX330_H /* 3867078 */:
                    temp = SystemProperties.getInt("persist.fyt.temperature", 0) == 1 ? (temp * 9) + 635 : (temp * 5) + 175;
                    break;
                case FinalCanbus.CAR_439_HC_RongWei950 /* 4129207 */:
                case FinalCanbus.CAR_452_OD_Zhonghua_V6_18 /* 6160836 */:
                case FinalCanbus.CAR_452_OD_WeiMa_E5 /* 15663556 */:
                ...
                case FinalCanbus.CAR_439_DJ_Nissan /* 12779959 */:
                case FinalCanbus.CAR_439_DJ_Nissan_H /* 12845495 */:
                    temp = SystemProperties.getInt("persist.fyt.temperature", 0) == 1 ? temp * 10 : temp * 5;
                    break;
                case FinalCanbus.CAR_452_RZC_SWM_G01_21_Low /* 11338180 */:
                    if (temp >= 36 && temp <= 50) {
                        temp = ((temp - 36) * 10) + 180;
    ...
    public void updateBlowModeLeft() {
        ...
        if (ConstAllAirDara.C_AIR_MODE_BODYFOOT == 255 && ConstAllAirDara.C_AIR_MODE_UPFOOT == 255) {
            View viewFindViewById = findViewById(R.id.air_sp_blow_win);
            if (win == 1) {

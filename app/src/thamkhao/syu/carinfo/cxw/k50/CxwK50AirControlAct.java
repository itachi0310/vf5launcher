    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_rear /* 2131427565 */:
                data0 = 13;
                break;
            case R.id.air_xts_blow_body /* 2131428154 */:
                data0 = 7;
                break;
            case R.id.air_xts_blow_body_foot /* 2131428155 */:
                data0 = 8;
                break;
            case R.id.air_xts_blow_foot /* 2131428156 */:
                data0 = 9;
                break;
            case R.id.air_xts_blow_foot_win /* 2131428157 */:
                data0 = 10;
                break;
            case R.id.air_xts_cycle_in /* 2131428158 */:
                data0 = 5;
                break;
            case R.id.air_xts_cycle_out /* 2131428159 */:
                data0 = 6;
                break;
        }

...
public class X80Act extends BaseActivity {
    ...
    public void updaterxuniDie() {
        int luzhiIndex = DataCanbus.DATA[119];
        int jindu = DataCanbus.DATA[121];
        int playIndex = DataCanbus.DATA[120];
        int[] dieInt = {DataCanbus.DATA[127], DataCanbus.DATA[126], DataCanbus.DATA[125], DataCanbus.DATA[124], DataCanbus.DATA[123], DataCanbus.DATA[122]};
        if (luzhiIndex >= 1 && luzhiIndex <= 6) {
            if (jindu >= 0 && jindu < 100) {
                if (findViewById(R.id.show_progress).getVisibility() != 0 && DataCanbus.DATA[96] == 2) {
    ...
    public void updaterShowPage() {
        int PageIndex = DataCanbus.DATA[96];
        if (PageIndex == 1) {
        ...
        if (PageIndex == 2) {
            ((TextView) findViewById(R.id.cd_tip_show_center_tv)).setVisibility(8);
            if ((findViewById(R.id.cd_view).getVisibility() == 8 || findViewById(R.id.cd_view).getVisibility() == 4) && (DataCanbus.DATA[109] == 3 || DataCanbus.DATA[109] == 4)) {
    ...
    public void updaterdiantaiNum() {
        int channel = DataCanbus.DATA[97];
        for (int i = 0; i < 6; i++) {
            if (i == channel - 1) {
    ...
    public void updaterChannelFreq1() {
        int channelfreq1 = DataCanbus.DATA[101];
    ...
    public void updaterChannelFreq2() {
        int channelfreq2 = DataCanbus.DATA[102];
    ...
    public void updaterChannelFreq3() {
        int channelfreq3 = DataCanbus.DATA[103];
    ...
    public void updaterChannelFreq4() {
        int channelfreq4 = DataCanbus.DATA[104];
    ...
    public void updaterChannelFreq5() {
        int channelfreq5 = DataCanbus.DATA[105];
    ...
    public void updaterChannelFreq6() {
        int channelfreq6 = DataCanbus.DATA[106];
    ...
    public void updaterMediaState() {
        int pageIndex = DataCanbus.DATA[96];
        if (pageIndex == 2) {
            int mMediaState = DataCanbus.DATA[109];
            ((TextView) findViewById(R.id.cd_tip_show_center_tv)).setVisibility(8);
            if (mMediaState == 5) {
                if (findViewById(R.id.cd_view).getVisibility() != 0) {
                    findViewById(R.id.cd_view).setVisibility(0);
    ...
    public void updaterSongType() {
        int songType = DataCanbus.DATA[110];
        String mId3Info = Callback_0375_SBD_WC1_ReservedCdBenTengX80.Str1;
        int mMediaState = DataCanbus.DATA[109];
        int trackNum = DataCanbus.DATA[111];
    ...
    public void updaterPlayTime() {
        ...
        int playsecond = DataCanbus.DATA[114];
        if (playsecond > 59) {
            playsecond = 59;
        }
        if (playsecond < 0) {
    ...
    public void updaterVol() {
        ...
        int muteValue = DataCanbus.DATA[129];
        if (muteValue == 1) {

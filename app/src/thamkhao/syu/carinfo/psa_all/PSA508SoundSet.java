    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int value11 = DataCanbus.DATA[196];
                if (value11 > 0) {
                    value10 = value11 - 1;
                } else {
                    value10 = 14;
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value13 = DataCanbus.DATA[197];
                if (value13 > 0) {
                    value8 = value13 - 1;
                } else {
                    value8 = 14;
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                setCmd(11, DataCanbus.DATA[198] != 0 ? 0 : 1);
                break;
            case R.id.btn_minus4 /* 2131427464 */:
                int value15 = DataCanbus.DATA[201];
                if (value15 > 0) {
                    value6 = value15 - 1;
                } else {
                    value6 = 5;
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                int value16 = DataCanbus.DATA[201];
                if (value16 < 5) {
                    value5 = value16 + 1;
                } else {
                    value5 = 0;
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value17 = DataCanbus.DATA[202];
                if (value17 > 0) {
                    value4 = value17 - 1;
                } else {
                    value4 = 14;
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int value20 = DataCanbus.DATA[203];
                if (value20 < 14) {
                    value = value20 + 1;
                } else {
                    value = 0;
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                setCmd(12, DataCanbus.DATA[199] != 0 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCmd(13, DataCanbus.DATA[200] != 0 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                DataCanbus.PROXY.cmd(101, 24, DataCanbus.DATA[239] != 0 ? 0 : 1);
                break;
        }
    }

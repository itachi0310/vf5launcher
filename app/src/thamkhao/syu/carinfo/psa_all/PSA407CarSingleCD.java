...
public class PSA407CarSingleCD extends Activity implements View.OnTouchListener {
    ...
    int cmdId = -1;
    int touchState = -1;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.psa_all.PSA407CarSingleCD.1
    ...
    private void setCdControl(int cmdId) {
        DataCanbus.PROXY.cmd(7, new int[]{cmdId, 0, 0}, null, null);
    }
    ...
    public void mUpdaterCdTime() {
        int value = DataCanbus.DATA[148] / 3600;
        int value1 = (DataCanbus.DATA[148] % 3600) / 60;
        int value2 = DataCanbus.DATA[148] % 60;
        int value3 = DataCanbus.DATA[147] / 3600;
        int value4 = (DataCanbus.DATA[147] % 3600) / 60;
        int value5 = DataCanbus.DATA[147] % 60;

    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value9 = DataCanbus.DATA[124] - 1;
                if (value9 < 1) {
                    value9 = 6;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                int value10 = DataCanbus.DATA[124] + 1;
                if (value10 > 6) {
                    value10 = 1;
                }
            ...
            case R.id.btn_minus6 /* 2131427470 */:
                int value11 = DataCanbus.DATA[126] - 1;
                if (value11 < 1) {
                    value11 = 7;
                }
            ...
            case R.id.ctv_checkedtext17 /* 2131427564 */:
                int value33 = DataCanbus.DATA[121];
                if (value33 == 0) {
                    value33 = 1;
                } else if (value33 == 1) {
                    value33 = 0;
            ...
            case R.id.ctv_checkedtext19 /* 2131427665 */:
                int value35 = DataCanbus.DATA[128];
                if (value35 == 0) {
                    value35 = 1;
                } else if (value35 == 1) {
                    value35 = 0;
            ...
            case R.id.ctv_checkedtext20 /* 2131427667 */:
                int value36 = DataCanbus.DATA[129];
                if (value36 == 0) {
                    value36 = 1;
                } else if (value36 == 1) {
                    value36 = 0;
            ...
            case R.id.ctv_checkedtext21 /* 2131427669 */:
                int value37 = DataCanbus.DATA[130];
                if (value37 == 0) {
                    value37 = 1;
                } else if (value37 == 1) {
                    value37 = 0;

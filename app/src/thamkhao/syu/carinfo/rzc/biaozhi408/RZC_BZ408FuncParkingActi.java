...
public class RZC_BZ408FuncParkingActi extends BaseActivity {
    ...
    private View.OnClickListener mClick = new View.OnClickListener() { // from class: com.syu.carinfo.rzc.biaozhi408.RZC_BZ408FuncParkingActi.2
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.rzc_bz4008_turn_light_bydriver /* 2131432554 */:
                    ...
                    break;
                case R.id.rzc_bz4008_only_unlock_backdoor /* 2131432556 */:
                    ...
                    break;
                case R.id.rzc_bz4008_temp_unit /* 2131432558 */:
                    ...
                    break;
                case R.id.rzc_bz4008_pilao /* 2131432561 */:
                    ...
                    break;
                case R.id.rzc_bz4008_pullcontrol_sys /* 2131432563 */:
                    ...
                    break;
                case R.id.rzc_bz4008_driver_assist /* 2131432565 */:
                    int value6 = DataCanbus.DATA[177];

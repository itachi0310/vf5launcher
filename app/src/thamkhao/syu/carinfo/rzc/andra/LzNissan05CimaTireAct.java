...
public class LzNissan05CimaTireAct extends BaseActivity {
    private IUiNotify notifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.andra.LzNissan05CimaTireAct.1
    ...
    public void addNotify() {
        DataCanbus.PROXY.cmd(1, new int[]{54, 0}, null, null);

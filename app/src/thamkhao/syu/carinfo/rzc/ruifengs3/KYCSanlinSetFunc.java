    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus13 /* 2131427491 */:
                int value25 = DataCanbus.DATA[122] - 1;
                if (value25 < 0) {
                    value25 = 3;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value26 = DataCanbus.DATA[122] + 1;
                if (value26 > 3) {
                    value26 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value27 = DataCanbus.DATA[124] - 1;
                if (value27 < 0) {
                    value27 = 1;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value28 = DataCanbus.DATA[124] + 1;
                if (value28 > 1) {
                    value28 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value29 = DataCanbus.DATA[123];
                if (value29 == 1) {
                    value29 = 0;
                } else if (value29 == 0) {
                    value29 = 1;
        ...
        builder.setPositiveButton(getResources().getString(R.string.confirm), new DialogInterface.OnClickListener() { // from class: com.syu.carinfo.rzc.ruifengs3.KYCSanlinSetFunc.2
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new Thread(new Runnable() { // from class: com.syu.carinfo.rzc.ruifengs3.KYCSanlinSetFunc.2.1
                    ...
                    public void run() {
                        DataCanbus.PROXY.cmd(2, new int[]{i, 0}, null, null);
                    }
                }).start();
                dialog.dismiss();
            }

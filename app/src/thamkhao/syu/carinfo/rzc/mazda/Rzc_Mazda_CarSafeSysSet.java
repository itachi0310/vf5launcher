    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value9 = DataCanbus.DATA[102] - 1;
                if (value9 < 1) {
                    value9 = 3;
                }
                setCarInfo(1, value9 + 16, 0);
                break;
            case R.id.btn_plus2 /* 2131427460 */:
                int value10 = DataCanbus.DATA[102] + 1;
                if (value10 > 3) {
                    value10 = 1;
                }
                setCarInfo(1, value10 + 16, 0);
                break;
            case R.id.btn_minus3 /* 2131427461 */:
                int value11 = DataCanbus.DATA[103] - 1;
                if (value11 < 1) {
                    value11 = 3;
                }
                setCarInfo(1, value11 + 32, 0);
                break;
            case R.id.btn_plus3 /* 2131427463 */:
                ...
                setCarInfo(1, value12 + 32, 0);
                break;
            case R.id.btn_minus4 /* 2131427464 */:
                int value13 = DataCanbus.DATA[105] - 1;
                if (value13 < 1) {
                    value13 = 3;
                }
                setCarInfo(3, 2, value13);
                break;
            case R.id.btn_plus4 /* 2131427466 */:
                int value14 = DataCanbus.DATA[105] + 1;
                if (value14 > 3) {
                    value14 = 1;
                }
                setCarInfo(3, 2, value14);
                break;
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                ...
                setCarInfo(5, 2, value19);
                break;
            case R.id.btn_plus7 /* 2131427475 */:
                int value20 = DataCanbus.DATA[110] + 1;
                if (value20 > 3) {
                    value20 = 1;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int value21 = DataCanbus.DATA[111] - 1;
                if (value21 < 1) {
                    value21 = 4;
                }
                setCarInfo(6, 1, value21);
                break;
            case R.id.btn_plus8 /* 2131427478 */:
                int value22 = DataCanbus.DATA[111] + 1;
                if (value22 > 4) {
                    value22 = 1;
                }
                setCarInfo(6, 1, value22);
                break;
            case R.id.btn_minus9 /* 2131427479 */:
                int value23 = DataCanbus.DATA[112] - 1;
                if (value23 < 1) {
                    value23 = 3;
                }
                setCarInfo(6, 2, value23);
                break;
            case R.id.btn_plus9 /* 2131427481 */:
                int value24 = DataCanbus.DATA[112] + 1;
                if (value24 > 3) {
                    value24 = 1;
                }
                setCarInfo(6, 2, value24);
                break;
            ...
            case R.id.btn_minus16 /* 2131427523 */:
                int value31 = DataCanbus.DATA[123] - 1;
                if (value31 < 1) {
                    value31 = 4;
                }
                setCarInfo(9, 2, value31);
                break;
            case R.id.btn_plus16 /* 2131427525 */:
                ...
                setCarInfo(9, 2, value32);
                break;
            case R.id.btn_minus17 /* 2131427526 */:
                int value33 = DataCanbus.DATA[127] - 1;
                if (value33 < 1) {
                    value33 = 3;
                }
                setCarInfo(11, 2, value33);
                break;
            case R.id.btn_plus17 /* 2131427528 */:
                int value34 = DataCanbus.DATA[127] + 1;
                if (value34 > 3) {
                    value34 = 1;
                }
                setCarInfo(11, 2, value34);
                break;
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value35 = DataCanbus.DATA[100];
                if (value35 == 1) {
                    value35 = 1;
                } else if (value35 == 0) {
                    value35 = 2;
                }
                setCarInfo(1, value35, 0);
                break;
            ...
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                ...
                setCarInfo(6, 6, value40);
                break;
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                int value41 = DataCanbus.DATA[119];
                if (value41 == 1) {
                    value41 = 1;
                } else if (value41 == 0) {
                    value41 = 2;
                }
                setCarInfo(6, 7, value41);
                break;
            case R.id.ctv_checkedtext8 /* 2131427555 */:
                int value42 = DataCanbus.DATA[121];
                if (value42 == 1) {
                    value42 = 1;
                } else if (value42 == 0) {
                    value42 = 2;
                }
                setCarInfo(8, 1, value42);
                break;
            case R.id.ctv_checkedtext9 /* 2131427556 */:
                int value43 = DataCanbus.DATA[122];
                if (value43 == 1) {
                    value43 = 1;
                } else if (value43 == 0) {
                    value43 = 2;
                }
                setCarInfo(9, 1, value43);
                break;
            ...
            case R.id.ctv_checkedtext12 /* 2131427559 */:
                ...
                setCarInfo(11, 1, value46);
                break;
            case R.id.ctv_checkedtext13 /* 2131427560 */:
                int value47 = DataCanbus.DATA[130];
                if (value47 == 1) {
                    value47 = 1;
                } else if (value47 == 0) {
                    value47 = 2;
                }
                setCarInfo(12, 1, value47);
                break;
            ...
            case R.id.btn_minus18 /* 2131427896 */:
                ...
                setCarInfo(11, 3, value50);
                break;
            case R.id.btn_plus18 /* 2131427897 */:
                int value51 = DataCanbus.DATA[128] + 1;
                if (value51 > 3) {
                    value51 = 1;
                }
                setCarInfo(11, 3, value51);
                break;
            case R.id.btn_minus19 /* 2131427898 */:
                int value52 = DataCanbus.DATA[129] - 1;
                if (value52 < 1) {
                    value52 = 3;
                }
                setCarInfo(11, 6, value52);
                break;
            case R.id.btn_plus19 /* 2131427899 */:
                int value53 = DataCanbus.DATA[129] + 1;
                if (value53 > 3) {
                    value53 = 1;
                }
                setCarInfo(11, 6, value53);
                break;
        }
    }

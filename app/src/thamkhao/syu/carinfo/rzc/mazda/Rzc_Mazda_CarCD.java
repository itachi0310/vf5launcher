...
public class Rzc_Mazda_CarCD extends BaseActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.jeep_btn_play /* 2131427589 */:
                DataCanbus.PROXY.cmd(3, new int[]{128, 0, 0}, null, null);
                break;
            case R.id.jeep_btn_pause /* 2131427590 */:
                DataCanbus.PROXY.cmd(3, new int[]{129, 0, 0}, null, null);
                break;
            case R.id.jeep_btn_fr /* 2131427625 */:
                DataCanbus.PROXY.cmd(3, new int[]{132, 0, 0}, null, null);
                break;
            case R.id.jeep_btn_ff /* 2131427626 */:
                DataCanbus.PROXY.cmd(3, new int[]{131, 0, 0}, null, null);
                break;
            case R.id.jeep_btn_loop /* 2131427739 */:
                int rep_mode = DataCanbus.DATA[81];
                if (rep_mode == 1) {
                    DataCanbus.PROXY.cmd(3, new int[]{136, 0, 0}, null, null);
                } else {
                    DataCanbus.PROXY.cmd(3, new int[]{135, 0, 0}, null, null);
                }
                break;
            case R.id.jeep_btn_random /* 2131427742 */:
                int random_mode = DataCanbus.DATA[80];
                if (random_mode == 1) {
                    DataCanbus.PROXY.cmd(3, new int[]{134, 0, 0}, null, null);
                } else {
                    DataCanbus.PROXY.cmd(3, new int[]{133, 0, 0}, null, null);
                }
                break;
        }
    }
    ...
    public boolean onLongClick(View v) {
        switch (v.getId()) {
            case R.id.jeep_btn_fr /* 2131427625 */:
                DataCanbus.PROXY.cmd(3, new int[]{13, 0, 0}, null, null);
                break;
            case R.id.jeep_btn_ff /* 2131427626 */:
                DataCanbus.PROXY.cmd(3, new int[]{12, 0, 0}, null, null);
                break;
        }
        return true;
    }
    ...
    protected void onResume() {
        ...
        DataCanbus.PROXY.cmd(3, new int[]{14, 0, 0}, null, null);
    }

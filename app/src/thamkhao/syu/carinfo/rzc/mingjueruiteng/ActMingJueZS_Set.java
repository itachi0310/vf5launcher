        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.mingjue_steerfeel_m /* 2131432751 */:
                    int val2 = DataCanbus.DATA[110] & 15;
                    if (val2 == 0) {
                        val = 2;
                    } else {
                        val = val2 - 1;
                ...
                case R.id.mingjue_steerfeel_p /* 2131432753 */:
                    ActMingJueZS_Set.this.sendCmd(3, ((DataCanbus.DATA[110] & 15) + 1) % 3);
                    break;
                case R.id.mingjue_searchcar_indicator /* 2131432755 */:
                    ActMingJueZS_Set.this.sendCmd(2, (DataCanbus.DATA[111] & 15) != 1 ? 1 : 0);
                    break;
                case R.id.mingjue_comehomewithme /* 2131432758 */:
                    ActMingJueZS_Set.this.sendCmd(1, (DataCanbus.DATA[112] & 15) != 1 ? 1 : 0);
                    break;
            }
        }
    };

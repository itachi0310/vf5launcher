    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rzc_ruiteng_unlock_mode /* 2131429032 */:
                this.value = DataCanbus.DATA[115];
                setCarInfoCmd(1, 3, this.value == 0 ? 1 : 0);
                break;
            case R.id.rzc_ruiteng_unlock_nearcar /* 2131429034 */:
                this.value = DataCanbus.DATA[116];
                setCarInfoCmd(1, 4, this.value == 0 ? 1 : 0);
                break;
            case R.id.rzc_273_set_rear /* 2131429036 */:
                int[] iArr = new int[3];
                iArr[0] = 5;
                iArr[1] = 1;
                iArr[2] = DataCanbus.DATA[118] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr);
                break;
            case R.id.rzc_273_set_wind_auto_pre /* 2131429037 */:
                ...
                break;
            case R.id.rzc_273_set_wind_auto_next /* 2131429039 */:
                this.value = DataCanbus.DATA[119];
                if (this.value < 2) {
                    this.value++;
                } else {
                ...
                FunRuiTeng.C_CARINFO_SET(5, 2, this.value);
                break;
            case R.id.rzc_273_set_dual_pre /* 2131429040 */:
                ...
                break;
            case R.id.rzc_273_set_dual_next /* 2131429042 */:
                this.value = DataCanbus.DATA[120];
                if (this.value < 2) {
                    this.value++;
                } else {

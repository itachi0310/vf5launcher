    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rzc_ruiteng_speed_lock /* 2131429029 */:
                ...
                iArr[0] = 1;
                iArr[1] = 1;
                iArr[2] = DataCanbus.DATA[95] != 0 ? 0 : 1;
            ...
            case R.id.rzc_ruiteng_auto_unlock /* 2131429030 */:
                ...
                iArr2[0] = 1;
                iArr2[1] = 2;
                iArr2[2] = DataCanbus.DATA[96] != 0 ? 0 : 1;
            ...
            case R.id.rzc_ruiteng_unlock_mode /* 2131429032 */:
                ...
                iArr3[0] = 1;
                iArr3[1] = 3;
                iArr3[2] = DataCanbus.DATA[97] != 0 ? 0 : 1;
            ...
            case R.id.rzc_ruiteng_unlock_nearcar /* 2131429034 */:
                ...
                iArr4[0] = 1;
                iArr4[1] = 4;
                iArr4[2] = DataCanbus.DATA[98] != 0 ? 0 : 1;
            ...
            case R.id.rzc_ruiteng_home_light_backcar /* 2131429043 */:
                ...
                iArr5[1] = 1;
                iArr5[2] = 1;
                iArr5[3] = DataCanbus.DATA[99] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr5);
                break;
            case R.id.rzc_ruiteng_home_light_backlight /* 2131432773 */:
                int[] iArr6 = new int[4];
                iArr6[0] = 2;
                iArr6[1] = 1;
                iArr6[2] = 2;
                iArr6[3] = DataCanbus.DATA[100] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr6);
                break;
            case R.id.rzc_ruiteng_home_light_back_foglight /* 2131432774 */:
                int[] iArr7 = new int[4];
                iArr7[0] = 2;
                iArr7[1] = 1;
                iArr7[2] = 3;
                iArr7[3] = DataCanbus.DATA[101] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr7);
                break;
            case R.id.rzc_ruiteng_home_light_time_pre /* 2131432775 */:
                int value = DataCanbus.DATA[102] - 1;
                FunRuiTeng.C_CARINFO_SET(2, 2, value);
                break;
            case R.id.rzc_ruiteng_home_light_time_next /* 2131432777 */:
                int value2 = DataCanbus.DATA[102] + 1;
                FunRuiTeng.C_CARINFO_SET(2, 2, value2);
                break;
            case R.id.rzc_ruiteng_find_light_backcar /* 2131432778 */:
                int[] iArr8 = new int[4];
                iArr8[0] = 2;
                iArr8[1] = 3;
                iArr8[2] = 1;
                iArr8[3] = DataCanbus.DATA[103] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr8);
                break;
            case R.id.rzc_ruiteng_find_light_back_light /* 2131432779 */:
                int[] iArr9 = new int[4];
                iArr9[0] = 2;
                iArr9[1] = 3;
                iArr9[2] = 2;
                iArr9[3] = DataCanbus.DATA[104] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr9);
                break;
            case R.id.rzc_ruiteng_find_light_back_fog_light /* 2131432780 */:
                int[] iArr10 = new int[4];
                iArr10[0] = 2;
                iArr10[1] = 3;
                iArr10[2] = 3;
                iArr10[3] = DataCanbus.DATA[105] != 0 ? 0 : 1;
                FunRuiTeng.C_CARINFO_SET(iArr10);
                break;
            case R.id.rzc_ruiteng_find_light_time_pre /* 2131432781 */:
                int value3 = DataCanbus.DATA[106] - 1;
                FunRuiTeng.C_CARINFO_SET(2, 4, value3);
                break;
            case R.id.rzc_ruiteng_find_light_time_next /* 2131432783 */:

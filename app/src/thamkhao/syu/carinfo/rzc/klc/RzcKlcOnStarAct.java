...
public class RzcKlcOnStarAct extends BaseActivity {
    ...
    public void onExtraClik(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.rzc_onStarDelete /* 2131432721 */:
            ...
            case R.id.rzc_btn3 /* 2131432724 */:
                ...
                break;
            case R.id.rzc_btn11 /* 2131432725 */:
                if (this.buffer != null) {
                    if (this.OnStarState == 4) {
                        this.buffer.append('*');
                        this.showInputTv.setText(this.buffer.toString());
            ...
            case R.id.rzc_btn9 /* 2131432732 */:
                ...
                break;
            case R.id.rzc_btn10 /* 2131432733 */:
                if (this.buffer != null) {
                    if (this.OnStarState == 4) {
                        this.buffer.append('#');
                        this.showInputTv.setText(this.buffer.toString());
                ...
                break;
            case R.id.rzc_callanswer /* 2131432734 */:
                ...
                break;
            case R.id.rzc_callhang /* 2131432735 */:
    ...
    public void updaterOnStarState() {
        this.OnStarState = DataCanbus.DATA[115];

...
public class Rzc_Oudi_0439_AirRearCtrl_HP extends Activity implements View.OnTouchListener {
    ...
    int cmdId = -1;
    int touchState = -1;
    Runnable airControl = new Runnable() { // from class: com.syu.carinfo.rzc.havalh6.Rzc_Oudi_0439_AirRearCtrl_HP.1
        @Override // java.lang.Runnable
        public void run() {
            Rzc_Oudi_0439_AirRearCtrl_HP.this.setAirControl(Rzc_Oudi_0439_AirRearCtrl_HP.this.cmdId, 0);
        }
    };
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.havalh6.Rzc_Oudi_0439_AirRearCtrl_HP.2
    ...
    private void init() {
        ((Button) findViewById(R.id.air_xts_frontpage)).setOnClickListener(new View.OnClickListener() { // from class: com.syu.carinfo.rzc.havalh6.Rzc_Oudi_0439_AirRearCtrl_HP.3

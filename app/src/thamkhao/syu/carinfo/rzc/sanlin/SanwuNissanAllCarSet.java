...
public class SanwuNissanAllCarSet extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.sanlin.SanwuNissanAllCarSet.1
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCarInfo(4, DataCanbus.DATA[104] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                setCarInfo(3, DataCanbus.DATA[105] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                setCarInfo(2, DataCanbus.DATA[106] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                setCarInfo(1, DataCanbus.DATA[107] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                setCarInfo(12, DataCanbus.DATA[114] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                setCarInfo(14, DataCanbus.DATA[116] != 1 ? 1 : 0);
                break;
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(2, new int[]{116, 0}, null, null);
        addNotify();
    }

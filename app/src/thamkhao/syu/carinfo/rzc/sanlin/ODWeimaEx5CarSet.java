...
public class ODWeimaEx5CarSet extends BaseActivity {
    private SeekBar.OnSeekBarChangeListener mseekbarClick = new SeekBar.OnSeekBarChangeListener() { // from class: com.syu.carinfo.rzc.sanlin.ODWeimaEx5CarSet.1
        @Override // android.widget.SeekBar.OnSeekBarChangeListener
        public void onStopTrackingTouch(SeekBar v) {
            switch (v.getId()) {
                case R.id.seekbar_checkedtext1 /* 2131428656 */:
    ...
    private View.OnClickListener mClick = new View.OnClickListener() { // from class: com.syu.carinfo.rzc.sanlin.ODWeimaEx5CarSet.2
    ...
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.sanlin.ODWeimaEx5CarSet.3
                    ...
                    if (((TextView) ODWeimaEx5CarSet.this.findViewById(R.id.tv_text3)) != null) {
                        switch (value) {
                            case 0:
                                ...
                                break;
                            case 1:
                                ((TextView) ODWeimaEx5CarSet.this.findViewById(R.id.tv_text3)).setText("PSI");
                                break;
                            case 2:

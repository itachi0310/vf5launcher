    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int bit7 = DataCanbus.DATA[17] - 1;
                if (bit7 < 0) {
                    bit7 = 1;
                }
                int value = (bit7 << 7) & 128;
                setCarInfo(18, value);
                break;
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                ...
                int value4 = (bit542 << 4) & 48;
                setCarInfo(20, value4);
                break;
            case R.id.btn_minus3 /* 2131427461 */:
                int bit73 = DataCanbus.DATA[22] - 1;
                if (bit73 < 0) {
                    bit73 = 1;
                }
                int value5 = (bit73 << 7) & 128;
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int bit75 = DataCanbus.DATA[27] - 1;
                if (bit75 < 0) {
                    bit75 = 1;
                }
                int value9 = (bit75 << 7) & 128;
                setCarInfo(49, value9);
                break;
            ...
            case R.id.btn_minus6 /* 2131427470 */:
                int bit6 = DataCanbus.DATA[28] - 1;
                if (bit6 < 0) {
                    bit6 = 1;
                }
                int value11 = (bit6 << 6) & 192;
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                ...
                setCarInfo1(66, (value13 >> 8) & 255, value13 & 255);
                break;
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                ...
                int value15 = (bit742 << 4) & 240;
                setCarInfo(24, value15);
                break;
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                ...
                int value17 = (bit32 << 2) & 12;
                setCarInfo(25, value17);
                break;
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                ...
                int value20 = (bit12 << 1) & 2;
                setCarInfo(26, value20);
                break;
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int bit77 = DataCanbus.DATA[12];
                int bit63 = DataCanbus.DATA[13];
                ...
                int value21 = ((bit77 << 7) & 128) | ((bit63 << 6) & 64) | ((bit5 << 5) & 32) | ((bit4 << 4) & 16) | ((bit3 << 3) & 8);

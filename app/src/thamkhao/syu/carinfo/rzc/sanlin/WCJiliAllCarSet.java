...
public class WCJiliAllCarSet extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.sanlin.WCJiliAllCarSet.1
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int value17 = DataCanbus.DATA[128] - 1;
                if (value17 < 0) {
                    value17 = 2;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value18 = DataCanbus.DATA[128] + 1;
                if (value18 > 2) {
                    value18 = 0;
                }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int value19 = DataCanbus.DATA[131] - 1;
                if (value19 < 0) {
                    value19 = 2;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int value20 = DataCanbus.DATA[131] + 1;
                if (value20 > 2) {
                    value20 = 0;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int value23 = DataCanbus.DATA[140] - 1;
                if (value23 < 0) {
                    value23 = 1;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value24 = DataCanbus.DATA[140] + 1;
                if (value24 > 1) {
                    value24 = 0;
                }
            ...
            case R.id.btn_minus13 /* 2131427491 */:
                int value25 = DataCanbus.DATA[142] - 1;
                if (value25 < 0) {
                    value25 = 2;
                }
            ...
            case R.id.btn_plus13 /* 2131427493 */:
                int value26 = DataCanbus.DATA[142] + 1;
                if (value26 > 2) {
                    value26 = 0;
                }
            ...
            case R.id.btn_minus14 /* 2131427494 */:
                int value27 = DataCanbus.DATA[144] - 1;
                if (value27 < 0) {
                    value27 = 3;
                }
            ...
            case R.id.btn_plus14 /* 2131427496 */:
                int value28 = DataCanbus.DATA[144] + 1;
                if (value28 > 3) {
                    value28 = 0;
                }
            ...
            case R.id.btn_minus15 /* 2131427520 */:
                int value29 = DataCanbus.DATA[145] - 1;
                if (value29 < 0) {
                    value29 = 2;
                }
            ...
            case R.id.btn_plus15 /* 2131427522 */:
                int value30 = DataCanbus.DATA[145] + 1;
                if (value30 > 2) {
                    value30 = 0;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                setCarInfo(7, DataCanbus.DATA[98] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCarInfo(8, DataCanbus.DATA[99] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                setCarInfo(9, DataCanbus.DATA[100] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                setCarInfo(11, DataCanbus.DATA[102] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                setCarInfo(3, DataCanbus.DATA[105] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                setCarInfo(4, DataCanbus.DATA[106] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                setCarInfo(5, DataCanbus.DATA[107] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext8 /* 2131427555 */:
                setCarInfo(6, DataCanbus.DATA[108] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext9 /* 2131427556 */:
                setCarInfo(13, DataCanbus.DATA[109] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext10 /* 2131427557 */:
                setCarInfo(14, DataCanbus.DATA[110] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                setCarInfo(15, DataCanbus.DATA[111] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext12 /* 2131427559 */:
                setCarInfo(33, DataCanbus.DATA[112] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext13 /* 2131427560 */:
                setCarInfo(34, DataCanbus.DATA[113] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext14 /* 2131427561 */:
                setCarInfo(36, DataCanbus.DATA[115] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext15 /* 2131427562 */:
                setCarInfo(37, DataCanbus.DATA[116] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext16 /* 2131427563 */:
                setCarInfo(38, DataCanbus.DATA[117] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext17 /* 2131427564 */:
                setCarInfo(39, DataCanbus.DATA[118] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext18 /* 2131427663 */:
                setCarInfo(40, DataCanbus.DATA[119] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext19 /* 2131427665 */:
                setCarInfo(42, DataCanbus.DATA[121] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext20 /* 2131427667 */:
                setCarInfo(43, DataCanbus.DATA[122] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext21 /* 2131427669 */:
                setCarInfo(46, DataCanbus.DATA[125] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext22 /* 2131427671 */:
                setCarInfo(47, DataCanbus.DATA[126] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext23 /* 2131427674 */:
                setCarInfo(48, DataCanbus.DATA[127] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext24 /* 2131427850 */:
                setCarInfo(50, DataCanbus.DATA[129] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext25 /* 2131427852 */:
                setCarInfo(51, DataCanbus.DATA[130] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext26 /* 2131427854 */:
                setCarInfo(54, DataCanbus.DATA[132] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext27 /* 2131427856 */:
                setCarInfo(55, DataCanbus.DATA[133] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext32 /* 2131427894 */:
                setCarInfo(63, DataCanbus.DATA[141] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext29 /* 2131427895 */:
                setCarInfo(57, DataCanbus.DATA[135] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext30 /* 2131427904 */:
                setCarInfo(60, DataCanbus.DATA[138] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext31 /* 2131427905 */:
                setCarInfo(61, DataCanbus.DATA[139] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext28 /* 2131427906 */:
                setCarInfo(56, DataCanbus.DATA[134] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext33 /* 2131428119 */:
                setCarInfo(65, DataCanbus.DATA[143] != 1 ? 1 : 0, 255, 255);
                break;
            case R.id.ctv_checkedtext34 /* 2131428382 */:
                setCarAirInfo(22, DataCanbus.DATA[146] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext35 /* 2131428384 */:
                setCarAirInfo(23, DataCanbus.DATA[147] != 1 ? 1 : 0);
                break;
            case R.id.ctv_checkedtext36 /* 2131428386 */:
                setCarAirInfo(24, DataCanbus.DATA[148] != 1 ? 1 : 0);
                break;
        }
    }

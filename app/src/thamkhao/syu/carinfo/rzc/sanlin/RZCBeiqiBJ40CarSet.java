    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int value18 = DataCanbus.DATA[107] - 1;
                if (value18 < 0) {
                    value18 = 1;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int value20 = DataCanbus.DATA[108] - 1;
                if (value20 < 0) {
                    value20 = 3;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int value111 = DataCanbus.DATA[112];
                int value23 = DataCanbus.DATA[113];
                int value33 = DataCanbus.DATA[114];
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int value113 = DataCanbus.DATA[112];
                int value24 = DataCanbus.DATA[113];
                int value34 = DataCanbus.DATA[114];
                if (value113 == 1) {
                    value24--;
                    if (value24 < 1) {
                        value24 = 5;
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int value114 = DataCanbus.DATA[112];
                int value25 = DataCanbus.DATA[113];
                int value35 = DataCanbus.DATA[114];
                if (value114 == 1) {
                    value25++;
                    if (value25 > 5) {
                        value25 = 1;
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int value115 = DataCanbus.DATA[112];
                int value26 = DataCanbus.DATA[113];
                int value36 = DataCanbus.DATA[114] - 1;
                if (value36 < 0) {
                    value36 = 255;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int value116 = DataCanbus.DATA[112];
                int value27 = DataCanbus.DATA[113];
                int value37 = DataCanbus.DATA[114] - 1;
                if (value37 > 255) {
                    value37 = 0;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int value28 = DataCanbus.DATA[115] - 1;
                if (value28 < 1) {
                    value28 = 7;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int value29 = DataCanbus.DATA[115] + 1;
                if (value29 > 7) {
                    value29 = 1;
                }

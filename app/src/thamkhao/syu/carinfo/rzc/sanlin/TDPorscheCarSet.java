...
public class TDPorscheCarSet extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.sanlin.TDPorscheCarSet.1
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int fad = DataCanbus.DATA[113];
                int bal = DataCanbus.DATA[114];
                int bass = DataCanbus.DATA[115];
                int mid = DataCanbus.DATA[116];
                int treb = DataCanbus.DATA[117];
                int vol = DataCanbus.DATA[118];
                int D4B02 = DataCanbus.DATA[119];
                int D4B12 = DataCanbus.DATA[120];
                int D4B22 = DataCanbus.DATA[121];
                int D4B32 = DataCanbus.DATA[122];
                if (fad > 0) {
                    fad--;
                }
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int fad2 = DataCanbus.DATA[113];
                int bal2 = DataCanbus.DATA[114];
                int bass2 = DataCanbus.DATA[115];
                int mid2 = DataCanbus.DATA[116];
                int treb2 = DataCanbus.DATA[117];
                int vol2 = DataCanbus.DATA[118];
                int D4B03 = DataCanbus.DATA[119];
                int D4B13 = DataCanbus.DATA[120];
                int D4B23 = DataCanbus.DATA[121];
                int D4B33 = DataCanbus.DATA[122];
                if (fad2 < 12) {
                    fad2++;
                }
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                int fad3 = DataCanbus.DATA[113];
                int bal3 = DataCanbus.DATA[114];
                int bass3 = DataCanbus.DATA[115];
                int mid3 = DataCanbus.DATA[116];
                int treb3 = DataCanbus.DATA[117];
                int vol3 = DataCanbus.DATA[118];
                int D4B04 = DataCanbus.DATA[119];
                int D4B14 = DataCanbus.DATA[120];
                int D4B24 = DataCanbus.DATA[121];
                int D4B34 = DataCanbus.DATA[122];
                if (bal3 > 0) {
                    bal3--;
                }
            ...
            case R.id.btn_plus8 /* 2131427478 */:
                int fad4 = DataCanbus.DATA[113];
                int bal4 = DataCanbus.DATA[114];
                int bass4 = DataCanbus.DATA[115];
                int mid4 = DataCanbus.DATA[116];
                int treb4 = DataCanbus.DATA[117];
                int vol4 = DataCanbus.DATA[118];
                int D4B05 = DataCanbus.DATA[119];
                int D4B15 = DataCanbus.DATA[120];
                int D4B25 = DataCanbus.DATA[121];
                int D4B35 = DataCanbus.DATA[122];
                if (bal4 < 12) {
                    bal4++;
                }
            ...
            case R.id.btn_minus9 /* 2131427479 */:
                int fad5 = DataCanbus.DATA[113];
                int bal5 = DataCanbus.DATA[114];
                int bass5 = DataCanbus.DATA[115];
                int mid5 = DataCanbus.DATA[116];
                int treb5 = DataCanbus.DATA[117];
                int vol5 = DataCanbus.DATA[118];
                int D4B06 = DataCanbus.DATA[119];
                int D4B16 = DataCanbus.DATA[120];
                int D4B26 = DataCanbus.DATA[121];
                int D4B36 = DataCanbus.DATA[122];
                if (bass5 > 0) {
                    bass5--;
                }
            ...
            case R.id.btn_plus9 /* 2131427481 */:
                int fad6 = DataCanbus.DATA[113];
                int bal6 = DataCanbus.DATA[114];
                int bass6 = DataCanbus.DATA[115];
                int mid6 = DataCanbus.DATA[116];
                int treb6 = DataCanbus.DATA[117];
                int vol6 = DataCanbus.DATA[118];
                int D4B07 = DataCanbus.DATA[119];
                int D4B17 = DataCanbus.DATA[120];
                int D4B27 = DataCanbus.DATA[121];
                int D4B37 = DataCanbus.DATA[122];
                if (bass6 < 12) {
                    bass6++;
                }
            ...
            case R.id.btn_minus10 /* 2131427482 */:
                int fad7 = DataCanbus.DATA[113];
                int bal7 = DataCanbus.DATA[114];
                int bass7 = DataCanbus.DATA[115];
                int mid7 = DataCanbus.DATA[116];
                int treb7 = DataCanbus.DATA[117];
                int vol7 = DataCanbus.DATA[118];
                int D4B08 = DataCanbus.DATA[119];
                int D4B18 = DataCanbus.DATA[120];
                int D4B28 = DataCanbus.DATA[121];
                int D4B38 = DataCanbus.DATA[122];
                if (mid7 > 0) {
                    mid7--;
                }
            ...
            case R.id.btn_plus10 /* 2131427484 */:
                int fad8 = DataCanbus.DATA[113];
                int bal8 = DataCanbus.DATA[114];
                int bass8 = DataCanbus.DATA[115];
                int mid8 = DataCanbus.DATA[116];
                int treb8 = DataCanbus.DATA[117];
                int vol8 = DataCanbus.DATA[118];
                int D4B09 = DataCanbus.DATA[119];
                int D4B19 = DataCanbus.DATA[120];
                int D4B29 = DataCanbus.DATA[121];
                int D4B39 = DataCanbus.DATA[122];
                if (mid8 < 12) {
                    mid8++;
                }
            ...
            case R.id.btn_minus11 /* 2131427485 */:
                int fad9 = DataCanbus.DATA[113];
                int bal9 = DataCanbus.DATA[114];
                int bass9 = DataCanbus.DATA[115];
                int mid9 = DataCanbus.DATA[116];
                int treb9 = DataCanbus.DATA[117];
                int vol9 = DataCanbus.DATA[118];
                int D4B010 = DataCanbus.DATA[119];
                int D4B110 = DataCanbus.DATA[120];
                int D4B210 = DataCanbus.DATA[121];
                int D4B310 = DataCanbus.DATA[122];
                if (treb9 > 0) {
                    treb9--;
                }
            ...
            case R.id.btn_plus11 /* 2131427487 */:
                int fad10 = DataCanbus.DATA[113];
                int bal10 = DataCanbus.DATA[114];
                int bass10 = DataCanbus.DATA[115];
                int mid10 = DataCanbus.DATA[116];
                int treb10 = DataCanbus.DATA[117];
                int vol10 = DataCanbus.DATA[118];
                int D4B011 = DataCanbus.DATA[119];
                int D4B111 = DataCanbus.DATA[120];
                int D4B211 = DataCanbus.DATA[121];
                int D4B311 = DataCanbus.DATA[122];
                if (treb10 < 12) {
                    treb10++;
                }
            ...
            case R.id.btn_minus12 /* 2131427488 */:
                int fad11 = DataCanbus.DATA[113];
                int bal11 = DataCanbus.DATA[114];
                int bass11 = DataCanbus.DATA[115];
                int mid11 = DataCanbus.DATA[116];
                int treb11 = DataCanbus.DATA[117];
                int vol11 = DataCanbus.DATA[118];
                int D4B012 = DataCanbus.DATA[119];
                int D4B112 = DataCanbus.DATA[120];
                int D4B212 = DataCanbus.DATA[121];
                int D4B312 = DataCanbus.DATA[122];
                if (vol11 > 0) {
                    vol11--;
                }
            ...
            case R.id.btn_plus12 /* 2131427490 */:
                int fad12 = DataCanbus.DATA[113];
                int bal12 = DataCanbus.DATA[114];
                int bass12 = DataCanbus.DATA[115];
                int mid12 = DataCanbus.DATA[116];
                int treb12 = DataCanbus.DATA[117];
                int vol12 = DataCanbus.DATA[118];
                int D4B013 = DataCanbus.DATA[119];
                int D4B113 = DataCanbus.DATA[120];
                int D4B213 = DataCanbus.DATA[121];
                int D4B313 = DataCanbus.DATA[122];
                if (vol12 < 32) {
                    vol12++;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                setCarInfo(2, DataCanbus.DATA[96] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext2 /* 2131427546 */:
                setCarInfo(3, DataCanbus.DATA[97] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext3 /* 2131427547 */:
                setCarInfo(4, DataCanbus.DATA[98] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext4 /* 2131427549 */:
                setCarInfo(5, DataCanbus.DATA[99] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext5 /* 2131427552 */:
                setCarInfo(7, DataCanbus.DATA[103] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext6 /* 2131427553 */:
                setCarInfo(8, DataCanbus.DATA[104] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext7 /* 2131427554 */:
                setCarInfo(13, DataCanbus.DATA[106] == 1 ? 0 : 1);
                break;
            case R.id.ctv_checkedtext8 /* 2131427555 */:
                int fad13 = DataCanbus.DATA[113];
                int bal13 = DataCanbus.DATA[114];
                int bass13 = DataCanbus.DATA[115];
                int mid13 = DataCanbus.DATA[116];
                int treb13 = DataCanbus.DATA[117];
                int vol13 = DataCanbus.DATA[118];
                int D4B014 = DataCanbus.DATA[119];
                int D4B114 = DataCanbus.DATA[120];
                int D4B214 = DataCanbus.DATA[121];
                int D4B314 = DataCanbus.DATA[122];
                if (D4B014 == 1) {
                    D4B0 = 0;
                } else {
                    D4B0 = 1;
            ...
            case R.id.ctv_checkedtext9 /* 2131427556 */:
                int fad14 = DataCanbus.DATA[113];
                int bal14 = DataCanbus.DATA[114];
                int bass14 = DataCanbus.DATA[115];
                int mid14 = DataCanbus.DATA[116];
                int treb14 = DataCanbus.DATA[117];
                int vol14 = DataCanbus.DATA[118];
                int D4B015 = DataCanbus.DATA[119];
                int D4B115 = DataCanbus.DATA[120];
                int D4B215 = DataCanbus.DATA[121];
                int D4B315 = DataCanbus.DATA[122];
                if (D4B115 == 1) {
                    D4B1 = 0;
                } else {
                    D4B1 = 1;
            ...
            case R.id.ctv_checkedtext10 /* 2131427557 */:
                int fad15 = DataCanbus.DATA[113];
                int bal15 = DataCanbus.DATA[114];
                int bass15 = DataCanbus.DATA[115];
                int mid15 = DataCanbus.DATA[116];
                int treb15 = DataCanbus.DATA[117];
                int vol15 = DataCanbus.DATA[118];
                int D4B016 = DataCanbus.DATA[119];
                int D4B116 = DataCanbus.DATA[120];
                int D4B216 = DataCanbus.DATA[121];
                int D4B316 = DataCanbus.DATA[122];
                if (D4B216 == 1) {
                    D4B2 = 0;
                } else {
                    D4B2 = 1;
            ...
            case R.id.ctv_checkedtext11 /* 2131427558 */:
                int fad16 = DataCanbus.DATA[113];
                int bal16 = DataCanbus.DATA[114];
                int bass16 = DataCanbus.DATA[115];
                int mid16 = DataCanbus.DATA[116];
                int treb16 = DataCanbus.DATA[117];
                int vol16 = DataCanbus.DATA[118];
                int D4B017 = DataCanbus.DATA[119];
                int D4B117 = DataCanbus.DATA[120];
                int D4B217 = DataCanbus.DATA[121];
                int D4B317 = DataCanbus.DATA[122];
                if (D4B317 == 1) {
                    D4B3 = 0;
                } else {
                    D4B3 = 1;
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(0, new int[]{65, 0}, null, null);

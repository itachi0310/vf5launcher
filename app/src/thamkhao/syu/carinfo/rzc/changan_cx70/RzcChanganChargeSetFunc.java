...
public class RzcChanganChargeSetFunc extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_minus1 /* 2131427455 */:
                int value3 = DataCanbus.DATA[191];
            ...
            case R.id.btn_plus1 /* 2131427457 */:
                int value4 = DataCanbus.DATA[191];
                int value12 = DataCanbus.DATA[192];
            ...
            case R.id.btn_minus2 /* 2131427458 */:
                int value5 = DataCanbus.DATA[191];
            ...
            case R.id.btn_plus2 /* 2131427460 */:
                int value6 = DataCanbus.DATA[191];
                int value14 = DataCanbus.DATA[192];
            ...
            case R.id.btn_minus3 /* 2131427461 */:
                int value7 = DataCanbus.DATA[191];
                int value15 = DataCanbus.DATA[192];
            ...
            case R.id.btn_plus3 /* 2131427463 */:
                int value8 = DataCanbus.DATA[191];
                int value16 = DataCanbus.DATA[192];
            ...
            case R.id.btn_minus4 /* 2131427464 */:
                ...
                int value17 = DataCanbus.DATA[192];
            ...
            case R.id.btn_plus4 /* 2131427466 */:
                ...
                int value18 = DataCanbus.DATA[192];
            ...
            case R.id.btn_minus5 /* 2131427467 */:
                int value11 = DataCanbus.DATA[194] - 1;
                if (value11 < 0) {
                    value11 = 1;
                }
            ...
            case R.id.btn_plus5 /* 2131427469 */:
                int value19 = DataCanbus.DATA[194] + 1;
                if (value19 > 1) {
                    value19 = 0;
                }
            ...
            case R.id.btn_minus6 /* 2131427470 */:
                int value20 = DataCanbus.DATA[195] - 1;
                if (value20 < 60) {
                    value20 = 60;
                }
            ...
            case R.id.btn_plus6 /* 2131427472 */:
                int value21 = DataCanbus.DATA[195] + 1;
                if (value21 < 100) {
                    value21 = 100;
                }
            ...
            case R.id.btn_minus7 /* 2131427473 */:
                int value22 = DataCanbus.DATA[196];
                if (value22 == 8) {
                    value2 = 32;
                } else if (value22 == 10) {
                    value2 = 8;
            ...
            case R.id.btn_plus7 /* 2131427475 */:
                int value23 = DataCanbus.DATA[196];
                if (value23 == 8) {
                    value = 10;
                } else if (value23 == 10) {
                    value = 16;
                } else if (value23 != 16 && value23 == 32) {
                    value = 8;
                } else {
                    value = 32;
                }
            ...
            case R.id.ctv_checkedtext1 /* 2131427530 */:
                int value24 = DataCanbus.DATA[194];
                if (value24 == 1) {
                    value24 = 8;
                } else if (value24 == 8) {
                    value24 = 1;
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(5, new int[]{83, 0}, null, null);
        addNotify();
    }

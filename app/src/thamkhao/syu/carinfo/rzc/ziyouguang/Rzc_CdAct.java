...
public class Rzc_CdAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bagoo_ziyouguang_cd_prev /* 2131429432 */:
                CD_CONRTROL_CMD(2, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_fb /* 2131429433 */:
                CD_CONRTROL_CMD(3, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_repeat /* 2131429434 */:
                CD_CONRTROL_CMD(8, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_repeat_random /* 2131429435 */:
                CD_CONRTROL_CMD(17, 0);
                break;
            case R.id.bagoo_ziyouguang_play /* 2131429436 */:
                CD_CONRTROL_CMD(19, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_pause /* 2131429437 */:
                CD_CONRTROL_CMD(20, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_ff /* 2131429438 */:
                CD_CONRTROL_CMD(4, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_next /* 2131429439 */:
                CD_CONRTROL_CMD(1, 0);
                break;
            case R.id.bagoo_ziyouguang_cd_list_btn /* 2131429440 */:
                for (int i = 0; i < this.totalTrackValue; i++) {

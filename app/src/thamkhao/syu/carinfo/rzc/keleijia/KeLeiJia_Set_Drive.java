...
public class KeLeiJia_Set_Drive extends BaseActivity {
    private int[] eventsIDs = {34, 35, 36, 37, 38, 39, 40, 85, 86, 87, 88, 89, 11, 78, 92, 95, 96, 138, 139};
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_minus1 /* 2131427455 */:
                    int value = (DataCanbus.DATA[92] & 255) - 1;
                    if (value < 1) {
                        value = 5;
                    }
                ...
                case R.id.btn_minus2 /* 2131427458 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value3 = (DataCanbus.DATA[87] & 255) - 1;
                        if (value3 < 1) {
                            value3 = 3;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{28, value3}, null, null);
                    } else {
                        int value4 = (DataCanbus.DATA[35] & 255) - 1;
                        if (value4 < 0) {
                ...
                case R.id.btn_plus2 /* 2131427460 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value5 = (DataCanbus.DATA[87] & 255) + 1;
                        if (value5 > 3) {
                            value5 = 1;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{28, value5}, null, null);
                    } else {
                        int value6 = (DataCanbus.DATA[35] & 255) + 1;
                ...
                case R.id.btn_minus3 /* 2131427461 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value7 = (DataCanbus.DATA[86] & 255) - 1;
                        if (value7 < 1) {
                            value7 = 5;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{27, value7}, null, null);
                    } else {
                        int value8 = (DataCanbus.DATA[36] & 255) - 1;
                        if (value8 < 0) {
                            value8 = 0;
                        }
                ...
                case R.id.btn_plus3 /* 2131427463 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value9 = (DataCanbus.DATA[86] & 255) + 1;
                        if (value9 > 5) {
                            value9 = 1;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{27, value9}, null, null);
                    } else {
                        int value10 = (DataCanbus.DATA[36] & 255) + 1;
                        if (value10 > 4) {
                            value10 = 4;
                        }
                ...
                case R.id.btn_minus4 /* 2131427464 */:
                    int value11 = (DataCanbus.DATA[139] & 255) - 1;
                    if (value11 < 1) {
                        value11 = 3;
                    }
                ...
                case R.id.btn_plus4 /* 2131427466 */:
                    int value12 = (DataCanbus.DATA[139] & 255) + 1;
                    if (value12 > 3) {
                        value12 = 1;
                    }
                ...
                case R.id.ctv_checkedtext2 /* 2131427546 */:
                    int value14 = DataCanbus.DATA[96];
                ...
                case R.id.ctv_checkedtext3 /* 2131427547 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value15 = DataCanbus.DATA[85] & 255;
                        ...
                        int value16 = DataCanbus.DATA[34] & 255;
                ...
                case R.id.ctv_checkedtext4 /* 2131427549 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value17 = DataCanbus.DATA[78] & 255;
                        ...
                        int value18 = DataCanbus.DATA[37] & 255;
                ...
                case R.id.ctv_checkedtext5 /* 2131427552 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value19 = DataCanbus.DATA[11] & 255;
                        ...
                        int value20 = DataCanbus.DATA[38] & 255;
                ...
                case R.id.ctv_checkedtext6 /* 2131427553 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value21 = DataCanbus.DATA[88] & 255;
                        ...
                        int value22 = DataCanbus.DATA[39] & 255;
                ...
                case R.id.ctv_checkedtext7 /* 2131427554 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value23 = DataCanbus.DATA[89] & 255;
                        ...
                        int value24 = DataCanbus.DATA[40] & 255;
                ...
                case R.id.ctv_checkedtext8 /* 2131427555 */:
                    int value25 = DataCanbus.DATA[138] & 255;

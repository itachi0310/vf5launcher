            ...
            switch (v.getId()) {
                case R.id.btn_minus1 /* 2131427455 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value = (DataCanbus.DATA[83] & 255) - 1;
                        if (value < 0) {
                            value = 7;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{24, value}, null, null);
                    } else {
                        int value2 = (DataCanbus.DATA[32] & 255) - 1;
                        if (value2 < 0) {
                ...
                case R.id.btn_plus1 /* 2131427457 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value3 = (DataCanbus.DATA[83] & 255) + 1;
                        if (value3 > 7) {
                            value3 = 0;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{24, value3}, null, null);
                    } else {
                        int value4 = (DataCanbus.DATA[32] & 255) + 1;
                ...
                case R.id.btn_minus2 /* 2131427458 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value5 = (DataCanbus.DATA[84] & 255) - 5;
                        if (value5 < 0) {
                            value5 = 0;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{25, value5}, null, null);
                    } else {
                        int value6 = (DataCanbus.DATA[33] & 255) - 5;
                        if (value6 < 0) {
                            value6 = 0;
                        }
                ...
                case R.id.btn_plus2 /* 2131427460 */:
                    if (((DataCanbus.DATA[1000] >> 16) & 65535) == 0 || ((DataCanbus.DATA[1000] >> 16) & 65535) >= 10) {
                        int value7 = (DataCanbus.DATA[84] & 255) + 5;
                        if (value7 > 100) {
                            value7 = 100;
                        }
                        DataCanbus.PROXY.cmd(1, new int[]{25, value7}, null, null);
                    } else {
                        int value8 = (DataCanbus.DATA[33] & 255) + 5;
                        if (value8 > 100) {
                            value8 = 100;
                        }
                ...
                case R.id.ctv_checkedtext1 /* 2131427530 */:
                    int value9 = DataCanbus.DATA[93] & 255;

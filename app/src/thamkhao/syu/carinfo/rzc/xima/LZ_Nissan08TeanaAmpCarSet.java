...
public class LZ_Nissan08TeanaAmpCarSet extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_minus8 /* 2131427476 */:
                ...
                DataCanbus.PROXY.cmd(1, new int[]{24, value, 0}, null, null);
                break;
            case R.id.btn_plus8 /* 2131427478 */:
                int value2 = DataCanbus.DATA[160] + 1;
                if (value2 > 3) {
                    value2 = 0;
                }
                DataCanbus.PROXY.cmd(1, new int[]{24, value2, 0}, null, null);
                break;
    ...
    protected void onResume() {
        super.onResume();
        DataCanbus.PROXY.cmd(3, new int[]{59, 0}, null, null);
        addNotify();
    }

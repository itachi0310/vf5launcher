...
public class DS5IndexAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.dongjian_wc2_ds5_car_set_check /* 2131429246 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_car_set_page1_check /* 2131429247 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_car_set_page2_check /* 2131429248 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_car_set_page3_check /* 2131429249 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_car_system_set_check /* 2131429250 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_unit_set_index_check /* 2131429251 */:
                try {
                ...
                break;
            case R.id.dongjian_wc2_ds5_time_set_index_check /* 2131429252 */:
                try {

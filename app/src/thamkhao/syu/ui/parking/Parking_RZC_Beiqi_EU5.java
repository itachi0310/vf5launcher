...
public class Parking_RZC_Beiqi_EU5 extends ParkingBase {
    ...
    public Parking_RZC_Beiqi_EU5(Context context) {
        super(context);
        this.b_msg = false;
        this.b_cancle = false;
        this.b_star = false;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (this.data0 != 0) {
            ...
            HandlerUI.getInstance().postDelayed(new Runnable() { // from class: com.syu.ui.parking.Parking_RZC_Beiqi_EU5.1
                @Override // java.lang.Runnable
                public void run() {
                    DataCanbus.PROXY.cmd(0, new int[]{Parking_RZC_Beiqi_EU5.this.data0, 0}, null, null);
                }
            }, 200L);
        }
        return false;

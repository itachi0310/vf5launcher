...
public class Door_Default_beifen extends DoorBase {
    private Rect back;
    private Rect engine;
    private Rect fl;
    private Rect fr;
    ...
    public Door_Default_beifen(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (SystemProperties.getInt("ro.build.fytmanufacturer", 0) == 95 && DataCanbus.DATA[1000] == 393666) {
            ...
            this.fl = new Rect(770, 233, 885, Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_DE0_D2_B6);
            this.fr = new Rect(1031, 233, 1145, Callback_0374_XP1_ZiYouGuang.U_CARSET_D40_DE0_D2_B6);
            ...
            this.back = new Rect(64, 446, 250, Callback_0374_XP1_ZiYouGuang.U_CARRADIO_D12_D4_B70);
        } else if (DataCanbus.DATA[1000] == 459199 || DataCanbus.DATA[1000] == 524735) {

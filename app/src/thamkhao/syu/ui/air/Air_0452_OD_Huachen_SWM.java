...
public class Air_0452_OD_Huachen_SWM extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[11] != 0) {
            this.srPath.addRect(224.0f, 113.0f, 288.0f, 1486.0f, Path.Direction.CW);
        }
        if (this.DATA[53] != 0) {
            this.srPath.addRect(224.0f, 113.0f, 288.0f, 1486.0f, Path.Direction.CW);
        }
        ...
        switch (temp) {
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(new StringBuilder().append(((temp * 5) + 160) / 10.0f).toString(), 70.0f, 132.0f, this.mPaint);
                break;
        }
        ...
        switch (temp2) {
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(new StringBuilder().append(((temp2 * 5) + 160) / 10.0f).toString(), 920.0f, 132.0f, this.mPaint);
                break;
        }
        canvas.save();

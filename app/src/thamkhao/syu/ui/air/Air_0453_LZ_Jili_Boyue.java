...
public class Air_0453_LZ_Jili_Boyue extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value2 != 0) {
            this.srPath.addRect(60.0f, 126.0f, 111.0f, 155.0f, Path.Direction.CW);
        }
        int value3 = this.DATA[30];
        if (value3 != 0) {
            this.srPath.addRect(903.0f, 128.0f, 954.0f, 156.0f, Path.Direction.CW);
        }
        ...
        this.srPath.addRect(311.0f, 47.0f, 311.0f + (value4 * 17.0f), 71.0f, Path.Direction.CW);

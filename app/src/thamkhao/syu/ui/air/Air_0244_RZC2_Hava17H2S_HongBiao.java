...
public class Air_0244_RZC2_Hava17H2S_HongBiao extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (temp >= 116 && temp <= 144) {
            c.drawText(new StringBuilder(String.valueOf(((temp - 116) / 2.0f) + 18.0f)).toString(), 60.0f, 132.0f, this.mPaint);
        } else {
        ...
        } else if (temp2 >= 116 && temp2 <= 144) {
            c.drawText(new StringBuilder(String.valueOf(((temp2 - 116) / 2.0f) + 18.0f)).toString(), 920.0f, 132.0f, this.mPaint);
        } else {

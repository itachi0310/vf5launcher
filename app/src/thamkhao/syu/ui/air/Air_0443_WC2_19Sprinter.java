...
public class Air_0443_WC2_19Sprinter extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[13] != 0) {
            this.srPath.addRect(591.0f, 20.0f, 674.0f, 74.0f, Path.Direction.CW);
        }
        ...
        if (temp5 == -1) {
            ...
            int temp6 = temp5 * 5;
            c.drawText(String.valueOf(temp6 / 10) + "." + (temp6 % 10) + "℃", 968.0f, 58.0f, this.mPaint);
        }
        canvas.save();

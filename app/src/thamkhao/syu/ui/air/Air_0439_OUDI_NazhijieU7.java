...
public class Air_0439_OUDI_NazhijieU7 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder(String.valueOf(17.0f + (temp / 2.0f))).toString(), 70.0f, 60.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(new StringBuilder(String.valueOf(17.0f + (temp2 / 2.0f))).toString(), 920.0f, 60.0f, this.mPaint);
        }
        canvas.save();

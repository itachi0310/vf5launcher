...
public class Air_0454_RZC_Shanqi_Delong extends AirBase {
    public Air_0454_RZC_Shanqi_Delong(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[11] != 0) {
            this.srPath.addRect(204.0f, 114.0f, 264.0f, 147.0f, Path.Direction.CW);
        }
        if (this.DATA[14] != 0) {
        ...
        if (this.DATA[53] != 0) {
            c.drawText("MAX", 185.0f, 108.0f, this.mPaint);
        } else {
            c.drawText("  ", 185.0f, 108.0f, this.mPaint);
        }
        this.mPaint.setTextSize(30.0f);
        int temp = this.DATA[27];
        if (temp == -2) {
            c.drawText("LO", 50.0f, 130.0f, this.mPaint);
        } else if (temp == -3) {
            c.drawText("HI", 50.0f, 130.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(((temp * 10) + 150) / 10.0f).toString(), 50.0f, 130.0f, this.mPaint);
        }
        int temp2 = this.DATA[27];
        if (temp2 == -2) {
            c.drawText("LO", 930.0f, 130.0f, this.mPaint);
        } else if (temp2 == -3) {
            c.drawText("HI", 930.0f, 130.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(((temp2 * 10) + 150) / 10.0f).toString(), 930.0f, 130.0f, this.mPaint);
        }
        canvas.save();

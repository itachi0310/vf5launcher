...
public class Air_0383_JYKJ_XP1_ZhongTaiDaMaiX5 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (left_temp == -2) {
            ...
            c.drawText(new StringBuilder().append(left_temp).toString(), 56.0f, 70.0f, this.mPaint);
        }
        ...
        if (right_temp == -2) {
            ...
            c.drawText(new StringBuilder().append(right_temp).toString(), 930.0f, 70.0f, this.mPaint);
        }
        canvas.save();

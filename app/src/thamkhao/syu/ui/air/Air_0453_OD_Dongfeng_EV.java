...
public class Air_0453_OD_Dongfeng_EV extends AirBase {
    public Air_0453_OD_Dongfeng_EV(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[13] != 0) {
            this.srPath.addRect(887.0f, 103.0f, 1001.0f, 149.0f, Path.Direction.CW);
        }
        if (this.DATA[11] != 0) {
        ...
        if (temp == -1) {
            ...
            c.drawText("LO", 70.0f, 60.0f, this.mPaint);
        } else if (temp == -3) {
            c.drawText("HI", 70.0f, 60.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(((temp * 5) + 175) * 0.1f).toString(), 70.0f, 60.0f, this.mPaint);
        }
        int temp2 = this.DATA[28];
        if (temp2 == -1) {
            c.drawText("NO", 920.0f, 60.0f, this.mPaint);
        } else if (temp2 == -2) {
            c.drawText("LO", 920.0f, 60.0f, this.mPaint);
        } else if (temp2 == -3) {
            c.drawText("HI", 920.0f, 60.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(((temp2 * 5) + 175) * 0.1f).toString(), 920.0f, 60.0f, this.mPaint);
        }
        canvas.save();

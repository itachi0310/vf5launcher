...
public class Air_0160_RZC_20TuGuanL extends AirBase {
    public Air_0160_RZC_20TuGuanL(Context context) {
        super(context);
    }
    ...
    protected void initDrawable() {
        this.mPathNormal = "0017_wc2_golf7/air_wc_20tuguan_l.webp";
        this.mPathHighlight = "0017_wc2_golf7/air_wc_20tuguan_l_p.webp";
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[366] != 0) {
            this.srPath.addRect(474.0f, 26.0f, 556.0f, 118.0f, Path.Direction.CW);
        }
        if (this.DATA[88] != 0) {
        ...
        this.srPath.addRect(483.0f, 128.0f, 483.0f + (value4 * 20.0f), 147.0f, Path.Direction.CW);

...
public class Air_0454_Oudi_Beiqi_diandong_new extends AirBase {
    public Air_0454_Oudi_Beiqi_diandong_new(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (left_temp == -2) {
            c.drawText("LO", 86.0f, 142.0f, this.mPaint);
        } else if (left_temp == -3) {
            c.drawText("HI", 86.0f, 142.0f, this.mPaint);
        } else if (left_temp == -1) {
            c.drawText("NO", 86.0f, 142.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(left_temp / 10) + "." + (left_temp % 10), 86.0f, 142.0f, this.mPaint);
        }
        canvas.save();

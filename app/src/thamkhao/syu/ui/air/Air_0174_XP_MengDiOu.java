...
public class Air_0174_XP_MengDiOu extends AirBase {
    public Air_0174_XP_MengDiOu(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[62] != 0) {
            this.srPath.addRect(168.0f, 97.0f, 280.0f, 155.0f, Path.Direction.CW);
        }
        if (this.DATA[12] == 0) {
            this.srPath.addRect(299.0f, 62.0f, 432.0f, 129.0f, Path.Direction.CW);
        }
        if (this.DATA[16] != 0) {
            this.srPath.addRect(772.0f, 92.0f, 860.0f, 164.0f, Path.Direction.CW);
        }
        if (this.DATA[18] != 0) {
        ...
        switch (value2) {
            ...
            case -1:
                ...
                break;
            default:
                str = new StringBuilder(String.valueOf(value2 / 10.0f)).toString();
                break;
        }
        ...
        switch (value3) {
            ...
            case -1:
                ...
                break;
            default:
                str2 = new StringBuilder(String.valueOf(value3 / 10.0f)).toString();
                break;
        }

...
public class Air_0439_RZC_Sanlin_All extends AirBase {
    public Air_0439_RZC_Sanlin_All(Context context) {
        super(context);
    }
    ...
    protected void initDrawable() {
        this.mPathNormal = "0395_wc2_guochan/air_0439_rzc_sanlin_n.webp";
        this.mPathHighlight = "0395_wc2_guochan/air_0439_rzc_sanlin_p.webp";
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[38] != 0) {
            this.srPath.addRect(454.0f, 25.0f, 573.0f, 67.0f, Path.Direction.CW);
        }
        if (this.DATA[11] != 0) {
        ...
        this.srPath.addRect(449.0f, 92.0f, 449.0f + (value * 15.6f), 159.0f, Path.Direction.CW);
        ...
        if (left_temp == -2) {
            c.drawText("LO", 55.0f, 140.0f, this.mPaint);
        } else if (left_temp == -3) {
            c.drawText("HI", 55.0f, 140.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append((left_temp * 5) / 10.0f).toString(), 55.0f, 140.0f, this.mPaint);
        }
        ...
        if (right_temp == -2) {
            ...
            c.drawText(new StringBuilder().append((right_temp * 5) / 10.0f).toString(), 930.0f, 140.0f, this.mPaint);
        }

...
public class Air_0254_WC2_15YingLang extends AirBase {
    public Air_0254_WC2_15YingLang(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 254) {
            ...
            c.drawText(String.format("%d.%d", Integer.valueOf(temp / 10), Integer.valueOf(temp % 10)), 295.0f, 155.0f, this.mPaint);
        }
        ...
        if (temp2 == 254) {
            ...
            c.drawText(String.format("%d.%d", Integer.valueOf(temp2 / 10), Integer.valueOf(temp2 % 10)), 905.0f, 155.0f, this.mPaint);
        }

...
public class Air_0452_DJ_Dodge_JCUV extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder(String.valueOf((temp + 13) / 1.0f)).toString(), 65.0f, 140.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(new StringBuilder(String.valueOf((temp2 + 13) / 1.0f)).toString(), 930.0f, 140.0f, this.mPaint);
        }
        canvas.save();

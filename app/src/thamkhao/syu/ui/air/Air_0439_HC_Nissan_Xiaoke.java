...
public class Air_0439_HC_Nissan_Xiaoke extends AirBase {
    public Air_0439_HC_Nissan_Xiaoke(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            int temp2 = ((temp - 36) * 5) + 180;
            c.drawText(String.valueOf(temp2 / 10) + "." + (temp2 % 10), 70.0f, 135.0f, this.mPaint);
        }
        ...
        if (temp3 == -1) {
            ...
            int temp4 = ((temp3 - 36) * 5) + 180;
            c.drawText(String.valueOf(temp4 / 10) + "." + (temp4 % 10), 915.0f, 135.0f, this.mPaint);
        }
        canvas.save();

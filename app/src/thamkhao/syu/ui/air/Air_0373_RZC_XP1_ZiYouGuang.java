...
public class Air_0373_RZC_XP1_ZiYouGuang extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -2) {
            ...
            c.drawText(new StringBuilder().append(temp).toString(), 65.0f, 140.0f, this.mPaint);
        } else {
        ...
        if (temp2 == -2) {
            ...
            c.drawText(new StringBuilder().append(temp2).toString(), 935.0f, 140.0f, this.mPaint);
        } else {

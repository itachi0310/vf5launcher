...
public class Air_0452_DJ_Guanzhi_All extends AirBase {
    public Air_0452_DJ_Guanzhi_All(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder().append(((temp * 5) + 165) / 10.0f).toString(), 70.0f, 135.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(new StringBuilder().append(((temp2 * 5) + 165) / 10.0f).toString(), 915.0f, 135.0f, this.mPaint);
        }
        canvas.save();

...
public class Air_0246_WC_20Baojun530 extends AirBase {
    public Air_0246_WC_20Baojun530(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder().append((temp * 2) + 16).toString(), 70.0f, 132.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(new StringBuilder().append((temp2 * 2) + 16).toString(), 920.0f, 132.0f, this.mPaint);
        }
        canvas.save();

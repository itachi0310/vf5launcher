...
public class Air_0452_KYC_Zhonghua_All extends AirBase {
    public Air_0452_KYC_Zhonghua_All(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value >= 0 && value <= 7) {
            this.srPath.addRect(468.0f, 60.0f, (value * 16) + 468, 119.0f, Path.Direction.CW);
        }
        ...
        if (temp == -2) {
            c.drawText("Lo", 60.0f, 140.0f, this.mPaint);
        } else if (temp == -3) {
            ...
            c.drawText("No", 60.0f, 140.0f, this.mPaint);
        }

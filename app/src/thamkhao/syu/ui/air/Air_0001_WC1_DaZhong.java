...
public class Air_0001_WC1_DaZhong extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mRectTmp.set(52.0f, 138.0f, ((value * 63) / 3) + 52, 156.0f);
        this.srPath.addRect(this.mRectTmp, Path.Direction.CW);
        int value2 = ToolkitMath.clamp(this.DATA[30], 0, 3);
        this.mRectTmp.set(955.0f, 138.0f, ((value2 * 64) / 3) + 955, 157.0f);
        this.srPath.addRect(this.mRectTmp, Path.Direction.CW);
        if (this.DATA[18] != 0) {
        ...
        this.mRectTmp.set(176.0f, 134.0f, ((value3 * 198) / 7) + 176, 154.0f);
        this.srPath.addRect(this.mRectTmp, Path.Direction.CW);
        if (this.DATA[22] != 0) {
        ...
        int value4 = ToolkitMath.clamp(this.DATA[25], 0, 7);
        this.mRectTmp.set(657.0f, 134.0f, ((value4 * 198) / 7) + 657, 153.0f);
        this.srPath.addRect(this.mRectTmp, Path.Direction.CW);
        ...
        int value5 = ToolkitMath.clamp(this.DATA[27], 0, 255);
        switch (value5) {
            case 0:
            ...
            case 255:
                ...
                break;
            default:
                c.drawText(String.format("%.1f", Float.valueOf(value5)), 51.0f, 67.0f, this.mPaint);
                break;
        }
        int value6 = ToolkitMath.clamp(this.DATA[28], 0, 255);
        switch (value6) {
            case 0:
            ...
            case 255:
                ...
                break;
            default:
                c.drawText(String.format("%.1f", Float.valueOf(value6)), 945.0f, 67.0f, this.mPaint);
                break;
        }
        canvas.save();

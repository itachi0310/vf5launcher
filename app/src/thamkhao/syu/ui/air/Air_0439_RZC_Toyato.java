...
public class Air_0439_RZC_Toyato extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.srPath.addRect(683.0f, 40.0f, 683.0f + (value * 19.4f), 139.0f, Path.Direction.CW);
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder().append(temp / 10.0f).toString(), 70.0f, 132.0f, this.mPaint);
        }

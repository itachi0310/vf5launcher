...
public class Air_0218_XBS_XP1_13Medeo extends AirBase {
    public Air_0218_XBS_XP1_13Medeo(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(new StringBuilder().append(temp).toString(), 60.0f, 150.0f, this.mPaint);
        } else {
        ...
        if (temp2 == -1) {
            ...
            c.drawText(new StringBuilder().append(temp2).toString(), 930.0f, 150.0f, this.mPaint);
        } else {

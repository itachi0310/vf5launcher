...
public class Air_0452_XC_TianLai_GJ extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 0) {
            ...
            c.drawText(new StringBuilder().append(17.5d + ((double) (temp / 2.0f))).toString(), 70.0f, 135.0f, this.mPaint);
        }
        int temp2 = this.DATA[28];
        if (temp2 == 0) {
            c.drawText("", 915.0f, 135.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(17.5d + ((double) (temp2 / 2.0f))).toString(), 915.0f, 135.0f, this.mPaint);
        }
        canvas.save();

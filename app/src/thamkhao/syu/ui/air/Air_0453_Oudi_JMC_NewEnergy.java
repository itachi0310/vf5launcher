    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (this.DATA[27]) {
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(new StringBuilder(String.valueOf(((r8 * 5) + 180) * 0.1f)).toString(), 51.0f, 97.0f, this.mPaint);
                break;
        }
        switch (this.DATA[27]) {
            case -3:
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(new StringBuilder(String.valueOf(((r8 * 5) + 180) * 0.1f)).toString(), 945.0f, 97.0f, this.mPaint);
                break;
        }
        canvas.save();

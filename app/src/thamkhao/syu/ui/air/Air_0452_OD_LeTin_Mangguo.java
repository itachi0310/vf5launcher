...
public class Air_0452_OD_LeTin_Mangguo extends AirBase {
    public Air_0452_OD_LeTin_Mangguo(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[68] != 0) {
            this.srPath.addRect(758.0f, 58.0f, 855.0f, 113.0f, Path.Direction.CW);
        }
        if (this.DATA[18] != 0) {

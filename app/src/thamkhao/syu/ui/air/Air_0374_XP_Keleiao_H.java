...
public class Air_0374_XP_Keleiao_H extends AirBase {
    public Air_0374_XP_Keleiao_H(Context context) {
        super(context);
    }
    ...
    protected void initDrawable() {
        this.mPathNormal = "0374_xp_keleiao/xp_keleiao_high.webp";
        this.mPathHighlight = "0374_xp_keleiao/xp_keleiao_high_p.webp";
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[13] != 0) {
            this.srPath.addRect(202.0f, 101.0f, 321.0f, 154.0f, Path.Direction.CW);
        }
        if (this.DATA[62] != 0) {
            this.srPath.addRect(694.0f, 22.0f, 806.0f, 75.0f, Path.Direction.CW);
        }
        if (this.DATA[12] != 1) {
            this.srPath.addRect(182.0f, 8.0f, 333.0f, 63.0f, Path.Direction.CW);
        }
        if (this.DATA[36] != 1) {
            this.srPath.addRect(227.0f, 63.0f, 296.0f, 82.0f, Path.Direction.CW);
        }
        if (this.DATA[15] != 0) {
        ...
        this.srPath.addRect(698.0f, 109.0f, (value * 16) + 698, 164.0f, Path.Direction.CW);

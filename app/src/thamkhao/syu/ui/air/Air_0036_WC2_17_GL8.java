...
public class Air_0036_WC2_17_GL8 extends AirBase {
    private int nWindLevelLeft;

    public Air_0036_WC2_17_GL8(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[77] != 0) {
            this.srPath.addRect(371.0f, 15.0f, 475.0f, 76.0f, Path.Direction.CW);
        }
        if (this.DATA[72] == 1) {
        ...
        int value = ToolkitMath.clamp(this.DATA[89], 0, 6);
        if (value < 0) {
            value = 0;
        } else if (value > 6) {
            value = 6;
        ...
        if (frontLevel == 0) {
            c.drawText("OFF", 448.0f, 160.0f, this.mPaint);
        } else if (frontLevel == 19) {
            c.drawText("AUTO", 448.0f, 160.0f, this.mPaint);
        } else {
            c.drawText("L" + frontLevel, 448.0f, 160.0f, this.mPaint);
        }

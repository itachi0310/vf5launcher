...
public class Air_0017_WC2_TuGuanL extends AirBase {
    public Air_0017_WC2_TuGuanL(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 254) {
            ...
            c.drawText(new StringBuilder().append((temp * 5) / 10.0f).toString(), 56.0f, 124.0f, this.mPaint);
        }
        ...
        if (temp2 == 254) {
            ...
            c.drawText(new StringBuilder().append((temp2 * 5) / 10.0f).toString(), 929.0f, 124.0f, this.mPaint);
        }
        canvas.save();

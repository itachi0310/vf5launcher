...
public class Air_0439_XBS_Nissan_Tule extends AirBase {
    public Air_0439_XBS_Nissan_Tule(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[65] != 0) {
            this.srPath.addRect(409.0f, 21.0f, 477.0f, 74.0f, Path.Direction.CW);
        }
        if (this.DATA[18] != 0) {

...
public class Air_0244_RZC_HavaH2S_LanBiao extends AirBase {
    public Air_0244_RZC_HavaH2S_LanBiao(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.srPath.addRect(5.0f, 90.0f, (tempValue * 20) + 5, 163.0f, Path.Direction.CW);
        ...
        this.srPath.addRect(871.0f, 93.0f, (tempValue2 * 20) + 871, 164.0f, Path.Direction.CW);

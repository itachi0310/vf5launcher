...
public class Air_0439_OUDI_Haval_H9 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[11] != 0) {
            this.srPath.addRect(368.0f, 109.0f, 412.0f, 152.0f, Path.Direction.CW);
        }
        if (this.DATA[13] != 0) {
            this.srPath.addRect(266.0f, 26.0f, 351.0f, 67.0f, Path.Direction.CW);
        }
        if (this.DATA[12] == 0) {
        ...
        if (this.DATA[18] != 0) {
            this.srPath.addRect(153.0f, 9.0f, 205.0f, 45.0f, Path.Direction.CW);
        }
        if (this.DATA[19] != 0) {
            this.srPath.addRect(161.0f, 44.0f, 198.0f, 59.0f, Path.Direction.CW);
        }
        if (this.DATA[20] != 0) {
            this.srPath.addRect(152.0f, 57.0f, 182.0f, 80.0f, Path.Direction.CW);
        }
        if (this.DATA[24] != 0) {
        ...
        if (temp12 == -1) {
            ...
            if (DataCanbus.DATA[1000] == 10420663 || DataCanbus.DATA[1000] == 10486199 || DataCanbus.DATA[1000] == 15794628 || DataCanbus.DATA[1000] == 15860164 || DataCanbus.DATA[1000] == 15925700 || DataCanbus.DATA[1000] == 15991236 || DataCanbus.DATA[1000] == 16056772) {
                temp1 = (temp12 * 5) + 160;
            } else if (DataCanbus.DATA[1000] == 2490807 || DataCanbus.DATA[1000] == 8651204 || DataCanbus.DATA[1000] == 2556343 || DataCanbus.DATA[1000] == 11796934 || DataCanbus.DATA[1000] == 11862470) {
        ...
        if (temp22 == -1) {
            ...
            c.drawText(String.valueOf(temp23 / 10) + "." + (temp23 % 10), 955.0f, 63.0f, this.mPaint);
        } else if (DataCanbus.DATA[1000] == 2490807 || DataCanbus.DATA[1000] == 8651204 || DataCanbus.DATA[1000] == 2556343 || DataCanbus.DATA[1000] == 11796934 || DataCanbus.DATA[1000] == 11862470) {
            if (temp22 == 0) {
                c.drawText("--.-", 955.0f, 63.0f, this.mPaint);
            } else {
                int temp24 = ((temp22 - 112) * 5) + 160;
                c.drawText(String.valueOf(temp24 / 10) + "." + (temp24 % 10), 955.0f, 63.0f, this.mPaint);
            }
        } else if (temp22 == 0) {
            c.drawText("--.-", 955.0f, 63.0f, this.mPaint);
        } else {
            int temp25 = ((temp22 - 116) * 5) + 160;
            c.drawText(String.valueOf(temp25 / 10) + "." + (temp25 % 10), 955.0f, 63.0f, this.mPaint);
        }
        canvas.save();

...
public class Air_0454_RZ_Suburu_All extends AirBase {
    public Air_0454_RZ_Suburu_All(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[79] != 0) {
            this.srPath.addRect(441.0f, 30.0f, 583.0f, 71.0f, Path.Direction.CW);
        }
        if (this.DATA[16] != 0) {
        ...
        if (temp3 == -2) {
            ...
            c.drawText("NO", 928.0f, 140.0f, this.mPaint);
        } else {
            int temp4 = temp3 * 5;

...
public class Air_0132H_WC2_HavaH2 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == 7) {
            this.srPath.addRect(504.0f, 89.0f, (value * 22) + ConstRzcAddData.U_CAR_ADD_START, 161.0f, Path.Direction.CW);
        } else {
            this.srPath.addRect(504.0f, 89.0f, (value * 22) + 504, 161.0f, Path.Direction.CW);
        }

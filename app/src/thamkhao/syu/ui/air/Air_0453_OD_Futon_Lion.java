...
public class Air_0453_OD_Futon_Lion extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -2) {
            ...
            c.drawText(new StringBuilder(String.valueOf(((double) (temp / 2.0f)) + 17.5d)).toString(), 60.0f, 132.0f, this.mPaint);
        } else {
        ...
        if (temp2 == -2) {
            ...
            c.drawText(new StringBuilder(String.valueOf(((double) (temp2 / 2.0f)) + 17.5d)).toString(), 920.0f, 132.0f, this.mPaint);
        } else {

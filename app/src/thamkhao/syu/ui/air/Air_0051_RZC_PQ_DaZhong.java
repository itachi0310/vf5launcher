...
public class Air_0051_RZC_PQ_DaZhong extends AirBase {
    public Air_0051_RZC_PQ_DaZhong(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mRectTmp.set(433.0f, 110.0f, (value * 39) + 433, 154.0f);
        this.srPath.addRect(this.mRectTmp, Path.Direction.CW);
        ...
        } else if ((carid >= 46 && carid <= 59) || carid == 63 || carid == 67 || carid == 69 || carid == 71 || carid == 72 || carid == 73) {
            if (value4 == 0) {
                c.drawText("LO", 71.0f, 60.0f, this.mPaint);
            } else if (value4 == 254) {
                c.drawText("HI", 71.0f, 60.0f, this.mPaint);

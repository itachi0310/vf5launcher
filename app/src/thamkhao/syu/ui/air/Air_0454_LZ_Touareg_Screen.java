...
public class Air_0454_LZ_Touareg_Screen extends AirBase {
    public Air_0454_LZ_Touareg_Screen(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText("LO", 70.0f, 135.0f, this.mPaint);
        } else if (temp == -3) {
        ...
        if (temp2 == -1) {
            ...
            c.drawText("LO", 915.0f, 135.0f, this.mPaint);
        } else if (temp2 == -3) {

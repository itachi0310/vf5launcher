...
public class DataPack {
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (DataCanbus.DATA[1000]) {
                ...
                case FinalCanbus.CAR_CZH_RZC_YiHu2017_H /* 3932494 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{107, 100};
                    break;
                case 40:
                ...
                case FinalCanbus.CAR_RZC4_PSA_ALL_NoAir_H /* 2163027 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{201, 202, 203};
                    break;
                case 265:
                    DataPack.mCurrentNotify = DataPack.mNotifyRzcZhongtaiT600;
                    DataPack.mCurrentUpdatteCode = new int[]{143, 144, 145};
                    break;
                case 293:
                ...
                case FinalCanbus.CAR_DJ_SHA_BUS_JiuLong /* 197016 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{94};
                    break;
                ...
                case FinalCanbus.CAR_439_HC_Nissan_GuiShi /* 7799223 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{102};
                    break;
                ...
                case FinalCanbus.CAR_WC2_LandRover_Discovery3 /* 131483 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{96};
                    break;
                ...
                case FinalCanbus.CAR_LZ_XP1_PsaAll_CD /* 196889 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{203, 204, 205, 206, 207, 208, 209};
                    break;
                case FinalCanbus.CAR_XP1_PsaAll_AutoPark /* 262425 */:
                    DataPack.mCurrentNotify = DataPack.mNotifyXPPsaAutoPark;
                    DataPack.mCurrentUpdatteCode = new int[]{212, 213};
                    break;
                ...
                case FinalCanbus.CAR_439_BNR_MZD_ALL /* 8061367 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{166, 167, 168, 169};
                    break;
                ...
                case FinalCanbus.CAR_453_PA_Ford_Mustang_10_CD /* 5702085 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{144};
                    break;
                ...
                case FinalCanbus.CAR_452_RZC_LandRover_RANGE_12 /* 2163140 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{182, 183};
                    break;
                ...
                case FinalCanbus.CAR_PA_Dodge_Challenger_08_14 /* 2818422 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{366};
                    break;
                ...
                case FinalCanbus.CAR_CZH_RZC_19Mingjue_MG6 /* 2097425 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{172, 174};
                    break;
                ...
                case FinalCanbus.CAR_RZC_XP1_21Xiaomayi_EQ1 /* 1638804 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{139};
                    break;
                case FinalCanbus.CAR_RZC4_PSA_04_407_CD /* 1704275 */:
                    DataPack.mCurrentNotify = DataPack.mNotifyRZC407PsaAll;
                    DataPack.mCurrentUpdatteCode = new int[]{222, 223, 224, 225, 226, 227, 228, 229, 230};
                    break;
                ...
                case FinalCanbus.CAR_452_OD_Ford_PRO_H /* 9241028 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{126};
                    break;
                ...
                case FinalCanbus.CAR_RZC_XP1_Dihaoe_22 /* 2621579 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{182};
                    break;
                ...
                case FinalCanbus.CAR_443_WC2_XianDai_All_18OPTIMA /* 15073723 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{99, 100, 101};
                    break;
                ...
                case FinalCanbus.CAR_452_WC_Honda_Yage8 /* 12321220 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{128, 131, 132, 133, 135};
                    break;
                ...
                case FinalCanbus.CAR_443_WC2_Tianlai08_12_CD_HW /* 4915643 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{140, 141, 142, 143, 144, 145, 146};
                    break;
                ...
                case FinalCanbus.CAR_452_LZ_Subaru_TRIBECA /* 7078340 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{94, 95, 96, 97, 98, 99, 132};
                    break;
                ...
                case FinalCanbus.CAR_452_XC_Lexus_RX350 /* 14614980 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{94, 95, 96, 97, 98, 99, 100, 101};
                    break;
                case FinalCanbus.CAR_452_XC_Nissan_Tule_CD /* 8716740 */:
                    DataPack.mCurrentNotify = DataPack.mNotifyXcTule;
                    DataPack.mCurrentUpdatteCode = new int[]{136};
                    break;
                ...
                case FinalCanbus.CAR_452_Luz_Audi_Q7_H /* 15270340 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{149, 27, 28, 21, 25, 77, 87, 29, 30};
                    break;
                ...
                case FinalCanbus.CAR_453_OD_Modernin /* 16384453 */:
                    ...
                    DataPack.mCurrentUpdatteCode = new int[]{148, 149, 150, 151, 152, 153, 154};
                    break;
    ...
    static IUiNotify mNotifyLzMustangAutoPark = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.5
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UILZFordMustang.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyWCFocusAutoPark = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.6
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIWCFordFocus.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyXPPsaAutoPark = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.7
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIXPPsaAutoPark.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyODModernin = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.8
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIODModernin.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotify18JiliYuanjing = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.9
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIRZC18Yuanjing.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyUAZPatriot = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.10
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIUAZPatriot.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyRzcZhongtaiT600 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.11
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIRzcZhongtaiT600PM25.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyWCUAZPatriot = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.12
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIWCUAZPatriot.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyRZCUAZPatriot = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.13
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIRZCUAZPatriot.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyLZRomeoBrakeMode = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.14
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 99) {
    ...
    static IUiNotify mNotifyWCProtonS70 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.15
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 123) {
    ...
    static IUiNotify mNotifyWCLandRover = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.16
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 96) {
    ...
    static IUiNotify mNotifyPAJeepBrakeMode = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.17
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 366 && DataCanbus.DATA[updateCode] != 0) {
                UIPAJeepBrakeMode.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
            }
        }
    };
    static IUiNotify mNotifyXcYage8 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.18
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 135 && DataCanbus.DATA[updateCode] == 0) {
    ...
    static IUiNotify mNotifyXcFord = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.19
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 119) {
    ...
    static IUiNotify mNotifyWCJianghuaiT8 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.20
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 126 && DataCanbus.DATA[updateCode] != 0) {
                UIWCJianghuaiT8.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
            }
        }
    };
    static IUiNotify mNotifyRZCBj90 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.21
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 64) {
    ...
    static IUiNotify mNotifyLZPsaAll = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.22
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UILZPsaAll.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyRZC407PsaAll = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.23
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIRZCPsa407All.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyWCTianlai = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.24
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
    ...
    static IUiNotify mNotifyLZLeuxs = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.25
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 138 && !LZLexusISCarSet.isFront) {
                if (FinalCanbus.num >= 0) {
                    UIXCTianlai.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
                } else {
                    FinalCanbus.num++;
    ...
    static IUiNotify mNotifyWCPSA407 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.26
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 213) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyPAFord = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.27
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 127) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyCMTZYBMW = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.28
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UICMBMW_WarnState.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyWcMzdWarn = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.29
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIWCMzdWarn.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyWCFeiyateBrake = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.30
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 143) {
    ...
    static IUiNotify mNotifyWCBenzC200 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.31
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 110) {
    ...
    static IUiNotify mNotifyXcTianlai = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.32
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 111) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyODJiliBinyuePro = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.33
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 212) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyRZCToyota = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.34
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 189) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyXcFordEDGE = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.35
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 96) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyBNRAds = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.36
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 160 && !Act_CarCD_AoDeSai.mIsFront) {
                if (FinalCanbus.num >= 0) {
                    UIXCTianlai.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
                } else {
                    FinalCanbus.num++;
    ...
    static IUiNotify mNotifyWCHuangguan = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.37
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 77) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyRZCXiaomayi = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.38
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 139) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyRZCDongfengE3 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.39
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 120) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyXcTianlaiGJ = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.40
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 102) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyODFordPro = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.41
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 126) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyDJDoggeJcuv = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.42
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 107) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyXcTule = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.43
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 136) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyRZCXiandai = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.44
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 100) {
                if (FinalCanbus.num >= 0) {
    ...
    static IUiNotify mNotifyODHzNezha = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.45
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 94) {
    ...
    static IUiNotify mNotifyXcLexus = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.46
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIXCLexus.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyZHToyotaProace = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.47
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIZHToyotaProace.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyXcRongwei = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.48
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIXCRongwei950.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyLZSubaru = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.49
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UILZSubaru.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyXcToyota = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.50
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 115) {
                UIXCTianlai.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
    ...
    static IUiNotify mNotifyBus = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.51
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 94) {
    ...
    static IUiNotify mNotifyRZCBiaozhi = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.52
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if ((updateCode == 201 || updateCode == 202 || updateCode == 203) && DataCanbus.DATA[updateCode] != 0) {
                UIRZCBiaozhiWarn.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
            }
        }
    };
    static IUiNotify mNotifyEi6 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.53
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UIEi6Warn.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyLandrover = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.54
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            UILandroverWarn.getInstance().showWindowTip(DataCanbus.DATA[updateCode], updateCode);
        }
    };
    static IUiNotify mNotifyAX5 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.55
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            WarnAX5.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyZhongTai = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.56
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            WarnZhongTaiX5.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyEC180 = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.57
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 100) {
    ...
    static IUiNotify mNotify20boyue = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.58
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 182) {
    ...
    static IUiNotify mNotifyXPMQBAirClear = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.59
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 122) {
    ...
    static IUiNotify mNotifyRZCMQBTireWarn = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.60
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
    ...
    static IUiNotify mNotifyGl8Old = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.61
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 1) {
    ...
    static IUiNotify mNotifyOdBeiqiEC = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.62
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            if (updateCode == 95) {
                WarnEC180.getInstance().showWindowTip(DataCanbus.DATA[updateCode]);
    ...
    static IUiNotify mNotifyZhongTaiT600_Bnr = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.63
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            WarnT600.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyAdui_Zhtd = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.64
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            WarnZhtdAudiAir.getInstance().showWindowTip(updateCode, DataCanbus.DATA[updateCode]);
        }
    };
    static IUiNotify mNotifyAdui_LuzHp = new IUiNotify() { // from class: com.syu.canbus.warn.DataPack.65
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {

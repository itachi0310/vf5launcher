...
public class UIRZCPsa407All {
    ...
    private void initTip(int value, int updateCode) {
        ...
        switch (DataCanbus.DATA[222]) {
            case 1:
                int val = DataCanbus.DATA[225];
                if (val > 9) {

...
public class Callback_0453_LZ_LandRover_KeepCD extends CallbackCanbusBase {
    ...
    public static final int U_AIR_SEAT_LEFT = 74;
    public static final int U_AIR_SEAT_LEFT_REAR = 45;
    public static final int U_AIR_SEAT_RIGHT = 75;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0453_LZ_LandRover_All(TheApp.getInstance()));

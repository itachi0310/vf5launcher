...
public class Callback_0373_RZC_XP1_ZiYouGuang extends CallbackCanbusBase {
    ...
    public static final int U_CARSET_D61_D0_B0 = 158;
    public static final int U_CARSET_D61_D0_B1 = 157;
    public static final int U_CARSET_D61_D0_B2 = 156;
    public static final int U_CARSET_D61_D0_B3 = 155;
    public static final int U_CARSET_D61_D0_B5 = 154;
    public static final int U_CARSET_D61_D0_B6 = 153;
    public static final int U_CARSET_D61_D0_B7 = 152;
    public static final int U_CARSET_D61_D1_B0 = 163;
    public static final int U_CARSET_D61_D1_B2 = 162;
    public static final int U_CARSET_D61_D1_B3 = 161;
    public static final int U_CARSET_D61_D1_B4 = 160;
    public static final int U_CARSET_D61_D1_B5 = 159;
    ...
    public void in() {
        ...
        if (DataCanbus.DATA[1000] == 373 || DataCanbus.DATA[1000] == 65909 || DataCanbus.DATA[1000] == 1114485 || DataCanbus.DATA[1000] == 1311093 || DataCanbus.DATA[1000] == 1376629 || DataCanbus.DATA[1000] == 1835381 || DataCanbus.DATA[1000] == 1245557 || DataCanbus.DATA[1000] == 196981 || DataCanbus.DATA[1000] == 459125) {
            AirHelper.getInstance().buildUi(new Air_0373_RZC_XP1_ZiYouGuang(TheApp.getInstance()));
            for (int i3 = 41; i3 < 60; i3++) {
                DataCanbus.NOTIFY_EVENTS[i3].addNotify(AirHelper.SHOW_AND_REFRESH);
            }
        } else {
            AirHelper.getInstance().buildUi(new Air_0373_RZC_Jeep_ZhiNanZhe(TheApp.getInstance()));

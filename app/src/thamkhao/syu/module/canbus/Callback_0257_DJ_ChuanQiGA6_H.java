...
import com.syu.ui.air.Air_0257_DJ_ChuangQiGa6_H;
import com.syu.ui.door.DoorHelper;

/* JADX INFO: loaded from: classes.dex */
public class Callback_0257_DJ_ChuanQiGA6_H extends CallbackCanbusBase {
    ...
    public static final int U_CLOSE_BIGLAMP_TIME = 106;
    public static final int U_CLOSE_INSIDELAMP_TIME = 105;
    ...
    public static final int U_DISPLAY_ENABLE_1 = 107;
    public static final int U_DISPLAY_ENABLE_2 = 108;
    public static final int U_DISPLAY_ENABLE_3 = 109;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0257_DJ_ChuangQiGa6_H(TheApp.getInstance()));

...
public class Callback_0112_RZC_XP1_Carmy extends CallbackCanbusBase {
    ...
    public static final int U_CARSET_DF2_D17_D0_B70 = 256;
    public static final int U_CARSET_DF2_D18_D0_B70 = 257;
    public static final int U_CARSET_DF2_D19_D0_B70 = 258;
    public static final int U_CARSET_DF2_D1A_D0_B70 = 259;
    public static final int U_CARSET_DF2_D1B_D0_B70 = 260;
    public static final int U_CARSET_DF2_D1B_D1_B70 = 261;
    public static final int U_CARSET_DF2_D1D_D0_B70 = 262;
    public static final int U_CARSET_DOORLOCK = 237;
    public static final int U_CARSET_OIL_UNIT = 159;
    public static final int U_CAR_360_ONOFF = 263;
    ...
    public static final int U_CNT_MAX = 264;
    ...
    public static final int U_STEER_BUTTON_SET = 255;
    ...
    public void in() {
        ...
        if (DataCanbus.DATA[1000] == 3211376 || DataCanbus.DATA[1000] == 3276912 || DataCanbus.DATA[1000] == 3342448 || DataCanbus.DATA[1000] == 3801200 || DataCanbus.DATA[1000] == 4915312 || DataCanbus.DATA[1000] == 3670128) {
            AirHelper.getInstance().buildUi(new Air_0112_zx_6606_toyota(TheApp.getInstance()));
        } else if (DataCanbus.DATA[1000] == 3735664) {
            AirHelper.getInstance().buildUi(new Air_0112_zx_6606_yazhoulong(TheApp.getInstance()));
        } else {
            AirHelper.getInstance().buildUi(new Air_0112_XP1_Camry(TheApp.getInstance()));
        }
        ...
        if (updateCode >= 0) {
            switch (updateCode) {
                ...
                case 195:
                    ...
                    break;
                default:
                    if (updateCode >= 0 && updateCode < 264) {
                        HandlerCanbus.update(updateCode, ints);
                        break;
                    }
                    break;

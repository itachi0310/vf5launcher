...
public class Callback_0001_WC1_DaZhong extends CallbackCanbusBase {
    public static final int U_BATTERY_VOLTAGE = 100;
    public static final int U_BRAKE_LIGHTS = 110;
    ...
    public static final int U_DASHBOARD_SHOW = 116;
    public static final int U_DRIVE_MILE = 101;
    public static final int U_ENGINE_SPEED = 109;
    public static final int U_HANDBRAK_STATE = 118;
    public static final int U_LIFE_BELT_WARN = 97;
    public static final int U_LIGHT_STATE = 117;
    public static final int U_LOW_BATTERY_WARN = 96;
    public static final int U_LOW_OIL_WARN = 95;
    public static final int U_MACHINE_OIL_WARN = 107;
    public static final int U_MISC_BEGIN = 94;
    public static final int U_MISC_END = 115;
    public static final int U_OUT_TEMP = 114;
    public static final int U_PARK_CARPORT = 103;
    public static final int U_PARK_ROAD = 102;
    public static final int U_PRECISION_SPEED = 108;
    public static final int U_RADAR_MUTE = 104;
    public static final int U_RESIDUAL_OIL = 99;
    public static final int U_REVEIVER_LIGHTS = 111;
    public static final int U_TURN_LIGHT_LIGHTS = 113;
    public static final int U_TURN_RIGHT_LIGHTS = 112;
    public static final int U_WATER_TEMP = 106;
    ...
    public void in() {
        ...
        if (ID != 15) {
            AirHelper.getInstance().buildUi(new Air_0001_WC1_DaZhong(TheApp.getInstance()));
        }
                ...
                default:
                    if (DataCanbus.DATA[1000] == 131073) {
                        if (updateCode >= 10 && updateCode < 93) {
                            ...
                            break;
                        } else if (updateCode >= 0 && updateCode < 119) {

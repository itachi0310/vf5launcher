...
public class FinalCanUp {
    ...
    public static final int CAN_UP_CYT = 17;
    public static final int CAN_UP_CYT_LHT = 18;
    ...
    public static final int CAN_UP_LZ = 11;
    public static final int CAN_UP_LZ2 = 16;
    public static final int CAN_UP_MCL = 8;
    public static final int CAN_UP_Null = 0;
    public static final int CAN_UP_OD = 9;
    public static final int CAN_UP_RZC = 12;
    public static final int CAN_UP_SBD = 1;
    public static final int CAN_UP_TD = 20;
    public static final int CAN_UP_WC = 2;
    public static final int CAN_UP_WY = 19;
    public static final int CAN_UP_XFY = 7;
    public static final int CAN_UP_XP = 3;
    public static final int CAN_UP_XinCheng = 14;
    public static final int CAN_UP_ZHTD = 13;

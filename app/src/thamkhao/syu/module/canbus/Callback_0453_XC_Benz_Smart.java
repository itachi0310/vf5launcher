...
public class Callback_0453_XC_Benz_Smart extends CallbackCanbusBase {
    public static final int U_CARINF_D35_D0_B6 = 95;
    public static final int U_CARINF_D35_D0_B7 = 94;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0453_XC_BenZ_Smart(TheApp.getInstance()));

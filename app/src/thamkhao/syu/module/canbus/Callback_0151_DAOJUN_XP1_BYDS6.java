...
public class Callback_0151_DAOJUN_XP1_BYDS6 extends CallbackCanbusBase {
    ...
    public static final int U_RADAR_ONOFF = 95;
    public static final int U_TURN_RIGHT_ENTER_CAMERA = 94;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0151_DAOJUN_XP1_BYDS6(TheApp.getInstance()));

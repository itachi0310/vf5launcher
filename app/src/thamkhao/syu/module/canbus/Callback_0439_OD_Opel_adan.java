...
public class Callback_0439_OD_Opel_adan extends CallbackCanbusBase {
    ...
    public static final int U_TIRE_ALARM_FL = 102;
    public static final int U_TIRE_ALARM_FR = 103;
    public static final int U_TIRE_ALARM_RL = 104;
    public static final int U_TIRE_ALARM_RR = 105;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0439_OD_Opel_Adan(TheApp.getInstance()));

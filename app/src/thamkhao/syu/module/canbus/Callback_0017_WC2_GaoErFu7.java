...
public class Callback_0017_WC2_GaoErFu7 extends CallbackCanbusBase {
    ...
    public void in() {
        ...
        if (this.carId == 0 || this.carId == 8) {
            AirHelper.getInstance().buildUi(new Air_0017_WC2_Golf(TheApp.getInstance()));
        ...
        if (this.carId == 3) {
            AirHelper.getInstance().buildUi(new Air_0017_WC2_TuGuanL(TheApp.getInstance()));
        ...
        if (this.carId == 4) {
            AirHelper.getInstance().buildUi(new Air_0017_WC2_KeDiYaKe(TheApp.getInstance()));
        ...
        if (this.carId == 5) {
            AirHelper.getInstance().buildUi(new Air_0017_WC2_TuAng_Wc(TheApp.getInstance()));
        ...
        if (this.carId != 6 && this.carId != 7) {
            if (this.carId == 9) {
                AirHelper.getInstance().buildUi(new Air_0017_WC2_MQB_All(TheApp.getInstance()));
            ...
            AirHelper.getInstance().buildUi(new Air_0017_WC2_MaiTeng(TheApp.getInstance()));

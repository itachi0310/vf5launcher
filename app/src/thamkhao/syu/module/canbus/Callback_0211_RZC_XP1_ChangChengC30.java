...
public class Callback_0211_RZC_XP1_ChangChengC30 extends CallbackCanbusBase {
    ...
    public void in() {
        ...
        if (mcarId == 0) {
            AirHelper.getInstance().buildUi(new Air_0211_RZC_ChangChengC30(TheApp.getInstance()));
        } else if (mcarId == 1) {
            AirHelper.getInstance().buildUi(new Air_0211_OuDi_ChangChengH3(TheApp.getInstance()));
        }

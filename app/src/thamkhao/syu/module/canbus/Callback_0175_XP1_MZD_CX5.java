...
public class Callback_0175_XP1_MZD_CX5 extends CallbackCanbusBase {
    public static final int U_AUTO_AC_ENABLED = 101;
    public static final int U_CAR_INFO_END = 105;
    ...
    public static final int U_FEEDBACK_LAMP_ENABLED = 100;
    public static final int U_OPEN_BIGLAMP_BY_WIPER = 104;
    public static final int U_OPTIMAL_OIL_EXPEND = 96;
    public static final int U_SENSITIVITY_OPEN_BIGLAMP = 103;
    public static final int U_SYSTEM_KEY_WITH_EKEY_ENABLED = 99;

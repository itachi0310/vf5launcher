...
public class Callback_0448_LZ_BWM_CarUi extends CallbackCanbusBase {
    ...
    public void in() {
        ...
        if (DataCanbus.DATA[1000] == 65984 || DataCanbus.DATA[1000] == 262592 || DataCanbus.DATA[1000] == 197056 || DataCanbus.DATA[1000] == 131520 || DataCanbus.DATA[1000] == 590272 || DataCanbus.DATA[1000] == 328128 || DataCanbus.DATA[1000] == 393664 || DataCanbus.DATA[1000] == 459200 || DataCanbus.DATA[1000] == 524736) {
            AirHelper.getInstance().buildUi(new Air_0448_LZ_BMW(TheApp.getInstance()));

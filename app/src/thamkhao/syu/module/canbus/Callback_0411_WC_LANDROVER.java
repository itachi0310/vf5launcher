...
public class Callback_0411_WC_LANDROVER extends CallbackCanbusBase {
    public static final int U_CARINF_D61_D0_B40 = 96;
    public static final int U_CNT_MAX = 97;
    public static final int U_CUR_SPEED = 95;
    public static final int U_ENGINE_SPEED = 94;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0411_WC_LandRover(TheApp.getInstance()));
        DoorHelper.getInstance().buildUi();
        for (int i2 = 0; i2 < 6; i2++) {
            DataCanbus.NOTIFY_EVENTS[i2].addNotify(DoorHelper.getInstance(), 0);
        }
        for (int i3 = 10; i3 < 92; i3++) {

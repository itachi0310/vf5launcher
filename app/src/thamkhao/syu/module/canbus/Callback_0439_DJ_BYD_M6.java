...
public class Callback_0439_DJ_BYD_M6 extends CallbackCanbusBase {
    ...
    public static final int U_CARINFO_DOOR_EC = 94;
    public static final int U_CARINFO_REMOTE_WINDOW = 95;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0439_Daojun_BydM6(TheApp.getInstance()));

...
public class Callback_0393_RZC3_16_QiYaKX5 extends CallbackCanbusBase {
    ...
    public static final int U_BLIND_SPOTS = 95;
    public static final int U_CLIMATE = 94;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0393_RZC_16_QiYaKX5(TheApp.getInstance()));
        ...
        DataCanbus.NOTIFY_EVENTS[94].addNotify(AirHelper.SHOW_AND_REFRESH, 0);
    }

...
import com.syu.ui.air.Air_0357_WC2_MaiRuiBao16;
import com.syu.ui.door.DoorHelper;

/* JADX INFO: loaded from: classes.dex */
public class Callback_0357_WC2_MaiRuiBao16 extends CallbackCanbusBase {
    public static final int U_24GHZ_RADAR_SET = 19;
    public static final int U_AIR_AC_ON = 72;
    public static final int U_AIR_AIR_QULITY = 73;
    public static final int U_AIR_AMB = 93;
    public static final int U_AIR_AQS = 88;
    public static final int U_AIR_BEGIN = 71;
    public static final int U_AIR_BLOW_AUTO_LEFT = 79;
    public static final int U_AIR_BLOW_AUTO_REAR = 83;
    public static final int U_AIR_BLOW_BODY_LEFT = 77;
    public static final int U_AIR_BLOW_BODY_REAR = 84;
    public static final int U_AIR_BLOW_FOOT_LEFT = 78;
    public static final int U_AIR_BLOW_FOOT_REAR = 85;
    public static final int U_AIR_BLOW_UP_LEFT = 76;
    public static final int U_AIR_BLOW_WIN_LEFT = 94;
    public static final int U_AIR_CYCLE_TYPE = 74;
    public static final int U_AIR_END = 95;
    public static final int U_AIR_FRONT_DEFROST = 75;
    ...
    public static final int U_AIR_REAR_DEFROST = 89;
    public static final int U_AIR_SEAT_LEFT = 90;
    public static final int U_AIR_SEAT_RIGHT = 91;
    public static final int U_AIR_SYNC = 92;
    public static final int U_AIR_TEMP_LEFT = 81;
    public static final int U_AIR_TEMP_LEFT_REAR = 86;
    public static final int U_AIR_TEMP_RIGHT = 82;
    public static final int U_AIR_WIND_LEVEL_LEFT = 80;
    public static final int U_AIR_WIND_LEVEL_REAR = 87;
    ...
    public static final int U_DOOR_BACK = 106;
    public static final int U_DOOR_BEGIN = 101;
    public static final int U_DOOR_END = 107;
    public static final int U_DOOR_ENGINE = 101;
    public static final int U_DOOR_FL = 102;
    public static final int U_DOOR_FR = 103;
    public static final int U_DOOR_RL = 104;
    public static final int U_DOOR_RR = 105;
    ...
    public static final int U_SETTING_ASSIST = 108;
    ...
    public void in() {
        ...
        DoorHelper.sUcDoorEngine = 101;
        DoorHelper.sUcDoorFl = 102;
        DoorHelper.sUcDoorFr = 103;
        DoorHelper.sUcDoorRl = 104;
        DoorHelper.sUcDoorRr = 105;
        DoorHelper.sUcDoorBack = 106;
        AirHelper.getInstance().buildUi(new Air_0357_WC2_MaiRuiBao16(TheApp.getInstance()));
        DoorHelper.getInstance().buildUi();
        for (int i2 = 101; i2 < 107; i2++) {
            DataCanbus.NOTIFY_EVENTS[i2].addNotify(DoorHelper.getInstance(), 0);
        }
        for (int i3 = 71; i3 < 95; i3++) {

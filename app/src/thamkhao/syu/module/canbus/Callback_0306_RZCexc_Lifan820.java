...
public class Callback_0306_RZCexc_Lifan820 extends CallbackCanbusBase {
    ...
    public static final int U_CAR_CAMERA_MODE = 96;
    public static final int U_CNT_MAX = 97;
    public static final int U_SET_RADAR_ON_OFF = 95;
    public static final int U_SET_WARN_VOL = 94;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0306_WC2_RZC_LiFan820(TheApp.getInstance()));

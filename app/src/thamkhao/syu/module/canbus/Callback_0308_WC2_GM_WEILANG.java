...
import com.syu.ui.air.Air_0308_WC2_15WEILANG;
import com.syu.ui.door.DoorHelper;

/* JADX INFO: loaded from: classes.dex */
public class Callback_0308_WC2_GM_WEILANG extends CallbackCanbusBase {
    ...
    public static final int U_AIR_BLOW_FRONT_MODE = 107;
    public static final int U_AIR_BLOW_REAR_MODE = 108;
    ...
    public static final int U_AIR_SEAT_HEAT_LEFT = 100;
    public static final int U_AIR_SEAT_HEAT_LEVEL_LEFT = 102;
    public static final int U_AIR_SEAT_HEAT_LEVEL_RIGHT = 103;
    public static final int U_AIR_SEAT_HEAT_RIGHT = 101;
    public static final int U_AIR_SYNC_ON = 104;
    ...
    public static final int U_AUTO_CRUISE_CONTROL = 106;
    ...
    public static final int U_SETTING_ASSIST = 105;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0308_WC2_15WEILANG(TheApp.getInstance()));

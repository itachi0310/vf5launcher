...
public class Callback_0372_WC1_Jeep_ZiYouGuang extends CallbackCanbusBase {
    ...
    public static final int U_PRESSURE_FL = 155;
    public static final int U_PRESSURE_FR = 156;
    public static final int U_PRESSURE_RL = 157;
    public static final int U_PRESSURE_RR = 158;
    ...
    public static final int U_TIRE_WARN = 154;

...
public class Callback_0439_DJ_LEXUS_ES extends CallbackCanbusBase {
    public static final int U_CAR_CD1_STATE = 122;
    public static final int U_CAR_CD2_STATE = 123;
    public static final int U_CAR_CD3_STATE = 124;
    public static final int U_CAR_CD4_STATE = 125;
    public static final int U_CAR_CD5_STATE = 126;
    public static final int U_CAR_CD6_STATE = 127;
    public static final int U_CAR_CD_ASL = 112;
    public static final int U_CAR_CD_BAN = 117;
    public static final int U_CAR_CD_BASS = 113;
    public static final int U_CAR_CD_DISC_RANDOM = 109;
    public static final int U_CAR_CD_DISC_REPEAT = 108;
    public static final int U_CAR_CD_FAD = 116;
    public static final int U_CAR_CD_MID = 114;
    ...
    public static final int U_CAR_CD_TREB = 115;
    public static final int U_CAR_CD_VOL = 118;
    public static final int U_CAR_JUMP_CD = 120;
    public static final int U_CAR_JUMP_RADIO = 121;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0439_DJ_LEXUS_ES(TheApp.getInstance()));

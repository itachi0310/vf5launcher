...
public class Callback_0290_RZC_QICHENG_T90 extends CallbackCanbusBase {
    ...
    public void in() {
        ...
        if (DataCanbus.DATA[1000] == 721186) {
            AirHelper.getInstance().buildUi(new Air_0290_RZC_Qichen_21_T90(TheApp.getInstance()));
        } else {
            AirHelper.getInstance().buildUi(new Air_0290_RZC_QiChenT90(TheApp.getInstance()));
        }

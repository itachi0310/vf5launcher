...
public class Callback_0042_WC2_ACCORD9_Lo extends CallbackCanbusBase {
    ...
    public static final int U_AVERAGE_SPEED = 116;
    public static final int U_BRIGHT_VALUE = 126;
    public static final int U_CAR_CAMERA_MODE = 130;
    public static final int U_CAR_RIGHT_CAMERA_STATUS = 129;
    public static final int U_CLOSE_BIGLAMP_TIME = 120;
    public static final int U_CLOSE_INSIDELAMP_TIME = 121;
    public static final int U_CNT_MAX = 132;
    public static final int U_CONTAST_VALUE = 128;
    public static final int U_CURRENT_SPEED = 117;
    public static final int U_DAYTIME_RUNING_LIGHTS_ON = 123;
    public static final int U_LAST_MILEAGE_BY_TYPE = 125;
    public static final int U_LOCK_UNLOCK_FEEDBACK_TONE = 119;
    public static final int U_MISC_BEGIN = 94;
    public static final int U_OPEN_BIGLAMP_BY_WIPER = 122;
    public static final int U_SENSITIVITY_OPEN_BIGLAMP = 124;
    public static final int U_SET_ENABLE_BACKVIDEO = 131;
    public static final int U_SMARTLOCK_AND_ONE_KEY_BOOT = 118;
    public static final int U_STATUR_VALUE = 127;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0042_WC2_Accord9(TheApp.getInstance()));

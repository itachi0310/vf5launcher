...
public class Callback_0428_XP_BiaoZhi206 extends CallbackCanbusBase {
    public static final int U_AVERAGE_OIL_EXPEND = 99;
    public static final int U_AVERAGE_SPEED = 94;
    public static final int U_CARINFO = 100;
    ...
    public static final int U_TRIP_MILES = 97;
    private String str = "";
    private Runnable mRunn = new Runnable() { // from class: com.syu.module.canbus.Callback_0428_XP_BiaoZhi206.1
        ...
        public void run() {
            if (!TextUtils.isEmpty(Callback_0428_XP_BiaoZhi206.this.str)) {
                ToastInfo.showToast(TheApp.getInstance().getApplicationContext(), Callback_0428_XP_BiaoZhi206.this.str);
            }
        }
    };

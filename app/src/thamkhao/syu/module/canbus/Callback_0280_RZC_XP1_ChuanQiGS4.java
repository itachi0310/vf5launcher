...
public class Callback_0280_RZC_XP1_ChuanQiGS4 extends CallbackCanbusBase {
    ...
    public static final int U_CARSET_ADD_D52_D35 = 118;
    public static final int U_CARSET_ADD_D52_D36 = 119;
    public static final int U_CARSET_ADD_D52_D37 = 120;
    public static final int U_CARSET_ADD_D52_D38 = 121;
    public static final int U_CARSET_ADD_D52_D39 = 122;
    public static final int U_CARSET_ADD_D52_D3A = 123;
    public static final int U_CARSET_ADD_D52_D3B = 124;
    public static final int U_CARSET_ADD_D52_D3C = 125;
    public static final int U_CARSET_ADD_D55_D01 = 126;
    public static final int U_CARSET_ADD_D55_D02 = 127;
    public static final int U_CARSET_ADD_D55_D03 = 128;
    public static final int U_CARSET_ADD_D55_D04 = 129;
    public static final int U_CARSET_ADD_D55_D05 = 130;
    public static final int U_CARSET_ADD_D55_D06 = 131;
    public static final int U_CARSET_ADD_D55_D07 = 132;
    public static final int U_CARSET_ADD_D55_D08 = 133;
    public static final int U_CARSET_ADD_D58_D01 = 134;
    public static final int U_CARSET_ADD_D58_D02 = 135;
    public static final int U_CARSET_ADD_D58_D03 = 136;
    public static final int U_CARSET_ADD_D58_D04 = 137;
    public static final int U_CARSET_ADD_D58_D05 = 138;
    public static final int U_CARSET_ADD_D58_D06 = 139;
    public static final int U_CARSET_ADD_D58_D07 = 140;
    public static final int U_CARSET_ADD_D58_D08 = 141;
    ...
    public static final int U_CAR_ENERGY_OD_D53_D10_B70 = 146;
    public static final int U_CAR_ENERGY_OD_D53_D9_B10 = 145;
    public static final int U_CAR_ENERGY_OD_D53_D9_B4 = 144;
    public static final int U_CAR_ENERGY_OD_D53_D9_B5 = 143;
    public static final int U_CAR_ENERGY_OD_D53_D9_B6 = 142;
    ...
    public void in() {
        ...
        if (DataCanbus.DATA[1000] == 262424 || DataCanbus.DATA[1000] == 459032 || DataCanbus.DATA[1000] == 524568 || DataCanbus.DATA[1000] == 1311000 || DataCanbus.DATA[1000] == 1245464 || DataCanbus.DATA[1000] == 1835288) {
            AirHelper.getInstance().buildUi(new Air_0280_RZC_GS8(TheApp.getInstance()));
            for (int i3 = 30; i3 < 38; i3++) {
                DataCanbus.NOTIFY_EVENTS[i3].addNotify(AirHelper.SHOW_AND_REFRESH, 0);
            }
        } else {
            AirHelper.getInstance().buildUi(new Air_0280_RZC_XP1_ChuangQiGs4(TheApp.getInstance()));
        }

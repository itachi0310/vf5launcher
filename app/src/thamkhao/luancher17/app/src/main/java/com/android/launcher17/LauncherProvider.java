...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.android.launcher17.settings";
    static final Uri CONTENT_APPWIDGET_RESET_URI = Uri.parse("content://com.android.launcher17.settings/appWidgetReset");
    ...
    static final String OLD_AUTHORITY = "com.android.launcher17.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            ContentValuesCallback permuteScreensCb = new ContentValuesCallback() { // from class: com.android.launcher17.LauncherProvider.DatabaseHelper.1
                @Override // com.android.launcher17.LauncherProvider.ContentValuesCallback
        ...
        /* JADX WARN: Code duplicated, block: B:48:0x013b A[FINALLY_INSNS] */
        private boolean updateContactsShortcuts(SQLiteDatabase db) {
            ...
            db.beginTransaction();
            try {
                c = db.query(TAG_FAVORITES, new String[]{"_id", "intent"}, selectWhere, null, null, null, null);
                if (c == null) {
                    return false;
                }
                            ...
                            if (uri != null) {
                                ...
                                if ("android.intent.action.VIEW".equals(intent.getAction()) || "com.android.contacts.action.QUICK_CONTACT".equals(intent.getAction())) {
                                    if (data.startsWith("content://contacts/people/") || data.startsWith("content://com.android.contacts/contacts/lookup/")) {
                                        ...
                                        newIntent.putExtra("com.android.launcher17.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION", true);
                ...
                while (true) {
                    ...
                    if (type == 2) {
                        ...
                        if (TAG_INCLUDE.equals(name)) {
                            ...
                            long container = -100;
                            if (a2.hasValue(2)) {
                                container = Long.valueOf(a2.getString(2)).longValue();
                            }
                            String screen = a2.getString(3);
                            String x = a2.getString(4);
                            String y = a2.getString(5);
                            values.clear();
        ...
        private ComponentName getSearchWidgetProvider() {
            SearchManager searchManager = (SearchManager) this.mContext.getSystemService(TAG_SEARCH);

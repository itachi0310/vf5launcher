...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY, int left, int top, int width, int height, final float initialScale) {
        ...
        this.mAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.DragView.1
    ...
    public void crossFade(int duration) {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.DragView.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator animation) {
    ...
    public void show(int touchX, int touchY) {
        ...
        post(new Runnable() { // from class: com.android.launcher17.DragView.3

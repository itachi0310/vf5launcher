...
public class AllAppsList {
    ...
    public void removePackage(String packageName) {
        ...
        for (int i = data2.size() - 1; i >= 0; i--) {
            ...
            if (RechargeDialogFragment.RechargePackageName != null && packageName.equals(RechargeDialogFragment.RechargePackageName)) {
                RechargeDialogFragment.RechargePackageName = null;
                SharedPreferences sPreferences = LauncherApplication.sApp.getSharedPreferences(RechargeDialogFragment.SHARED_NAME, 0);
                SharedPreferences.Editor editor = sPreferences.edit();
                editor.putString(RechargeDialogFragment.SHARED_KEY, null);
                editor.commit();
            }
        }

...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener, View.OnLongClickListener, DropTarget, FolderInfo.FolderListener, TextView.OnEditorActionListener, View.OnFocusChangeListener {
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        this.mActionModeCallback = new ActionMode.Callback() { // from class: com.android.launcher17.Folder.1
        ...
        this.mReorderAlarmListener = new OnAlarmListener() { // from class: com.android.launcher17.Folder.2
        ...
        this.mOnExitAlarmListener = new OnAlarmListener() { // from class: com.android.launcher17.Folder.3
            @Override // com.android.launcher17.OnAlarmListener
            public void onAlarm(Alarm alarm) {
    ...
    public void animateOpen() {
        ...
        if (getParent() instanceof DragLayer) {
            ...
            oa.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.Folder.4
    ...
    public void animateClosed() {
        if (getParent() instanceof DragLayer) {
            ...
            ObjectAnimator oa = LauncherAnimUtils.ofPropertyValuesHolder(this, alpha, scaleX, scaleY);
            oa.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.Folder.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
    ...
    public void onDropCompleted(final View target, final DropTarget.DragObject d, final boolean isFlingToDelete, final boolean success) {
        if (this.mDeferDropAfterUninstall) {
            ...
            this.mDeferredAction = new Runnable() { // from class: com.android.launcher17.Folder.6
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int width = getPaddingLeft() + getPaddingRight() + this.mContent.getDesiredWidth();
        int height = getFolderHeight();
        int contentAreaWidthSpec = View.MeasureSpec.makeMeasureSpec(this.mContent.getDesiredWidth(), 1073741824);
        int contentAreaHeightSpec = View.MeasureSpec.makeMeasureSpec(getContentAreaHeight(), 1073741824);
        ...
        this.mFolderName.measure(contentAreaWidthSpec, View.MeasureSpec.makeMeasureSpec(this.mFolderNameHeight, 1073741824));
    ...
    private void replaceFolderWithFinalItem() {
        Runnable onCompleteRunnable = new Runnable() { // from class: com.android.launcher17.Folder.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    @Override // com.android.launcher17.FolderInfo.FolderListener

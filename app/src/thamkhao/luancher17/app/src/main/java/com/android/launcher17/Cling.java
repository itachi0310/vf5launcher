...
public class Cling extends FrameLayout implements Insettable, View.OnClickListener, View.OnLongClickListener, View.OnTouchListener {
    ...
    void show(boolean animate, int duration) {
        ...
        post(new Runnable() { // from class: com.android.launcher17.Cling.1
    ...
    void hide(int duration, final Runnable postCb) {
        if (this.mDrawIdentifier.equals(FIRST_RUN_PORTRAIT) || this.mDrawIdentifier.equals(FIRST_RUN_LANDSCAPE)) {
            View content = getContent();
            content.animate().alpha(0.0f).setDuration(duration).setListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.Cling.2
            ...
            animate().alpha(0.0f).setDuration(duration).setListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.Cling.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    Cling.this.setVisibility(8);
                    postCb.run();
        ...
        if (this.mScrimView != null) {
            this.mScrimView.animate().alpha(0.0f).setDuration(duration).setListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.Cling.4
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {

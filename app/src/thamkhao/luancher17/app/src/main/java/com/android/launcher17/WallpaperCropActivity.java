...
public class WallpaperCropActivity extends Activity {
    ...
    protected void init() {
        ...
        actionBar.getCustomView().setOnClickListener(new View.OnClickListener() { // from class: com.android.launcher17.WallpaperCropActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                WallpaperCropActivity.this.cropImageAndSetWallpaper(imageUri, (OnBitmapCroppedHandler) null, true);
            }
        });
    }
    ...
    protected void setWallpaper(String filePath, final boolean finishActivityWhenDone) {
        ...
        Runnable onEndCrop = new Runnable() { // from class: com.android.launcher17.WallpaperCropActivity.2
    ...
    protected void cropImageAndSetWallpaper(Resources res, int resId, final boolean finishActivityWhenDone) {
        ...
        Runnable onEndCrop = new Runnable() { // from class: com.android.launcher17.WallpaperCropActivity.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    protected void cropImageAndSetWallpaper(Uri uri, OnBitmapCroppedHandler onBitmapCroppedHandler, final boolean finishActivityWhenDone) {
        ...
        Runnable onEndCrop = new Runnable() { // from class: com.android.launcher17.WallpaperCropActivity.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [com.android.launcher17.WallpaperCropActivity$5] */
    public static void suggestWallpaperDimension(Resources res, final SharedPreferences sharedPrefs, WindowManager windowManager, final WallpaperManager wallpaperManager) {
        ...
        new Thread("suggestWallpaperDimension") { // from class: com.android.launcher17.WallpaperCropActivity.5

...
public class FirstFrameAnimatorHelper extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
    ...
    public static void initializeDrawListener(View view) {
        ...
        sGlobalDrawListener = new ViewTreeObserver.OnDrawListener() { // from class: com.android.launcher17.FirstFrameAnimatorHelper.1
    ...
    public void onAnimationUpdate(final ValueAnimator animation) {
        ...
        if (!this.mHandlingOnAnimationUpdate && sVisible && animation.getCurrentPlayTime() < animation.getDuration()) {
            ...
            if (frameNum == 0 && currentTime < this.mStartTime + 1000) {
                ...
                this.mTarget.post(new Runnable() { // from class: com.android.launcher17.FirstFrameAnimatorHelper.2
    ...
    public void print(ValueAnimator animation) {
        float flatFraction = animation.getCurrentPlayTime() / animation.getDuration();

...
class DeviceProfile {
    ...
    private float invDistWeightedInterpolate(float width, float height, ArrayList<DeviceProfileQuery> points) {
        ...
        Collections.sort(points, new Comparator<DeviceProfileQuery>() { // from class: com.android.launcher17.DeviceProfile.1

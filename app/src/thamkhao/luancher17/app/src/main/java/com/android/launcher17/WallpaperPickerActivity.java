...
public class WallpaperPickerActivity extends WallpaperCropActivity {
    ...
    public static class UriWallpaperInfo extends WallpaperTileInfo {
        ...
        public void onSave(final WallpaperPickerActivity a) {
            WallpaperCropActivity.OnBitmapCroppedHandler h = new WallpaperCropActivity.OnBitmapCroppedHandler() { // from class: com.android.launcher17.WallpaperPickerActivity.UriWallpaperInfo.1
                @Override // com.android.launcher17.WallpaperCropActivity.OnBitmapCroppedHandler
    ...
    public static class ResourceWallpaperInfo extends WallpaperTileInfo {
        ...
        @Override // com.android.launcher17.WallpaperPickerActivity.WallpaperTileInfo
        public void onSave(WallpaperPickerActivity a) {
            a.cropImageAndSetWallpaper(this.mResources, this.mResId, true);
        }
    ...
    @Override // com.android.launcher17.WallpaperCropActivity, android.app.Activity
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (sv != null) {
            ...
            sv.setVisibility(this.mliveWallpaper == 1 ? 8 : 0);
        }
        if (v != null) {
            Log.e("TAAA", "onNewIntent mliveWallpaper 22== " + this.mliveWallpaper);
            v.setVisibility(this.mliveWallpaper != 0 ? 0 : 8);
        }
    }
    ...
    @Override // com.android.launcher17.WallpaperCropActivity
    protected void init() {
        setContentView(R.layout.wallpaper_picker);
        this.mCropView = (CropView) findViewById(R.id.cropView);
        this.mWallpaperStrip = findViewById(R.id.wallpaper_strip);
        this.mCropView.setTouchCallback(new CropView.TouchCallback() { // from class: com.android.launcher17.WallpaperPickerActivity.1
            LauncherViewPropertyAnimator mAnim;

            @Override // com.android.launcher17.CropView.TouchCallback
            public void onTouchDown() {
                ...
                this.mAnim.alpha(0.0f).setDuration(150L).addListener(new Animator.AnimatorListener() { // from class: com.android.launcher17.WallpaperPickerActivity.1.1
        ...
        this.mThumbnailOnClickListener = new View.OnClickListener() { // from class: com.android.launcher17.WallpaperPickerActivity.2
        ...
        this.mLongClickListener = new View.OnLongClickListener() { // from class: com.android.launcher17.WallpaperPickerActivity.3
        ...
        a.registerDataSetObserver(new DataSetObserver() { // from class: com.android.launcher17.WallpaperPickerActivity.4
        ...
        this.mWallpapersView.setVisibility(this.mliveWallpaper == 1 ? 8 : 0);
        liveWallpapersView.setVisibility(this.mliveWallpaper == 0 ? 8 : 0);
        ...
        if (LauncherApplication.sApp.getResources().getBoolean(R.bool.apps_set_wallpaper)) {
            ...
            if (wallpaperSetView != null) {
                wallpaperSetView.setOnClickListener(new View.OnClickListener() { // from class: com.android.launcher17.WallpaperPickerActivity.5
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        if (WallpaperPickerActivity.this.mSelectedThumb != null) {
            ...
            if (actionBar.getCustomView() != null) {
                actionBar.getCustomView().setOnClickListener(new View.OnClickListener() { // from class: com.android.launcher17.WallpaperPickerActivity.6
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        if (WallpaperPickerActivity.this.mSelectedThumb != null) {
                            WallpaperTileInfo info = (WallpaperTileInfo) WallpaperPickerActivity.this.mSelectedThumb.getTag();
        ...
        this.mActionModeCallback = new ActionMode.Callback() { // from class: com.android.launcher17.WallpaperPickerActivity.7
    ...
    private ArrayList<ResourceWallpaperInfo> addWallpapers(Resources res, String packageName, int listResId) {
        ...
        for (String extra : extras) {
            ...
            if (resId != 0) {
                int thumbRes = res.getIdentifier(String.valueOf(extra) + "_small", "drawable", packageName);
                if (thumbRes != 0) {

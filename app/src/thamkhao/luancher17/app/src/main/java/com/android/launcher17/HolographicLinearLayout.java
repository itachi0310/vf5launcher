...
public class HolographicLinearLayout extends LinearLayout {
    ...
    public HolographicLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mHotwordOn = a.getBoolean(1, false);
        a.recycle();
        setWillNotDraw(false);
        this.mHolographicHelper = new HolographicViewHelper(context);
        setOnTouchListener(new View.OnTouchListener() { // from class: com.android.launcher17.HolographicLinearLayout.1
        ...
        setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.android.launcher17.HolographicLinearLayout.2

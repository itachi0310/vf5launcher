...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:libs/android-support-v4.jar:android/support/v4/animation/DonutAnimatorCompatProvider.class
  classes.dex
 */
...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:libs/android-support-v4.jar:android/support/v4/animation/DonutAnimatorCompatProvider$DonutFloatValueAnimator.class
  classes.dex
 */

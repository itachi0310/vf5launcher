...
public class TiledImageRenderer {
    ...
    private final TileQueue mUploadQueue = new TileQueue(0 == true ? 1 : 0);
    private final TileQueue mDecodeQueue = new TileQueue(0 == true ? 1 : 0);
    protected int mImageWidth = -1;
    protected int mImageHeight = -1;
    private final Rect mTileRange = new Rect();
    private final Rect[] mActiveRange = {new Rect(), new Rect()};
    private TileDecoder mTileDecoder = new TileDecoder(this, 0 == true ? 1 : 0);
    ...
    private class Tile extends UploadedTexture {
        ...
        boolean decode() {
            try {
                Bitmap reuse = (Bitmap) TiledImageRenderer.sTilePool.acquire();
                ...
                Log.w(TiledImageRenderer.TAG, "fail to decode tile", t);
            }
    ...
    private static class TileQueue {
        ...
        /* synthetic */ TileQueue(TileQueue tileQueue) {
            this();
        }
        ...
        public boolean push(Tile tile) {
            ...
            if (contains(tile)) {
                Log.w(TiledImageRenderer.TAG, "Attempting to add a tile already in the queue!");
            } else {
                wasEmpty = this.mHead == null;
    ...
    private class TileDecoder extends Thread {
        ...
        /* synthetic */ TileDecoder(TiledImageRenderer tiledImageRenderer, TileDecoder tileDecoder) {
            this();
        }
        ...
        public void finishAndWait() {
            ...
            try {
                ...
                Log.w(TiledImageRenderer.TAG, "Interrupted while waiting for TileDecoder thread to finish!");
            }
        }

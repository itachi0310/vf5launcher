...
public class HolographicImageView extends ImageView {
    ...
    public HolographicImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        a.recycle();
        setOnTouchListener(new View.OnTouchListener() { // from class: com.android.launcher17.HolographicImageView.1
        ...
        setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.android.launcher17.HolographicImageView.2

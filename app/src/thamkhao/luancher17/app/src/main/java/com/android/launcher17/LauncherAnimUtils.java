...
public class LauncherAnimUtils {
    ...
    static Animator.AnimatorListener sEndAnimListener = new Animator.AnimatorListener() { // from class: com.android.launcher17.LauncherAnimUtils.1
    ...
    public static void startAnimationAfterNextDraw(final Animator animator, final View view) {
        view.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver.OnDrawListener() { // from class: com.android.launcher17.LauncherAnimUtils.2
            ...
            public void onDraw() {
                if (!this.mStarted) {
                    ...
                    if (animator.getDuration() != 0) {
                        ...
                        view2.post(new Runnable() { // from class: com.android.launcher17.LauncherAnimUtils.2.1

...
public class MemoryTracker extends Service {
    public static final String ACTION_START_TRACKING = "com.android.launcher17.action.START_TRACKING";
    ...
    Handler mHandler = new Handler() { // from class: com.android.launcher17.MemoryTracker.1

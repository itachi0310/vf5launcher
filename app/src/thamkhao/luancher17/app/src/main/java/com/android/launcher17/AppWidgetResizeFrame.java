...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    public void onTouchUp() {
        ...
        this.mDeltaX = 0;
        this.mDeltaY = 0;
        post(new Runnable() { // from class: com.android.launcher17.AppWidgetResizeFrame.1
    ...
    public void snapToWidget(boolean animate) {
        ...
        oa.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.AppWidgetResizeFrame.2

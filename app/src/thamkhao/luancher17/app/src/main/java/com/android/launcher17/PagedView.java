...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mPageIndicatorViewId = a.getResourceId(7, -1);
        a.recycle();
    ...
    public void scrollTo(int x, int y) {
        boolean isXBeforeFirstPage;
        boolean isXAfterLastPage;
        if (this.mFreeScroll) {
        ...
        if (isRtl) {
            isXBeforeFirstPage = x > this.mMaxScrollX;
        } else {
            isXBeforeFirstPage = x < 0;
        }
        if (isRtl) {
            isXAfterLastPage = x < 0;
        } else {
            isXAfterLastPage = x > this.mMaxScrollX;
        }
    ...
    protected boolean shouldDrawChild(View child) {
        return child.getAlpha() > 0.0f && child.getVisibility() == 0;
    }
    ...
    protected boolean hitsPreviousPage(float x, float y) {
        ...
        if (isLayoutRtl()) {
            return x > ((float) (((getViewportOffsetX() + getViewportWidth()) - offset) + this.mPageSpacing));
        }
        return x < ((float) ((getViewportOffsetX() + offset) - this.mPageSpacing));
    }
                ...
                if (this.mTouchState == 1) {
                    ...
                    if (pageUnderPointIndex > -1 && pageUnderPointIndex != indexOfChild(this.mDragView) && !isHoveringOverDelete) {
                        ...
                        if (this.mTempVisiblePagesRange[0] <= pageUnderPointIndex && pageUnderPointIndex <= this.mTempVisiblePagesRange[1] && pageUnderPointIndex != this.mSidePageHoverIndex && this.mScroller.isFinished()) {
                            ...
                            this.mSidePageHoverRunnable = new Runnable() { // from class: com.android.launcher17.PagedView.1
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.android.launcher17.PagedView.SavedState.1
    ...
    void animateDragViewToOriginalPosition() {
        if (this.mDragView != null) {
            ...
            anim.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.PagedView.2
    ...
    void endReordering() {
        if (this.mReorderingStarted) {
            this.mReorderingStarted = false;
            final Runnable onCompleteRunnable = new Runnable() { // from class: com.android.launcher17.PagedView.3
                @Override // java.lang.Runnable
                public void run() {
            ...
            if (!this.mDeferringForDelete) {
                this.mPostReorderingPreZoomInRunnable = new Runnable() { // from class: com.android.launcher17.PagedView.4
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    private static class FlingAlongVectorAnimatorUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            rect.left = (int) (rect.left + ((this.mVelocity.x * (curTime - this.mPrevTime)) / 1000.0f));
            Rect rect2 = this.mFrom;
            rect2.top = (int) (rect2.top + ((this.mVelocity.y * (curTime - this.mPrevTime)) / 1000.0f));
    ...
    private Runnable createPostDeleteAnimationRunnable(final View dragView) {
        return new Runnable() { // from class: com.android.launcher17.PagedView.5
            @Override // java.lang.Runnable
            public void run() {
                int oldX;
                int newX;
                ...
                slideAnimations.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.PagedView.5.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animation) {
    ...
    public void onFlingToDelete(PointF vel) {
        ...
        TimeInterpolator tInterpolator = new TimeInterpolator(startTime) { // from class: com.android.launcher17.PagedView.6
        ...
        mDropAnim.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.PagedView.7
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
    ...
    private void onDropToDelete() {
        ...
        anim.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.PagedView.8
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                onAnimationEndRunnable.run();
            }

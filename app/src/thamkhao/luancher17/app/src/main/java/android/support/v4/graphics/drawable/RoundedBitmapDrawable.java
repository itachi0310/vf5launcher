...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:libs/android-support-v4.jar:android/support/v4/graphics/drawable/RoundedBitmapDrawable.class
  classes.dex
 */
...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    private int mGravity = FinalCanbus.CAR_RZC3_ZYC_IX35;
    ...
    public void setTargetDensity(int density) {
        if (this.mTargetDensity != density) {
            if (density == 0) {
                density = FinalCanbus.CAR_RZC_XP1_DaZhong_GaoErFu7;
            }
    ...
    RoundedBitmapDrawable(Resources res, Bitmap bitmap) {
        this.mTargetDensity = FinalCanbus.CAR_RZC_XP1_DaZhong_GaoErFu7;
        if (res != null) {

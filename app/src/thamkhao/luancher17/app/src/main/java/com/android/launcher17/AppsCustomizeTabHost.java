...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable, TabHost.OnTabChangeListener, Insettable {
    ...
    public AppsCustomizeTabHost(Context context, AttributeSet attrs) {
        ...
        this.mRelayoutAndMakeVisible = new Runnable() { // from class: com.android.launcher17.AppsCustomizeTabHost.1
    ...
    protected void onFinishInflate() {
        ...
        TabHost.TabContentFactory contentFactory = new TabHost.TabContentFactory() { // from class: com.android.launcher17.AppsCustomizeTabHost.2
    ...
    public void onTabChanged(String tabId) {
        ...
        post(new Runnable() { // from class: com.android.launcher17.AppsCustomizeTabHost.3
            @Override // java.lang.Runnable
            public void run() {
                ...
                outAnim.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.AppsCustomizeTabHost.3.1
                ...
                inAnim.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.AppsCustomizeTabHost.3.2
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animation) {
                        AppsCustomizeTabHost.this.reloadCurrentPage();
                    }
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (child != this) {
                        if (Launcher.getLauncher().mHotseat != child || LauncherApplication.sApp.getResources().getBoolean(R.bool.apps_hotseat_hide)) {
                            if (child.getVisibility() != 8 && child != overviewPanel) {
    ...
    void alphaAnmi() {
        ...
        bgAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.AppsCustomizeTabHost.4

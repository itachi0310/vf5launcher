...
public class FolderIcon extends LinearLayout implements FolderInfo.FolderListener {
    ...
    public static class FolderRingAnimator {
        ...
        public void animateToAcceptState() {
            ...
            this.mAcceptAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.FolderIcon.FolderRingAnimator.1
            ...
            this.mAcceptAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.FolderIcon.FolderRingAnimator.2
        ...
        public void animateToNaturalState() {
            ...
            final int previewSize = sPreviewSize;
            this.mNeutralAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.FolderIcon.FolderRingAnimator.3
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator animation) {
                    float percent = ((Float) animation.getAnimatedValue()).floatValue();
            ...
            this.mNeutralAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.FolderIcon.FolderRingAnimator.4
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    private void onDrop(final ShortcutInfo item, DragView animateView, Rect finalRect, float scaleRelativeToDragLayer, int index, Runnable postAnimationRunnable, DropTarget.DragObject d) {
        ...
        if (animateView != null) {
            ...
            postDelayed(new Runnable() { // from class: com.android.launcher17.FolderIcon.1
    ...
    private void animateFirstItem(Drawable d, int duration, final boolean reverse, final Runnable onCompleteRunnable) {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher17.FolderIcon.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        va.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher17.FolderIcon.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animation) {

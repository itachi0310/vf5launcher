...
public class Hotseat extends FrameLayout {
    ...
    void addDefultIcon(int icon, final String pkg, int index) {
        ...
        newBtn.setOnClickListener(new View.OnClickListener() { // from class: com.android.launcher17.Hotseat.1
    ...
    void addDefultIcon(int icon, int title, int index) {
        ...
        newBtn.setOnClickListener(new View.OnClickListener() { // from class: com.android.launcher17.Hotseat.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                if (Hotseat.this.mLauncher != null) {
    ...
    Intent findIntentFromPackage(String pkg) {
        ...
        mainIntent2.setFlags(270532608);

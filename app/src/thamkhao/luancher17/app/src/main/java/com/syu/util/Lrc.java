...
public class Lrc {
    ...
    public Id3Info getId3Info(String strFile) throws Throwable {
    ...
    void GetId3v2_APIC(String strFile, Id3Info id3Info) throws Throwable {
        ...
        try {
            try {
                RandomAccessFile randomFile2 = new RandomAccessFile(strFile, "r");
                try {
                    ReadID3v2_APIC(randomFile2, id3Info);
                    if (randomFile2 != null) {
                        try {
                            randomFile2.close();
            ...
            if (tmp[0] == 0) {
                ...
                if (tmp[0] == 0) {
                    ...
                    if (nReadByte == 10 && IsValidFrameV23(fhV23) && (nFrameLength = getInt_way2(fhV23, 4)) >= 0 && nFrameLength <= length) {
                        byte[] iEncode = {0};
                        long dwPosNext = randomFile.getFilePointer() + ((long) nFrameLength);
    ...
    boolean GetId3v1Info(String strFile, Id3Info id3Info) throws Throwable {
        ...
        try {
            try {
                RandomAccessFile randomFile2 = new RandomAccessFile(strFile, "r");
                try {
                    bSucc = ReadID3v1(randomFile2, id3Info);
                    if (randomFile2 != null) {
                        try {
                            randomFile2.close();
                            randomFile = randomFile2;
    ...
    boolean ReadAPEv2(RandomAccessFile randomFile, Id3Info id3Info) throws IOException {
        ...
        randomFile.seek(randomFile.length() - ((long) nOffset));
        ...
        randomFile.seek(randomFile.length() - ((long) (nFieldSize + nOffset)));
    ...
    public boolean GetAPEv2Info(String strFile, Id3Info id3Info) throws Throwable {
        ...
        try {
            try {
                RandomAccessFile randomFile2 = new RandomAccessFile(strFile, "r");
                try {
                    bSucc = ReadAPEv2(randomFile2, id3Info);
                    if (randomFile2 != null) {
                        try {
                            randomFile2.close();
                            randomFile = randomFile2;
    ...
    boolean GetId3v2Info(String strFile, Id3Info id3Info) throws Throwable {
        ...
        try {
            try {
                RandomAccessFile randomFile2 = new RandomAccessFile(strFile, "r");
                try {
                    bSucc = ReadID3v2(randomFile2, id3Info);
                    if (randomFile2 != null) {
                        try {
                            randomFile2.close();
                            randomFile = randomFile2;
    ...
    String ReadAsciiText(RandomAccessFile randomFile, int iLenMax, int[] iLenActual, int iEncode, boolean bDetectEncode) throws IOException {
        ...
        randomFile.seek(randomFile.getFilePointer() + ((long) iLenTemp));
    ...
    public void ParseFields(RandomAccessFile randomFile, int nFieldsSize, int nFieldsNum, Id3Info id3Info) throws IOException {
        ...
        for (int i = 0; i < nFieldsNum && nFieldsSize > 10; i++) {
            ...
            if (strName != null) {
                randomFile.seek(randomFile.getFilePointer() - ((long) (nFieldsSize2 - len[0])));

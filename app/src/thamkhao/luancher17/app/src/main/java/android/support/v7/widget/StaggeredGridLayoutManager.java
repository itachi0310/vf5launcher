...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec, boolean alreadyMeasured) {
        ...
        boolean measure = alreadyMeasured ? shouldReMeasureChild(child, widthSpec2, heightSpec2, lp) : shouldMeasureChild(child, widthSpec2, heightSpec2, lp);
        if (measure) {
    ...
    private void updateLayoutState(int anchorPosition, RecyclerView.State state) {
        ...
        this.mLayoutState.mInfinite = this.mPrimaryOrientation.getMode() == 0;
    }

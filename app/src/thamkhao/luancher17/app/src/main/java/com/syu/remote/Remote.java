...
/* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:bin/autolib.jar:com/syu/remote/Remote.class
  classes.dex
 */
...
public class Remote implements ServiceConnection {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:bin/autolib.jar:com/syu/remote/Remote$Command.class
  classes.dex
 */
    class Command {
        int cmdid;
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
  190001025_com.android.launcher17.apk:bin/autolib.jar:com/syu/remote/Remote$Module.class
  classes.dex
 */
    class Module {

...
public class PreloadReceiver extends BroadcastReceiver {
    public static final String EXTRA_WORKSPACE_NAME = "com.android.launcher17.action.EXTRA_WORKSPACE_NAME";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (provider != null) {
            ...
            new Thread(new Runnable() { // from class: com.android.launcher17.PreloadReceiver.1

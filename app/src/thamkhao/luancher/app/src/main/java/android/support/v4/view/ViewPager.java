...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager.class */
public class ViewPager extends ViewGroup {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$Decor.class */
    interface Decor {
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$OnAdapterChangeListener.class */
    interface OnAdapterChangeListener {
        void onAdapterChanged(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$OnPageChangeListener.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$PageTransformer.class */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$ItemInfo.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$SimpleOnPageChangeListener.class */
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        if (oldCurInfo != null) {
            ...
            if (oldCurPosition < curItem.position) {
                ...
                while (pos2 >= curItem.position && itemIndex2 >= 0) {
                    ItemInfo itemInfo2 = this.mItems.get(itemIndex2);
                    while (true) {
                        ii = itemInfo2;
                        ...
                        itemIndex2--;
                        itemInfo2 = this.mItems.get(itemIndex2);
                    }
        ...
        while (i >= 0) {
            ...
            while (pos3 > ii3.position) {
                int i2 = pos3;
                pos3--;
                offset3 -= this.mAdapter.getPageWidth(i2) + marginOffset;
            }
        ...
        int i3 = curIndex + 1;
        while (i3 < itemCount) {
            ItemInfo ii4 = this.mItems.get(i3);
            while (pos4 < ii4.position) {
                int i4 = pos4;
                pos4++;
                offset4 += this.mAdapter.getPageWidth(i4) + marginOffset;
            }
            if (ii4.position == N - 1) {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$SavedState.class */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8 && (lp2 = (LayoutParams) child.getLayoutParams()) != null && lp2.isDecor) {
                ...
                int vgrav = lp2.gravity & SyuJniNative.JNI_EXE_CMD_112_IS_AREAACTIVED;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & SyuJniNative.JNI_EXE_CMD_112_IS_AREAACTIVED;
                    switch (hgrav) {
                        case 1:
        ...
        if (currentFocused == this) {
            ...
            if (!isChild) {
                ...
                while (true) {
                    ...
                    sb.append(" => ").append(parent4.getClass().getSimpleName());
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$MyAccessibilityDelegate.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$PagerObserver.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$LayoutParams.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/ViewPager$ViewPositionComparator.class */

...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/FragmentActivity.class */
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompatApi23.RequestPermissionsRequestCodeValidator {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/FragmentActivity$NonConfigurationInstances.class */
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        if (!this.mStartedActivityFromFragment && requestCode != -1 && (requestCode & SupportMenu.CATEGORY_MASK) != 0) {
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode, @Nullable Bundle options) {
        ...
        try {
            if (requestCode == -1) {
                ...
                ActivityCompat.startActivityForResult(this, intent, ((requestIndex + 1) << 16) + (requestCode & SupportMenu.USER_MASK), options);
                this.mStartedActivityFromFragment = false;
            }
        } catch (Throwable th) {
            this.mStartedActivityFromFragment = false;
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/FragmentActivity$HostCallbacks.class */

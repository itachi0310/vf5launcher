...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/ActionBarDrawerToggleJellybeanMR2.class */
class ActionBarDrawerToggleJellybeanMR2 {
    ...
    public static Drawable getThemeUpIndicator(Activity activity) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(null, THEME_ATTRS, R.attr.actionBarStyle, 0);

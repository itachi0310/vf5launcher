...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SearchViewCompatIcs.class */
class SearchViewCompatIcs {
    SearchViewCompatIcs() {
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SearchViewCompatIcs$MySearchView.class */

...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/BackStackRecord.class */
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/BackStackRecord$Op.class */
    ...
    public void run() {
        ...
        while (true) {
            Op op2 = op;
            if (op2 != null) {
                int enterAnim = state != null ? 0 : op2.enterAnim;
                int exitAnim = state != null ? 0 : op2.exitAnim;
                switch (op2.cmd) {
                    case 1:
    ...
    private void calculateFragments(SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        while (true) {
            ...
            if (op2 != null) {
                switch (op2.cmd) {
                    case 1:
                        setLastIn(firstOutFragments, lastInFragments, op2.fragment);
                        break;
                    case 2:
                        Fragment f = op2.fragment;
                        if (this.mManager.mAdded != null) {
                        ...
                        break;
                    case 3:
                        setFirstOut(firstOutFragments, lastInFragments, op2.fragment);
                        break;
                    case 4:
                        setFirstOut(firstOutFragments, lastInFragments, op2.fragment);
                        break;
            ...
            if (op2 != null) {
                switch (op2.cmd) {
                    ...
                    case 2:
                        if (op2.removed != null) {
                            for (int i = op2.removed.size() - 1; i >= 0; i--) {
                                setLastIn(firstOutFragments, lastInFragments, op2.removed.get(i));
                            }
                        }
                        setFirstOut(firstOutFragments, lastInFragments, op2.fragment);
                        break;
    ...
    public TransitionState popFromBackStack(boolean doStateMove, TransitionState state, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        while (true) {
            Op op2 = op;
            if (op2 != null) {
                int popEnterAnim = state != null ? 0 : op2.popEnterAnim;
                int popExitAnim = state != null ? 0 : op2.popExitAnim;
                switch (op2.cmd) {
                    case 1:
                        Fragment f = op2.fragment;
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/app/BackStackRecord$TransitionState.class */

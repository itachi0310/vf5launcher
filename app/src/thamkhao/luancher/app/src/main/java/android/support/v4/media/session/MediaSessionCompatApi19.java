...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi19.class */
class MediaSessionCompatApi19 {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi19$Callback.class */
    ...
    static void addNewMetadata(Bundle metadata, RemoteControlClient.MetadataEditor editor) {
        ...
        if (metadata.containsKey("android.media.metadata.RATING")) {
            editor.putObject(HttpStatus.SC_SWITCHING_PROTOCOLS, (Object) metadata.getParcelable("android.media.metadata.RATING"));
        }
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi19$OnMetadataUpdateListener.class */

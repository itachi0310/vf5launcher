...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/PagerTitleStrip.class */
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImpl.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImplBase.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImplIcs.class */
    ...
    public PagerTitleStrip(Context context, AttributeSet attrs) {
        ...
        int textAppearance = a2.getResourceId(0, 0);
        if (textAppearance != 0) {
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        int vgrav = this.mGravity & SyuJniNative.JNI_EXE_CMD_112_IS_AREAACTIVED;
        switch (vgrav) {
            case 16:
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/PagerTitleStrip$PageListener.class */

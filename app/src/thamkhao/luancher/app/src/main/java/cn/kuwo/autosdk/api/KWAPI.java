...
public class KWAPI {
    ...
    private static final CarPlayerModeReceiver mCarPlayerModeReceiver = new CarPlayerModeReceiver(0 == true ? 1 : 0);
    private static final CarExitReceiver mCarExitReceiver = new CarExitReceiver(0 == true ? 1 : 0);
    ...
    private OnPlayerModeListener mPlayerModeListener = null;
    ...
    private String packJson(List list) {
        ...
        while (true) {
            ...
            try {
                ...
                jSONObject.put(MUSIC_NAME, ((Music) list.get(i2)).name);
    ...
    public boolean isKuwoRunning(Context context) {
        if (Build.VERSION.SDK_INT >= 22) {
            ...
            while (it.hasNext()) {
                if (KW_CAR_PROCESS_NAME.equals(((v) it.next()).e)) {
                    return true;
                }
            }
            return false;

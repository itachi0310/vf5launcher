...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/utils/W3Utils.class */
public class W3Utils implements Callback.OnRefreshLisenter {
    ...
    static {
        ...
        addFilterApp("com.autonavi.amapauto");
    ...
    public static W3Utils initialize(Context context) {
        ...
        enable = !"true".equals(value) && Build.VERSION.SDK_INT >= 22;
        if (utils == null) {
    ...
    public boolean startActivitySafelyForAction(String action, String pkg, int... flags) {
        ...
        if (action != null && action.length() > 0) {
            ...
            success = startActivitySafely(intent, flags);
        }
        return success;
    }

...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/LayoutInflaterCompatBase.class */
class LayoutInflaterCompatBase {
    LayoutInflaterCompatBase() {
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/view/LayoutInflaterCompatBase$FactoryWrapper.class */

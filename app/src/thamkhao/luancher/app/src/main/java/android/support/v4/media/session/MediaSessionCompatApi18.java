...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi18.class */
class MediaSessionCompatApi18 {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi18$Callback.class */
    interface Callback {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/media/session/MediaSessionCompatApi18$OnPlaybackPositionUpdateListener.class */

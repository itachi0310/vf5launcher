...
public final class n {
    ...
    public static void a(Context context, String str) {
        ...
        try {
            f34a = ((WifiManager) context.getSystemService("wifi")).getConnectionInfo().getMacAddress();
        ...
        try {
            strA = ((TelephonyManager) context.getSystemService("phone")).getDeviceId();
        } catch (Throwable th2) {
            th2.printStackTrace();
            strA = "";
        }
        if (TextUtils.isEmpty(strA)) {
            strA = !TextUtils.isEmpty(f34a) ? String.valueOf(f34a.replace(":", "")) + "000" : a();
        }
        b = strA;
    }
}

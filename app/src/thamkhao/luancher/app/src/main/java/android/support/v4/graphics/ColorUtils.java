...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/graphics/ColorUtils.class */
public final class ColorUtils {
    ...
    public static int compositeColors(@ColorInt int foreground, @ColorInt int background) {
        ...
        int b = compositeComponent(Color.blue(foreground), fgAlpha, Color.blue(background), bgAlpha, a2);
    ...
    public static void RGBToHSL(@IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int r, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int g, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int b, @NonNull float[] outHsl) {
        float h;
        float s;
        float rf = r / 255.0f;
        float gf = g / 255.0f;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int alpha) {
    ...
    public static void RGBToLAB(@IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int r, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int g, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int b, @NonNull double[] outLab) {
    ...
    public static void RGBToXYZ(@IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int r, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int g, @IntRange(from = Headers.NO_TRANSFER_ENCODING, to = 255) int b, @NonNull double[] outXyz) {
        if (outXyz.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double l, @FloatRange(from = -128.0d, to = 127.0d) double a2, @FloatRange(from = -128.0d, to = 127.0d) double b, @NonNull double[] outXyz) {
        double fy = (l + 16.0d) / 116.0d;
        double fx = (a2 / 500.0d) + fy;
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double l, @FloatRange(from = -128.0d, to = 127.0d) double a2, @FloatRange(from = -128.0d, to = 127.0d) double b) {
        double[] result = getTempDouble3Array();
        LABToXYZ(l, a2, b, result);
    ...
    public static int blendARGB(@ColorInt int color1, @ColorInt int color2, @FloatRange(from = 0.0d, to = 1.0d) float ratio) {
        ...
        return Color.argb((int) a2, (int) r, (int) g, (int) b);
    }
    ...
    @VisibleForTesting
    static float circularInterpolate(float a2, float b, float f) {
        if (Math.abs(b - a2) > 180.0f) {
            if (b > a2) {
                a2 += 360.0f;
            } else {
                b += 360.0f;

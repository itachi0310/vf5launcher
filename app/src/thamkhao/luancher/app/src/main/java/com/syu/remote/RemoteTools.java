...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/RemoteTools.class */
public class RemoteTools implements ServiceConnection {
    ...
    public int getInt(int module, int def, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getInt(def, code, params);
        }
        return def;
    }
    ...
    public float getFlt(int module, float def, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getFlt(def, code, params);
        }
        return def;
    }
    ...
    public String getStr(int module, String def, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getStr(def, code, params);
        }
        return def;
    }
    ...
    public int[] getInts(int module, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getInts(code, params);
        }
        return new int[1];
    }
    ...
    public float[] getFlts(int module, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getFlts(code, params, new int[0]);
        }
        return new float[1];
    }
    ...
    public String[] getStrs(int module, int code, int params) {
        Registrar sModule = this.mModules.get(module);
        if (sModule != null) {
            return sModule.getStrs(code, params);
        }
        return new String[1];
    }
}

...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Remote.class */
public class Remote implements ServiceConnection {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Remote$Command.class */
    class Command {
        int module;
        int cmdid;
        int[] ints;
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Remote$Module.class */
    class Module {

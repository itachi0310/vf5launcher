...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/ExploreByTouchHelper.class */
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private boolean intersectVisibleToUser(Rect localRect) {
        ...
        while (true) {
            ...
            if (obj instanceof View) {
                ...
                if (obj == null || !this.mView.getLocalVisibleRect(this.mTempVisibleRect)) {
                    return false;
                }
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/ExploreByTouchHelper$ExploreByTouchNodeProvider.class */

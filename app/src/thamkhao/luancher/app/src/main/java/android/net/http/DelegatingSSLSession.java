...
/* JADX INFO: loaded from: Launcher3.apk:libs/org.apache.http.legacy.jar:android/net/http/DelegatingSSLSession.class */
public class DelegatingSSLSession implements SSLSession {

    /* JADX INFO: loaded from: Launcher3.apk:libs/org.apache.http.legacy.jar:android/net/http/DelegatingSSLSession$CertificateWrap.class */

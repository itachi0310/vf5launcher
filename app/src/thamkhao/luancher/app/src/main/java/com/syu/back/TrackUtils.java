...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/back/TrackUtils.class */
public class TrackUtils {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/back/TrackUtils$Point.class */
    public static class Point {
        float x;
        float y;
    }

    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/back/TrackUtils$TRACK_TYPE.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/back/TrackUtils$Crcle.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/back/TrackUtils$Cubic.class */
    public class Cubic {
        ...
        public Cubic(float a2, float b, float c, float d) {
            super/*android.a.a.a.e*/.a(this);
            this.f513a = a2;
            this.b = b;
            this.c = c;
            this.d = d;
        ...
        public float eval(float u) {
            return (((((this.d * u) + this.c) * u) + this.b) * u) + this.f513a;
        }
    }
    ...
    public float getAngleOfArcLen(float len, Crcle c, double startAngle, int mode) {
        ...
        int[] iArr = new int[2];
        return (float) (startAngle + (((double) mode) * angle));
    }
    ...
    public float[] getPointsOfArc(Crcle c, boolean left) {
        ...
        for (int i = 0; i < POINT_COUNT; i++) {
            float[] ps1 = utils.realToCameraForJ(utils.getPointForAngle(c, 0.0f - (angle * i), left));
            dst[i * 2] = ps1[0];
            dst[(i * 2) + 1] = ps1[1];
        }
        return dst;
    ...
    public float[] pointOfView(float startX, float endX, float startY, float endY) {
        ...
        for (int i = 0; i < POINT_COUNT; i++) {
            ps[i * 2] = startX + (dex * i) + 0.5f;
            ps[(i * 2) + 1] = startY + (dey * i) + 0.5f;
        }
        return ps;
    }

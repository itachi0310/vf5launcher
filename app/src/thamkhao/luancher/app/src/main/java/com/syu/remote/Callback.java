...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Callback.class */
public class Callback extends IModuleCallback.Stub {
    List<Lisenter> mLisenters = new ArrayList();
    Handler mHandler = new Handler(Looper.getMainLooper());

    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Callback$OnRefreshLisenter.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Callback$Lisenter.class */
    class Lisenter {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Callback$Massage.class */
    class Massage {
        int code;
        int[] ints;
        float[] flts;

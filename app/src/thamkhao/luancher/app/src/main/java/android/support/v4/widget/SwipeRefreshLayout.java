...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SwipeRefreshLayout.class */
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SwipeRefreshLayout$OnRefreshListener.class */
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, LAYOUT_ATTRS);

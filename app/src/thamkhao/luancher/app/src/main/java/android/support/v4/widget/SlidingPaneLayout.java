...
/* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout.class */
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$PanelSlideListener.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SlidingPanelLayoutImpl.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SimplePanelSlideListener.class */
    ...
    void updateObscuredViewsVisibility(View panel) {
        ...
        for (int i2 = 0; i2 < childCount && (child = getChildAt(i2)) != panel; i2++) {
    ...
    /* JADX WARN: Code duplicated, block: B:141:0x020e A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:41:0x0135 A[PHI: r14
  0x0135: PHI (r14v2 'weightSum' float) = (r14v1 'weightSum' float), (r14v3 'weightSum' float) binds: [B:37:0x011d, B:39:0x012f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:63:0x01f8  */
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        ...
        int baseAlpha = (fadeColor & ViewCompat.MEASURED_STATE_MASK) >>> 24;
        int imag = (int) (baseAlpha * mag);
        int color = (imag << 24) | (fadeColor & ViewCompat.MEASURED_SIZE_MASK);
        if (lp.dimPaint == null) {
    ...
    boolean smoothSlideTo(float slideOffset, int velocity) {
        ...
        if (isLayoutRtl) {
            ...
            int childWidth = this.mSlideableView.getWidth();
            x = (int) (getWidth() - ((startBound + (slideOffset * this.mSlideRange)) + childWidth));
        } else {
            int startBound2 = getPaddingLeft() + lp.leftMargin;
            x = (int) (startBound2 + (slideOffset * this.mSlideRange));
        }
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$DragHelperCallback.class */
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                newLeft = Math.min(Math.max(left, startBound2), endBound2);
            }
            return newLeft;
        }
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$LayoutParams.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SavedState.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SlidingPanelLayoutImplBase.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SlidingPanelLayoutImplJB.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$SlidingPanelLayoutImplJBMR1.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$AccessibilityDelegate.class */
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/android-support-v4.jar:android/support/v4/widget/SlidingPaneLayout$DisableLayerRunnable.class */

...
/* JADX INFO: loaded from: Launcher3.apk:libs/eventbus-3.1.1.jar:org/greenrobot/eventbus/util/AsyncExecutor.class */
public class AsyncExecutor {
    ...
    /* JADX INFO: loaded from: Launcher3.apk:libs/eventbus-3.1.1.jar:org/greenrobot/eventbus/util/AsyncExecutor$RunnableEx.class */
    public interface RunnableEx {
        void run() throws Exception;
    }

    /* JADX INFO: loaded from: Launcher3.apk:libs/eventbus-3.1.1.jar:org/greenrobot/eventbus/util/AsyncExecutor$Builder.class */

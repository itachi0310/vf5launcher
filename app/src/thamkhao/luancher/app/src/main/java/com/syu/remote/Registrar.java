...
/* JADX INFO: loaded from: Launcher3.apk:bin/autolib.jar:com/syu/remote/Registrar.class */
public abstract class Registrar {
    ...
    final int getInt(int def, int code, int... params) {
        try {
            ...
            if (object != null && object.ints != null && object.ints.length > 0) {
    ...
    final float getFlt(float def, int code, int... params) {
        try {
            ModuleObject object = this.mModule.get(code, params, null, null);
            if (object != null && object.flts != null && object.flts.length > 0) {
                return object.flts[0];
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    final String getStr(String def, int code, int... params) {
        try {
            ModuleObject object = this.mModule.get(code, params, null, null);
            if (object != null && object.strs != null && object.strs.length > 0) {
                return object.strs[0];
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
